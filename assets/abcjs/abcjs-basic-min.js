...
// https://cdn.jsdelivr.net/npm/abcjs@6.2.0/dist/abcjs-basic-min.js
// The official documentation is accessible at:
// https://abcjs.net

!function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.abcjs = t() : e.ABCJS = t()
}(this, (function() {
    return e = {
        1045: function(e, t, r) {
            var n = r(1185)
                ...
                i.startAnimation = function(r, i, a) {
                    ...
                    function c(e) {
                        a.hideCurrentMeasure ? function(e) {
                            ...
                            o && s(r.querySelectorAll(o)),
                            o = e
                        }(e)
                    }
                    e && (e.stop(),
                    e = void 0),
                    a.showCursor && ((t = r.querySelector(".abcjs-cursor")) || ((t = document.createElement("DIV")).className = "abcjs-cursor cursor",
        ...
        4321: function(e, t, r) {
            var n = r(4916)
              ...
              , s = {
                    ...
                    if (r.tablature) {
                        ...
                        for (var s = 0; s < i.length; s++) {
                            var o = i[s]
                              , c = o.instrument;
                            if (null == c)
                                return this.setError(e, "tablature 'instrument' is missing"),
                                n;
                            var l = a[c]
                              , h = null;
                            if (l && (h = this.plugins[l]),
                            !h)
                                return this.setError(e, "Undefined tablature plugin: " + c),
                                n;
                            0 != r.visualTranspose && (o.visualTranspose = r.visualTranspose),
                    ...
                    for (var r = t.tablatures, n = 0; n < t.lines.length; n++) {
                        ...
                        if (a)
                            for (var s = 0; s < a.length; s++)
                                if (r[s]) {
                                    var o = r[s];
                                    null == o.instance && (o.instance = new o.classz,
                ...
                init: function() {
                    this.inited || (this.register(new n),
                    this.register(new i),
                    this.inited = !0)
                }
            };
        ...
        5681: function(e) {
            e.exports = function(e, t) {
                ...
                r.replaceTarget = function(e) {
                    ...
                    r.lineEndCallback && (r.lineEndTimings = function(e, t) {
                        for (var r = [], n = null, i = 0; i < e.length; i++) {
                            var a = e[i];
                            "end" !== a.type && a.top !== n && (r.push({
                    ...
                    r.newSeekPercent = 0,
                    r.lastTimestamp = 0,
                    0 !== r.noteTimings.length && (r.millisecondsPerBeat = 1e3 / (r.qpm / 60) / r.beatSubdivisions,
                ...
                r.doTiming = function(e) {
                    if (r.lastTimestamp !== e && (r.lastTimestamp = e,
                    r.startTime || (r.startTime = e),
                    !r.isPaused && r.isRunning)) {
                        for (r.currentTime = e - r.startTime,
                        r.currentTime += 16; r.noteTimings.length > r.currentEvent && r.noteTimings[r.currentEvent].milliseconds < r.currentTime; ) {
                        ...
                        if (r.lineEndCallback && r.lineEndTimings.length > r.currentLine && r.lineEndTimings[r.currentLine].milliseconds < r.currentTime && r.currentEvent < r.noteTimings.length) {
                            var n = r.noteTimings[r.currentEvent].milliseconds === r.currentTime ? r.noteTimings[r.currentEvent] : r.noteTimings[r.currentEvent - 1];
                        ...
                        if (r.currentTime < r.lastMoment) {
                            if (requestAnimationFrame(r.doTiming),
                ...
                r.shouldStop = function(e) {
                    return new Promise((function(t) {
                        return e ? "continue" === e ? t(!1) : void (e.then && e.then((function(e) {
                            t("continue" !== e)
                        }
                        ))) : t(!0)
                    }
                ...
                r.doBeatCallback = function(e) {
                    if (r.beatCallback) {
                        for (var t, n, i = r.currentEvent; i < r.noteTimings.length && null === r.noteTimings[i].left; )
                            i++;
                        if (i < r.noteTimings.length) {
                            for (t = r.noteTimings[i].milliseconds,
                            i = Math.max(0, r.currentEvent - 1); i >= 0 && null === r.noteTimings[i].left; )
                                i--;
                            n = r.noteTimings[i]
                        }
                        var a = {}
                        ...
                        var u = r.startTime;
                        if (r.beatCallback(r.currentBeat / r.beatSubdivisions, r.totalBeats / r.beatSubdivisions, r.lastMoment, a, s),
                        u !== r.startTime)
                ...
                r.animationJogger = function() {
                    r.isRunning && (r.doTiming(performance.now()),
                ...
                r.pause = function() {
                    ...
                    r.isRunning = !1,
                    r.joggerTimer && (clearTimeout(r.joggerTimer),
                    r.joggerTimer = null)
                }
                ,
                ...
                r.setProgress = function(e, t) {
                    ...
                    for (r.startTime = i - r.currentTime,
                    r.currentEvent,
                    r.currentEvent = 0; r.noteTimings.length > r.currentEvent && r.noteTimings[r.currentEvent].milliseconds < r.currentTime; )
                        r.currentEvent++;
                    ...
                    r.eventCallback && r.currentEvent >= 0 && "event" === r.noteTimings[r.currentEvent].type && r.eventCallback(r.noteTimings[r.currentEvent]),
                    r.lineEndCallback && r.lineEndCallback(r.lineEndTimings[r.currentLine], r.noteTimings[r.currentEvent], {
                        line: r.currentLine,
                        endTimings: r.lineEndTimings
                    }),
                    r.joggerTimer = setTimeout(r.animationJogger, 60)
        ...
        1592: function(e, t, r) {
            ...
            !function() {
                ...
                o.parseOnly = function(e, t) {
                    for (var r = o.numberOfTunes(e), n = [], i = 0; i < r; i++)
                        n.push(1);
                    return o.renderEngine((function() {}
                    ), n, e, t)
                }
                ,
                o.renderEngine = function(t, r, a, o) {
                    ...
                    if (void 0 !== r && void 0 !== a) {
                        var l;
                        (!(l = r) || l.propertyIsEnumerable("length") || "object" !== n(l) || "number" != typeof l.length) && (r = [r]),
                        void 0 === o && (o = {});
                        for (var h = o.startingTune ? parseInt(o.startingTune, 10) : 0, u = new e(a), d = new i, f = 0; f < r.length; f++) {
                            var p = r[f];
                            if ("*" === p || "string" == typeof p && (p = document.getElementById(p)),
                            p)
                                if (h >= 0 && h < u.tunes.length) {
                                    d.parse(u.tunes[h].abc, o, u.tunes[h].startPos - u.header.length);
                                    var m = d.getTune();
                                    o.tablature && (s.init(),
                                    m.tablatures = s.preparePlugins(m, h, o));
                                    var g = d.getWarnings();
                                    g && (m.warnings = g);
                ...
                o.extractMeasures = function(t) {
                    for (var r = [], n = new e(t), i = 0; i < n.tunes.length; i++) {
                        for (var a = n.tunes[i], s = a.abc.split("K:"), c = s[1].split("\n"), l = s[0] + "K:" + c[0] + "\n", h = null, u = null, d = null, f = [], p = !1, m = o.parseOnly(a.abc)[0], g = m.getPickupLength() > 0, v = 0; v < m.lines.length; v++) {
                            var b = m.lines[v];
                            if (b.staff)
                                for (var y = 0; y < 1; y++)
                                    for (var x = b.staff[y], w = 0; w < 1; w++)
                                        for (var k = x.voices[w], C = 0; C < k.length; C++) {
                                            var T = k[C];
                                            if (null === d && T.startChar >= 0 && (d = T.startChar,
                                            u = void 0 === T.chord ? h : null),
                                            T.chord && (h = T),
                                            "bar" === T.el_type) {
                                                if (p) {
                                                    var _ = {
                                                        abc: a.abc.substring(d, T.endChar)
                                                    };
        ...
        6859: function(e, t, r) {
            ...
            function l(e, t, r, n, a) {
                r.viewportHorizontal ? (e.innerHTML = '<div class="abcjs-inner"></div>',
                r.scrollHorizontal ? (e.style.overflowX = "auto",
                e.style.overflowY = "hidden") : e.style.overflow = "hidden",
                o[e.id] = e,
                e = e.children[0]) : r.viewportVertical ? (e.innerHTML = '<div class="abcjs-inner scroll-amount"></div>',
            ...
            e.exports = {
                ...
                relativeMode: function(e, r) {
                    ...
                    for (var a = i[1], s = 0; s < n.modes.length; s++) {
                        ...
                        if (-1 !== c && c === o.length - a.length)
                            return o.substring(0, o.length - a.length)
                    }
                    return e
                },
        ...
        6780: function(e, t, r) {
            ...
            e.exports = function() {
                ...
                this.copyTopInfo = function(t) {
                    ...
                    e(this, t, "metaText", r),
                    e(this, t, "metaTextInfo", r)
                }
                ,
                this.copyBottomInfo = function(t) {
                    var r = ["unalignedWords", "book", "source", "discography", "notes", "transcription", "history", "abc-copyright", "abc-creator", "abc-edited-by", "footer"];
                    e(this, t, "metaText", r),
                    e(this, t, "metaTextInfo", r)
                }
                ,
                this.getBeatLength = function() {
                    var e = this.getMeterFraction()
                      , t = 1;
                    return (6 === e.num || 9 === e.num || 12 === e.num || 3 === e.num && 8 === e.den) && (t = 3),
                    t / e.den
                }
                ,
                                ...
                                for (var i = 0; i < e[n].staff.length; i++)
                                    for (var a = 0; a < e[n].staff[i].voices.length; a++)
                                        for (var s = e[n].staff[i].voices[a], o = 1, c = 0; c < s.length; c++) {
                                            ...
                                            if (s[c].startTriplet && (o = s[c].tripletMultiplier),
                ...
                this.getMeterFraction = function() {
                    ...
                    r = parseInt(e.value[0].den, 10)) : "cut_time" === e.type ? (t = 2,
                    r = 2) : "common_time" === e.type && (t = 4,
                    r = 4)),
                    this.meter = {
                        num: t,
                        den: r
                            ...
                            for (var n = 0; n < r.staff.length; n++)
                                for (var i = r.staff[n], a = 0; a < i.voices.length; a++)
                                    for (var s = i.voices[a], o = 0; o < s.length; o++) {
                                        var c = s[o];
                                        if (c.startChar && c.endChar && c.startChar <= e && c.endChar > e)
                                            return c
                                    }
                    }
                    return null
                ...
                this.addElementToEvents = function(e, t, r, i, a, s, o, c, l, h) {
                    ...
                    u > 0) {
                        ...
                        if (void 0 !== l)
                            ...
                            if (e["event" + r]) {
                                if (e["event" + r].left ? e["event" + r].left = Math.min(e["event" + r].left, t.x) : e["event" + r].left = t.x,
                                ...
                                t.abcelem.midiPitches && t.abcelem.midiPitches.length)
                                    for (e["event" + r].midiPitches || (e["event" + r].midiPitches = []),
                ...
                this.makeVoicesArray = function() {
                    for (var e = [], t = [], r = {}, n = 0; n < this.engraver.staffgroups.length; n++) {
                        ...
                        if (a && a.staffs && a.staffs.length > 0)
                            for (var s = a.staffs[0], o = s.absoluteY, c = o - s.top * i.STEP, l = a.staffs[a.staffs.length - 1], h = (o = l.absoluteY) - l.bottom * i.STEP - c, u = a.voices, d = 0; d < u.length; d++)
                ...
                this.setupEvents = function(e, r, n, i) {
                    ...
                    for (var a, s = [], o = {}, c = e, l = !0, h = this.makeVoicesArray(), u = 0, d = 0; d < h.length; d++) {
                        ...
                        for (var y = -1, x = 0; x < v.length; x++) {
                            ...
                            y !== w && this.tempoLocations[w] && (b = this.tempoLocations[w],
                            r = i * this.getBeatLength() * b / 60,
                            y = w);
                            var k, C = v[x].elem, T = this.addElementToEvents(o, C, p, v[x].top, v[x].height, v[x].line, v[x].measureNumber, r, a, l);
                            if (a = T.isTiedState,
                            l = T.nextIsBar,
                            f += T.duration,
                            ...
                            "bar" === C.type) {
                                ...
                                if (S) {
                                    ...
                                    y = -1;
                                    for (var A = m; A < g; A++) {
                                        y !== (w = v[A].measureNumber) && this.tempoLocations[w] && (b = this.tempoLocations[w],
                                        r = i * this.getBeatLength() * b / 60,
                                        y = w);
                                        var B = v[A].elem;
                                        a = (T = this.addElementToEvents(o, B, p, v[A].top, v[A].height, v[A].line, v[A].measureNumber, r, a, l)).isTiedState,
                                        l = T.nextIsBar,
                                        f += T.duration,
                                        N = p,
                                        p = Math.round(1e3 * f)
                ...
                this.addUsefulCallbackInfo = function(e, t) {
                    for (var r = this.millisecondsPerMeasure(t), n = 0; n < e.length; n++)
                ...
                this.setTiming = function(e, t) {
                    if (t = t || 0,
                    !this.engraver || !this.engraver.staffgroups)
                        return console.log("setTiming cannot be called before the tune is drawn."),
                    ...
                    var c = a * s;
                    return this.noteTimings = this.setupEvents(o, c, e, i),
                    this.noteTimings.length > 0 ? (this.totalTime = this.noteTimings[this.noteTimings.length - 1].milliseconds / 1e3,
                    this.totalBeats = this.totalTime * s) : (this.totalTime = void 0,
        ...
        351: function(e) {
                        ...
                        for (var i = 0; i < e.staff.length; i++) {
                            for (var a = {}, s = Object.keys(e.staff[i]), o = 0; o < s.length; o++)
                                if ("voices" !== s[o])
                                    ...
                                    a.voices = [];
                                    for (var c = 0; c < e.staff[i].voices.length; c++)
                                        a.voices.push([].concat(e.staff[i].voices[c]))
                                }
                            t.staff.push(a)
                        }
                    }
            ...
            e.exports = function(e, t) {
                t || (t = {});
                for (var c = !!t.lineBreaks, l = [], h = !1, u = [], d = [], f = [], p = [], m = [], g = [], v = [], b = 0; b < e.length; b++) {
                    var y = e[b];
                    if (y.staff) {
                        if (h && !y.vskip)
                            for (var x = l[l.length - 1], w = 0; w < x.staff.length; w++) {
                                var k = y.staff[w]
                                  , C = x.staff[w];
                                if (k && (s(k.meter, u[w]) || (r(k.meter, k.voices),
                                u[w] = k.meter,
                                delete k.meter),
                                s(k.key, d[w]) || (n(k.key, k.voices),
                                d[w] = k.key,
                                delete k.key),
                                k.title && (C.abbrevTitle = k.title),
                                s(k.clef, f[w]) || (i(k.clef, k.voices),
                                f[w] = k.clef,
                                delete k.clef),
                                s(k.vocalfont, p[w]) || (a(k.vocalfont, k.voices, "vocalfont"),
                                p[w] = k.vocalfont,
                                delete k.vocalfont),
                                s(k.gchordfont, m[w]) || (a(k.gchordfont, k.voices, "gchordfont"),
                                m[w] = k.gchordfont,
                                delete k.gchordfont),
                                s(k.tripletfont, g[w]) || (a(k.tripletfont, k.voices, "tripletfont"),
                                g[w] = k.tripletfont,
                                delete k.tripletfont),
                                s(k.annotationfont, v[w]) || (a(k.annotationfont, k.voices, "annotationfont"),
        ...
        5294: function(e, t, r) {
            var n = r(5008)
              ...
              , c = function(e, t) {
                this.abcjsParams = function(e) {
                    ...
                    if (e.midi_options)
                        for (t in e.midi_options)
                            e.midi_options.hasOwnProperty(t) && (r[t] = e.midi_options[t]);
                    if (e.parser_options)
                        for (t in e.parser_options)
                            e.parser_options.hasOwnProperty(t) && (r[t] = e.parser_options[t]);
                    if (e.render_options)
                        for (t in e.render_options)
                            e.render_options.hasOwnProperty(t) && (r[t] = e.render_options[t]);
                    return r.tablature && e.warnings_id && (r.tablature.warnings_id = e.warnings_id),
                    r
                }(t),
                ...
                t.canvas_id ? this.div = t.canvas_id : t.paper_id ? this.div = t.paper_id : (this.div = document.createElement("DIV"),
                ...
                t.warnings_id ? "string" == typeof t.warnings_id ? this.warningsdiv = document.getElementById(t.warnings_id) : this.warningsdiv = t.warnings_id : t.generate_warnings && (this.warningsdiv = document.createElement("div"),
                ...
                this.setReadOnly = function(e) {
                    ...
                    e ? (r.setAttribute("readonly", "yes"),
                    this.addClassName(r, t)) : (r.removeAttribute("readonly"),
                    this.removeClassName(r, t))
                }
            };
            c.prototype.redrawMidi = function() {
                ...
                if (this.synth) {
                    ...
                    this.synth.synthControl || (this.synth.synthControl = new i,
            ...
            c.prototype.parseABC = function() {
                ...
                return e === this.currentAbc ? (this.updateSelection(),
                !1) : (this.currentAbc = e,
                !0)
            }
            ,
            ...
            c.prototype.setDirtyStyle = function(e) {
                if (void 0 !== this.indicate_changed) {
                    var t, r, i = "abc_textarea_dirty", a = this.editarea.getElem();
                    e ? function(e, t) {
                        var r = e.className;
                        return r.length > 0 && (r === t || new RegExp("(^|\\s)" + t + "(\\s|$)").test(r))
                    }(t = a, r = i) || (t.className += (t.className ? " " : "") + r) : function(e, t) {
            ...
            c.prototype.millisecondsPerMeasure = function() {
                return this.synth && this.synth.synthControl && this.synth.synthControl.visualObj ? this.synth.synthControl.visualObj.millisecondsPerMeasure() : 0
            }
            ,
                    ...
                    for (var h = 0; h < n.tracks.length; h++) {
                        ...
                        for (var u = {}, d = 0; d < n.tracks[h].length; d++) {
                            ...
                            case "program":
                                ...
                                128 === f.instrument ? (a.setChannel(9, p),
                                a.setInstrument(0)) : (a.setChannel(f.channel, p),
                                a.setInstrument(f.instrument));
                                break;
                            case "note":
                                var m = f.gap * l
                                  , g = f.start
        ...
        5008: function(e) {
            var t = {
                ...
                cloneHashOfHash: function(e) {
                    var r = {};
                    for (var n in e)
                        e.hasOwnProperty(n) && (r[n] = t.clone(e[n]));
                    return r
                },
                cloneHashOfArrayOfHash: function(e) {
                    var r = {};
                    for (var n in e)
                        e.hasOwnProperty(n) && (r[n] = t.cloneArray(e[n]));
                    return r
                },
                strip: function(e) {
        ...
        8905: function(e, t, r) {
            ...
            e.exports = function() {
                ...
                this.getTune = function() {
                    ...
                    return t.lineBreaks && (e.lineBreaks = t.lineBreaks),
                ...
                var m, g, v = {
                    ...
                    addFormattingOptions: function(e, t, r) {
                        "note" === r ? ("auto" !== this.vocalPosition && f(e, "vocalPosition", this.vocalPosition),
                        ...
                        this.differentFont("tripletfont", t) && p(e, "tripletfont", this.tripletfont)) : "bar" === r && ("auto" !== this.dynamicPosition && f(e, "dynamicPosition", this.dynamicPosition),
                        "auto" !== this.chordPosition && f(e, "chordPosition", this.chordPosition),
                        "auto" !== this.ornamentPosition && f(e, "ornamentPosition", this.ornamentPosition),
                        "auto" !== this.volumePosition && f(e, "volumePosition", this.volumePosition),
                    ...
                    duplicateStartEndingHoldOvers: function() {
                        ...
                        for (var e = 0; e < this.inTie.length; e++)
                            if (this.endingHoldOver.inTie.push([]),
                            this.inTie[e])
                    ...
                    restoreStartEndingHoldOvers: function() {
                        if (this.endingHoldOver.inTie) {
                            ...
                            for (var r in this.endingHoldOver.inTieChord)
                                this.endingHoldOver.inTieChord.hasOwnProperty(r) && (this.inTieChord[r] = this.endingHoldOver.inTieChord[r])
                        }
                    }
                }, b = function(e) {
                    ...
                    var i = r[n];
                    " " !== i && i || (i = "SPACE");
                    var a, s = b(r.substring(n - 64, n)) + '<span style="text-decoration:underline;font-size:1.3em;font-weight:bold;">' + i + "</span>" + b(r.substring(n + 1).substring(0, 64));
                    !function(e) {
                ...
                var x = function(t, r) {
                    ...
                    t) {
                        ...
                        for (var i = [], a = 0, s = !1, o = function(t) {
                            var o = n.strip(r.substring(a, t));
                            if (o = o.replace(/\\([-_*|~])/g, "$1"),
                            a = t + 1,
                            o.length > 0) {
                                s && (o = o.replace(/~/g, " "));
                                var c = r[t];
                            ...
                            case "":
                                ...
                                break;
                            case "-":
                                !c && !o(l) && i.length > 0 && (n.last(i).divider = "-",
                                i.push({
                                    skip: !0,
                                    to: "next"
                                }));
                        ...
                        y("Can't add words before the first line of music", t, 0)
                }
                  , w = function(t, r) {
                    if (r.indexOf("") >= 0)
                        d += r;
                    ...
                    t) {
                        ...
                        for (var i = [], a = 0, s = !1, o = function(t) {
                            ...
                            case "":
                                ...
                                break;
                            case "-":
                                !o(c) && i.length > 0 && (n.last(i).divider = "-",
                                i.push({
                                    skip: !0,
                                    to: "next"
                                }));
                  ...
                  , k = function(e) {
                    if (n.startsWith(e, "%%")) {
                        ...
                        0 !== (e = e.replace(/\s+$/, "")).length)
                            if (u)
                                x(r.getCurrentVoice(), e.substring(2));
                            else if (d)
                                w(r.getCurrentVoice(), e.substring(2));
                            else if (e.length < 2 || ":" !== e[1] || g.lineContinuation)
                                g.parseMusic(e);
                            else {
                ...
                this.parse = function(l, h, f) {
                    ...
                    v.reset(),
                    v.iChar = f,
                    h.visualTranspose ? (v.globalTranspose = parseInt(h.visualTranspose),
                    0 === v.globalTranspose ? v.globalTranspose = void 0 : r.setVisualTranspose(h.visualTranspose)) : v.globalTranspose = void 0,
                    ...
                    try {
                        ...
                        for (var _ = e.nextLine(); _; ) {
                            if (h.header_only && !1 === v.is_in_header)
                                throw "normal_abort";
                            if (h.stop_on_warning && v.warnings)
                                throw "normal_abort";
                            var S = v.is_in_header;
                            k(_),
                            S && !v.is_in_header && (r.setRunningFont("annotationfont", v.annotationfont),
                    ...
                    h.hint_measures && function() {
                        for (var e = 0; e < t.lines.length; e++) {
                            var r = t.lines[e].staff;
                            if (r) {
                                for (var n = e + 1; n < t.lines.length && void 0 === t.lines[n].staff; )
                                    n++;
        ...
        9565: function(e, t, r) {
            ...
            e.exports = function(e) {
                ...
                o.length > 1 && !n.startsWith(o[0].abc, "X:") && o.shift().abc.split("\n").forEach((function(e) {
                    n.startsWith(e, "%%") && (t += e + "\n")
                }
                ));
                var c = t;
        ...
        8360: function(e, t, r) {
            ...
            !function() {
                ...
                var o = {
                  ...
                  , c = function(e, r, n, i, a) {
                    ...
                    for (var c, l = [], h = "normal", u = "normal", d = "none", f = !1, p = "face", m = !1; e.length; ) {
                        ...
                        case "face":
                            ...
                            l[l.length - 1] = l[l.length - 1] + g.token) : l.push(g.token) : "number" === g.type ? (c ? t("Font size specified twice in font definition.", n, i) : c = g.token,
                            p = "modifier") : "bold" === v ? h = "bold" : "italic" === v ? u = "italic" : "underline" === v ? d = "underline" : "box" === v ? (o[a] ? f = !0 : t('This font style doesn\'t support "box"', n, i),
                            p = "finished") : "utf" === v ? (g = e.shift(),
                            p = "size") : t("Unknown parameter " + g.token + " in font definition.", n, i);
                            break;
                        case "size":
                            "number" === g.type ? c ? t("Font size specified twice in font definition.", n, i) : c = g.token : t("Expected font size in font definition.", n, i),
                            p = "modifier";
                            break;
                        case "modifier":
                            "bold" === v ? h = "bold" : "italic" === v ? u = "italic" : "underline" === v ? d = "underline" : "box" === v ? (o[a] ? f = !0 : t('This font style doesn\'t support "box"', n, i),
                            p = "finished") : t("Unknown parameter " + g.token + " in font definition.", n, i);
                            break;
                        case "finished":
                            t('Extra characters found after "box" in font definition.', n, i)
                        }
                    }
                    void 0 === c ? r ? c = r.size : (t("Must specify the size of the font since there is no default value.", n, i),
                    c = 12) : c = parseFloat(c),
                    "" === (l = l.join(" ")) && (r ? l = r.face : (t("Must specify the name of the font since there is no default value.", n, i),
                    l = "sans-serif"));
                    var b = function(e) {
                        switch (e) {
                        case "Arial-Italic":
                  ...
                  , l = function(e, t, n) {
                    return 0 === t.length ? 'Directive "' + e + '" requires a font as a parameter.' : (r[e] = c(t, r[e], n, 0, e),
                    r.is_in_header && (a.formatting[e] = r[e]),
                    null)
                }
                  , h = function(e, t) {
                    var r = "";
                  ...
                  , u = ["acoustic-bass-drum", "bass-drum-1", "side-stick", "acoustic-snare", "hand-clap", "electric-snare", "low-floor-tom", "closed-hi-hat", "high-floor-tom", "pedal-hi-hat", "low-tom", "open-hi-hat", "low-mid-tom", "hi-mid-tom", "crash-cymbal-1", "high-tom", "ride-cymbal-1", "chinese-cymbal", "ride-bell", "tambourine", "splash-cymbal", "cowbell", "crash-cymbal-2", "vibraslap", "ride-cymbal-2", "hi-bongo", "low-bongo", "mute-hi-conga", "open-hi-conga", "low-conga", "high-timbale", "low-timbale", "high-agogo", "low-agogo", "cabasa", "maracas", "short-whistle", "long-whistle", "short-guiro", "long-guiro", "claves", "hi-wood-block", "low-wood-block", "mute-cuica", "open-cuica", "mute-triangle", "open-triangle"]
                  , d = function(e, t, n, i, a) {
                    if (1 !== n.length || "number" !== n[0].type)
                        return 'Directive "' + t + '" requires a number as a parameter.';
                    var s = n[0].intt;
                    return void 0 !== i && s < i ? 'Directive "' + t + '" requires a number greater than or equal to ' + i + " as a parameter." : void 0 !== a && s > a ? 'Directive "' + t + '" requires a number less than or equal to ' + a + " as a parameter." : (r[e] = s,
                    null)
                }
                  , f = function(e, t, n) {
                    if (1 === n.length && ("true" === n[0].token || "false" === n[0].token))
                        return r[e] = "true" === n[0].token,
                        null;
                    var i = d(e, t, n, 0, 1);
                    return null !== i ? i : (r[e] = 1 === r[e],
                    null)
                }
                  , p = function(e, t, n, i) {
                    if (1 !== n.length)
                        return 'Directive "' + t + '" requires one of [ ' + i.join(", ") + " ] as a parameter.";
                    for (var a = n[0].token, s = !1, o = 0; !s && o < i.length; o++)
                        i[o] === a && (s = !0);
                    return s ? (r[e] = a,
                    null) : 'Directive "' + t + '" requires one of [ ' + i.join(", ") + " ] as a parameter."
                }
                  , m = ["nobarlines", "barlines", "beataccents", "nobeataccents", "droneon", "droneoff", "drumon", "drumoff", "fermatafixed", "fermataproportional", "gchordon", "gchordoff", "controlcombo", "temperamentnormal", "noportamento"]
                  , g = ["gchord", "ptstress", "beatstring"]
                  , v = ["bassvol", "chordvol", "bassprog", "chordprog", "c", "channel", "beatmod", "deltaloudness", "drumbars", "gracedivider", "makechordchannels", "randomchordattack", "chordattack", "stressmodel", "transpose", "rtranspose", "vol", "volinc"]
                  , b = ["program"]
                ...
                i.parseFontChangeLine = function(e) {
                    ...
                    if (t.length > 1 && r.setfont) {
                        for (var n = [{
                            ...
                            "0" === t[i][0] ? n.push({
                                text: t[i].substring(1)
                            }) : "1" === t[i][0] && r.setfont[1] ? n.push({
                                font: r.setfont[1],
                                text: t[i].substring(1)
                            }) : "2" === t[i][0] && r.setfont[2] ? n.push({
                                font: r.setfont[2],
                                text: t[i].substring(1)
                            }) : "3" === t[i][0] && r.setfont[3] ? n.push({
                                font: r.setfont[3],
                                text: t[i].substring(1)
                            }) : "4" === t[i][0] && r.setfont[4] ? n.push({
                                font: r.setfont[4],
                                text: t[i].substring(1)
                ...
                function S(e) {
                    ...
                    return {
                        error: "Directive stretchlast requires zero or one parameter: false, true, or number between 0 and 1 (received " + e[0].token + ")"
                    }
                }
                i.addDirective = function(o) {
                    var E = e.tokenize(o, 0, o.length);
                    if (0 === E.length || "alpha" !== E[0].type)
                        return null;
                    var M = o.substring(o.indexOf(E[0].token) + E[0].token.length);
                    M = e.stripComment(M);
                    var N, A = E.shift().token.toLowerCase(), B = "";
                    switch (A) {
                    case "bagpipes":
                    ...
                    case "graceslurs":
                        ...
                        if ("0" === E[0].token || "false" === E[0].token)
                    ...
                    case "lineThickness":
                        var P = S(E);
                        if (void 0 !== P.value && (a.formatting.lineThickness = P.value),
                        P.error)
                            return P.error;
                        break;
                    case "stretchlast":
                        var L = S(E);
                        if (void 0 !== L.value && (a.formatting.stretchlast = L.value),
                        L.error)
                            return L.error;
                        break;
                    case "titlecaps":
                    ...
                    case "wordsspace":
                        return function(t, r) {
                            ...
                            return 0 === n.used || 0 !== r.length ? 'Directive "' + t + '" requires a measurement as a parameter.' : (a.formatting[t] = n.value,
                            null)
                        }(A, E);
                    case "voicescale":
                        ...
                        var H = E.shift();
                        return r.currentVoice && (r.currentVoice.scale = H.floatt,
                    ...
                    case "voicecolor":
                        ...
                        var O = E.shift();
                        return r.currentVoice && (r.currentVoice.color = O.token,
                        s.changeVoiceColor(r.currentVoice.color)),
                        null;
                    case "vskip":
                        var z = Math.round(function(t, r) {
                            var n = e.getMeasurement(r);
                            return 0 === n.used || 0 !== r.length ? {
                                error: 'Directive "' + t + '" requires a measurement as a parameter.'
                            } : n.value
                        }(A, E));
                        return z.error ? z.error : (s.addSpacing(z),
                        null);
                    case "scale":
                        h(A, E);
                        break;
                    case "sep":
                        if (0 === E.length)
                            ...
                            if (0 === (D = e.getMeasurement(E)).used || 0 !== E.length)
                                return 'Directive "' + A + '" requires 3 numbers: space above, space below, length of line';
                            var j = D.value;
                            s.addSeparator(F, I, j, {
                                startChar: r.iChar,
                                endChar: r.iChar + M.length
                            })
                        }
                        break;
                    case "barsperstaff":
                        if (null !== (B = d("barsperstaff", A, E)))
                            return B;
                        break;
                    case "staffnonote":
                        if (1 !== E.length)
                        ...
                        break;
                    case "printtempo":
                        if (null !== (B = f("printTempo", A, E)))
                            return B;
                        break;
                    case "partsbox":
                        if (null !== (B = f("partsBox", A, E)))
                            return B;
                        r.partsfont.box = r.partsBox;
                        break;
                    case "freegchord":
                        if (null !== (B = f("freegchord", A, E)))
                            return B;
                        break;
                    case "measurenb":
                    case "barnumbers":
                        if (null !== (B = d("barNumbers", A, E)))
                            return B;
                        break;
                    case "setbarnb":
                        if (1 !== E.length || "number" !== E[0].type)
                    ...
                    case "text":
                        ...
                        s.addText(i.parseFontChangeLine(G), {
                            startChar: r.iChar,
                            endChar: r.iChar + M.length + 7
                        });
                        break;
                    case "center":
                    ...
                    case "headerfont":
                        return function(e, t, r) {
                            return 0 === t.length ? 'Directive "' + e + '" requires a font as a parameter.' : (a.formatting[e] = c(t, a.formatting[e], r, 0, e),
                            null)
                        }(A, E, o);
                    case "barlabelfont":
                    case "barnumberfont":
                    ...
                    case "score":
                        ...
                        for (var R, X = function(e, t, i, a, s) {
                            ...
                            void 0 === r.voices[e] && (r.voices[e] = {
                                staffNum: o.index,
                                index: o.numVoices
                            },
                            o.numVoices++)
                        }, U = !1, K = !1, Q = !1, $ = !1, J = !1, Z = !1, ee = !1, te = function() {
                            if (ee = !0,
                            R) {
                                var e = "start";
                                R.staffNum > 0 && ("start" !== r.staves[R.staffNum - 1].connectBarLines && "continue" !== r.staves[R.staffNum - 1].connectBarLines || (e = "continue")),
                            ...
                            switch (re.token) {
                            case "(":
                                U ? t("Can't nest parenthesis in %%score", o, re.start) : (U = !0,
                                $ = !0);
                                break;
                            case ")":
                                ...
                                break;
                            case "[":
                                K ? t("Can't nest brackets in %%score", o, re.start) : (K = !0,
                                J = !0);
                                break;
                            case "]":
                                !K || J ? t("Unexpected close bracket in %%score", o, re.start) : (K = !1,
                                r.staves[R.staffNum].bracket = "end");
                                break;
                            case "{":
                                Q ? t("Can't nest braces in %%score", o, re.start) : (Q = !0,
                                Z = !0);
                                break;
                            case "}":
                                !Q || Z ? t("Unexpected close brace in %%score", o, re.start) : (Q = !1,
                                r.staves[R.staffNum].brace = "end");
                                break;
                            case "|":
                                te();
                                break;
                            default:
                                for (var ne = ""; ("alpha" === re.type || "number" === re.type) && (ne += re.token,
                                re.continueId); )
                                    re = E.shift();
                    ...
                    case "abc":
                        ...
                        case "-charset":
                            var se = ae.shift();
                            s.addMetaText(A + se, ae.join(" "), {
                                startChar: r.iChar,
                                endChar: r.iChar + M.length + 5
                            });
                            break;
                        default:
                    ...
                    case "footer":
                        ...
                        '"' === (oe = M.substring(oe.start, oe.end))[0] && '"' === oe[oe.length - 1] && (oe = oe.substring(1, oe.length - 1));
                        var ce = oe.split("\t")
                          , le = {};
                        le = 1 === ce.length ? {
                            left: "",
                    ...
                    case "midi":
                        ...
                        0 === he.length ? t("Expected midi command", M, 0) : function(e, r, n) {
                            var i = e.shift().token
                              , a = [];
                            if (m.indexOf(i) >= 0)
                                0 !== e.length && t("Unexpected parameter in MIDI " + i, n, 0);
                            else if (g.indexOf(i) >= 0)
                                1 !== e.length ? t("Expected one parameter in MIDI " + i, n, 0) : a.push(e[0].token);
                            else if (v.indexOf(i) >= 0)
                                1 !== e.length ? t("Expected one parameter in MIDI " + i, n, 0) : "number" !== e[0].type ? t("Expected one integer parameter in MIDI " + i, n, 0) : a.push(e[0].intt);
                            else if (b.indexOf(i) >= 0)
                                1 !== e.length && 2 !== e.length ? t("Expected one or two parameters in MIDI " + i, n, 0) : "number" !== e[0].type || 2 === e.length && "number" !== e[1].type ? t("Expected integer parameter in MIDI " + i, n, 0) : (a.push(e[0].intt),
                                2 === e.length && a.push(e[1].intt));
                            else if (y.indexOf(i) >= 0)
                                2 !== e.length ? t("Expected two parameters in MIDI " + i, n, 0) : "number" !== e[0].type || "number" !== e[1].type ? t("Expected two integer parameters in MIDI " + i, n, 0) : (a.push(e[0].intt),
                                a.push(e[1].intt));
                            else if (k.indexOf(i) >= 0)
                                2 !== e.length ? t("Expected two parameters in MIDI " + i, n, 0) : "alpha" !== e[0].type || "number" !== e[1].type ? t("Expected one string and one integer parameters in MIDI " + i, n, 0) : (a.push(e[0].token),
                                a.push(e[1].intt));
                            else if ("drummap" === i)
                                2 === e.length && "alpha" === e[0].type && "number" === e[1].type ? (r.formatting || (r.formatting = {}),
                                ...
                                a = r.formatting.midi.drummap) : 3 === e.length && "punct" === e[0].type && "alpha" === e[1].type && "number" === e[2].type ? (r.formatting || (r.formatting = {}),
                                r.formatting.midi || (r.formatting.midi = {}),
                                r.formatting.midi.drummap || (r.formatting.midi.drummap = {}),
                                r.formatting.midi.drummap[e[0].token + e[1].token] = e[2].intt,
                                a = r.formatting.midi.drummap) : t("Expected one note name and one integer parameter in MIDI " + i, n, 0);
                            else if (C.indexOf(i) >= 0)
                                3 !== e.length || "number" !== e[0].type || "/" !== e[1].token || "number" !== e[2].type ? t("Expected fraction parameter in MIDI " + i, n, 0) : (a.push(e[0].intt),
                                a.push(e[2].intt));
                            else if (x.indexOf(i) >= 0)
                                4 !== e.length ? t("Expected four parameters in MIDI " + i, n, 0) : "number" !== e[0].type || "number" !== e[1].type || "number" !== e[2].type || "number" !== e[3].type ? t("Expected four integer parameters in MIDI " + i, n, 0) : (a.push(e[0].intt),
                                a.push(e[1].intt),
                                a.push(e[2].intt),
                                a.push(e[3].intt));
                            else if (w.indexOf(i) >= 0)
                                5 !== e.length ? t("Expected five parameters in MIDI " + i, n, 0) : "number" !== e[0].type || "number" !== e[1].type || "number" !== e[2].type || "number" !== e[3].type || "number" !== e[4].type ? t("Expected five integer parameters in MIDI " + i, n, 0) : (a.push(e[0].intt),
                                a.push(e[1].intt),
                                a.push(e[2].intt),
                                a.push(e[3].intt),
                                a.push(e[4].intt));
                            else if (b.indexOf(i) >= 0)
                                1 !== e.length || 4 !== e.length ? t("Expected one or two parameters in MIDI " + i, n, 0) : "number" !== e[0].type ? t("Expected integer parameter in MIDI " + i, n, 0) : 4 === e.length ? ("octave" !== e[1].token && t("Expected octave parameter in MIDI " + i, n, 0),
                                "=" !== e[2].token && t("Expected octave parameter in MIDI " + i, n, 0),
                                "number" !== e[3].type && t("Expected integer parameter for octave in MIDI " + i, n, 0)) : (a.push(e[0].intt),
                            ...
                            s.hasBeginMusic() ? s.appendElement("midi", -1, -1, {
                                cmd: i,
                                params: a
                            }) : (void 0 === r.formatting.midi && (r.formatting.midi = {}),
                            r.formatting.midi[i] = a)
                        }(he, a, M);
                        break;
                    case "percmap":
                        var ue = function(e) {
                            ...
                            var r = t[0]
                              , n = parseInt(t[1], 10);
                            if ((isNaN(n) || n < 35 || n > 81) && t[1] && (n = u.indexOf(t[1].toLowerCase()) + 35),
                            isNaN(n) || n < 35 || n > 81)
                                return {
                            ...
                            return 3 === t.length && (i.noteHead = t[2]),
                            {
                                key: r,
                                value: i
                            }
                        }(M);
                        ue.error ? t(ue.error, o, 8) : (a.formatting.percmap || (a.formatting.percmap = {}),
                        a.formatting.percmap[ue.key] = ue.value);
                        break;
                    case "map":
                    case "playtempo":
                    case "auquality":
                ...
                i.globalFormatting = function(n) {
                    for (var i in n)
                        if (n.hasOwnProperty(i)) {
                            var s, o = "" + n[i], c = e.tokenize(o, 0, o.length);
                            switch (i) {
                            case "titlefont":
                            case "gchordfont":
                            case "composerfont":
                            ...
                            case "freegchord":
                                ...
                                break;
                            case "fontboxpadding":
                                1 === c.length && "number" === c[0].type || t('Directive "' + i + '" requires a number as a parameter.'),
                                a.formatting.fontboxpadding = c[0].floatt;
                                break;
                            case "stretchlast":
                                var u = S(c);
                                if (void 0 !== u.value && (a.formatting.stretchlast = u.value),
                                u.error)
                                    return u.error;
                                break;
                            default:
        ...
        9928: function(e, t, r) {
            ...
            e.exports = function(e, t, r, s, o) {
                this.reset = function(e, t, r, n) {
                    a.initialize(e, t, r, n, o),
                    i.initialize(e, t, r, n, o)
                }
                ,
                this.reset(e, t, r, s),
                ...
                this.setMeter = function(n) {
                    if ("C" === (n = e.stripComment(n)))
                        return !0 === r.havent_set_length && (r.default_length = .125,
                    ...
                    try {
                        var a = function() {
                            var e = function() {
                                ...
                                for ("(" === t.token && (t = i.shift()); ; ) {
                                    ...
                                    e.num += t.token,
                                    0 === i.length || "/" === i[0].token)
                                        return e;
                                    if (")" === (t = i.shift()).token) {
                                        if (0 === i.length || "/" === i[0].token)
                                            return e;
                        ...
                        return !0 === r.havent_set_length && (r.default_length = o < .75 ? .0625 : .125,
                        r.havent_set_length = !1),
                        s
                    } catch (e) {
                        t(e, n, 0)
                ...
                this.resolveTempo = function() {
                    r.tempo && (this.calcTempo(r.tempo),
                ...
                this.addUserDefinition = function(e, i, a) {
                    ...
                    if (-1 !== s) {
                        ...
                        1 === o.length ? -1 !== "HIJKLMNOPQRSTUVWXYhijklmnopqrstuvw~".indexOf(o) ? 0 !== c.length ? (void 0 === r.macros && (r.macros = {}),
                        r.macros[o] = c) : t("Missing macro definition", e, i) : t("Macro definitions must be H-Y, h-w, or tilde", e, i) : t("Macro definitions can only be one character", e, i)
                    } else
                        t("Need an = in a macro definition", e, i)
                }
                ,
                this.setDefaultLength = function(e, t, n) {
                    ...
                    if (2 === i.length) {
                        var a = parseInt(i[0])
                          , s = parseInt(i[1]);
                        s > 0 && (r.default_length = a / s,
                        r.havent_set_length = !1)
                    } else
                        1 === i.length && "1" === i[0] && (r.default_length = 1,
                        r.havent_set_length = !1)
                }
                ;
                var c = {
                ...
                this.setTempo = function(n, i, a, s) {
                    try {
                        ...
                        var l = {
                          ...
                          , h = !0
                          , u = o.shift();
                        if ("quote" === u.type && (l.preString = u.token,
                        u = o.shift(),
                        0 === o.length))
                            return c[l.preString.toLowerCase()] && (l.bpm = c[l.preString.toLowerCase()],
                            l.suppressBpm = !0),
                            {
                                type: "immediate",
                                tempo: l
                        ...
                        if ("alpha" === u.type && "C" === u.token) {
                            ...
                            if ("punct" === (u = o.shift()).type && "=" === u.token) {
                                ...
                                if (l.duration = [parseInt(u.token)],
                                0 === o.length)
                        ...
                        if (0 !== o.length && ("quote" === (u = o.shift()).type && (l.postString = u.token,
                        u = o.shift()),
                        0 !== o.length))
                            throw "Unexpected string at end of Q: field";
                        return !1 === r.printTempo && (l.suppress = !0),
                        {
                            type: h ? "delaySet" : "immediate",
                            tempo: l
                        }
                    } catch (e) {
                        return t(e, n, i),
                ...
                this.letter_to_inline_header = function(n, c, l) {
                    ...
                    n.length >= c + 5 && "[" === n[c] && ":" === n[c + 2]) {
                        ...
                        case "[M:":
                            ...
                            return o.hasBeginMusic() && m ? o.appendStartingElement("meter", d, f, m) : r.meter = m,
                            [u - c + 1 + h];
                        case "[K:":
                            var g = a.parseKey(n.substring(c + 3, u), !0);
                            return g.foundClef && o.hasBeginMusic() && o.appendStartingElement("clef", d, f, r.clef),
                            g.foundKey && o.hasBeginMusic() && o.appendStartingElement("key", d, f, a.fixKey(r.clef, r.key)),
                            [u - c + 1 + h];
                        case "[P:":
                            return l || s.lines.length <= s.lineNum ? r.partForNextLine = {
                            ...
                            [u - c + 1 + h];
                        case "[L:":
                            return this.setDefaultLength(n, c + 3, u),
                            [u - c + 1 + h];
                        case "[Q:":
                            if (u > 0) {
                                var v = this.setTempo(n, c + 3, u, r.iChar);
                                return "delaySet" === v.type ? o.hasBeginMusic() ? o.appendElement("tempo", d, f, this.calcTempo(v.tempo)) : r.tempoForNextLine = ["tempo", d, f, this.calcTempo(v.tempo)] : "immediate" === v.type && (!l && o.hasBeginMusic() ? o.appendElement("tempo", d, f, v.tempo) : r.tempoForNextLine = ["tempo", d, f, v.tempo]),
                                [u - c + 1 + h, n[c + 1], n.substring(c + 3, u)]
                            }
                            break;
                        case "[V:":
                            if (u > 0)
                                return a.parseVoice(n, c + 3, u),
                                [u - c + 1 + h, n[c + 1], n.substring(c + 3, u)];
                            break;
                        case "[r:":
                            return [u - c + 1 + h]
                ...
                this.letter_to_body_header = function(e, s) {
                    if (e.length >= s + 3)
                        ...
                        case "M:":
                            ...
                            return o.hasBeginMusic() && l && o.appendStartingElement("meter", r.iChar + s, r.iChar + e.length, l),
                            [e.length];
                        case "K:":
                            var h = a.parseKey(e.substring(s + 2), o.hasBeginMusic());
                            return h.foundClef && o.hasBeginMusic() && o.appendStartingElement("clef", r.iChar + s, r.iChar + e.length, r.clef),
                            h.foundKey && o.hasBeginMusic() && o.appendStartingElement("key", r.iChar + s, r.iChar + e.length, a.fixKey(r.clef, r.key)),
                            [e.length];
                        case "P:":
                            return o.hasBeginMusic() && o.appendElement("part", r.iChar + s, r.iChar + e.length, {
                                title: e.substring(s + 2)
                            }),
                            [e.length];
                        case "L:":
                            return this.setDefaultLength(e, s + 2, e.length),
                            [e.length];
                        case "Q:":
                            var u = e.indexOf("", s + 2);
                            -1 === u && (u = e.length);
                            var d = this.setTempo(e, s + 2, u, r.iChar);
                            return "delaySet" === d.type ? o.appendElement("tempo", r.iChar + s, r.iChar + e.length, this.calcTempo(d.tempo)) : "immediate" === d.type && o.appendElement("tempo", r.iChar + s, r.iChar + e.length, d.tempo),
                            [u, e[s], n.strip(e.substring(s + 2))];
                        case "V:":
                            return a.parseVoice(e, s + 2, e.length),
                            [e.length, e[s], n.strip(e.substring(s + 2))]
                        }
                    return [0]
                }
                ;
                ...
                this.parseHeader = function(n) {
                    var c = l[n[0]];
                    if (void 0 !== c)
                        return "unalignedWords" === c ? o.addMetaTextArray(c, i.parseFontChangeLine(e.translateString(e.stripComment(n.substring(2)))), {
                            startChar: r.iChar,
                    ...
                    switch (n[0]) {
                    case "H":
                        for (o.addMetaText("history", e.translateString(e.stripComment(n.substring(2))), {
                            startChar: r.iChar,
                            endChar: r.iChar + n.length
                        }),
                        n = e.peekLine(); n && ":" !== n[1]; )
                    ...
                    case "K":
                        ...
                        !r.is_in_header && o.hasBeginMusic() && (d.foundClef && o.appendStartingElement("clef", h, u, r.clef),
                    ...
                    case "M":
                        ...
                        break;
                    case "P":
                        r.is_in_header ? o.addMetaText("partOrder", e.translateString(e.stripComment(n.substring(2))), {
                            startChar: r.iChar,
                            endChar: r.iChar + n.length
                        }) : r.partForNextLine = {
                    ...
                    case "Q":
                        ...
                        "delaySet" === f.type ? r.tempo = f.tempo : "immediate" === f.type && (s.metaText.tempo ? r.tempoForNextLine = ["tempo", h, u, f.tempo] : s.metaText.tempo = f.tempo);
                        break;
                    case "T":
        ...
        9708: function(e, t, r) {
            ...
            !function() {
                ...
                s.addPosToKey = function(e, t) {
                    ...
                    r < -10 ? (t.accidentals.forEach((function(e) {
                        e.verticalPos -= 7,
                    ...
                    ))) : r < -4 ? (t.accidentals.forEach((function(e) {
                        e.verticalPos -= 7,
                    ...
                    ))) : r >= 7 && (t.accidentals.forEach((function(e) {
                        e.verticalPos += 7
                    }
                    )),
                    t.impliedNaturals && t.impliedNaturals.forEach((function(e) {
                ...
                s.parseKey = function(n, a) {
                    ...
                    var o = e.tokenize(n, 0, n.length)
                      , c = {};
                    if (0 === o.length)
                        return t("Must pass in key signature.", n, 0),
                        c;
                    switch (o[0].token) {
                    case "HP":
                    ...
                    default:
                        ...
                        if (h.len > 0) {
                            ...
                            if (o.length > 0) {
                                ...
                                if (p.len > 0 && (o[0].token.length > 1 ? o[0].token = o[0].token.substring(1) : o.shift(),
                                f += p.token,
                                u = p.token),
                                o.length > 0) {
                                ...
                                if (void 0 === s.standardKey(f, h.token, u, 0))
                                    return t("Unsupported key signature: " + f, n, 0),
                                    c
                            }
                            var g, v = s.deepCopyKey(r.key), b = !a && r.globalTranspose ? -r.globalTranspose : 0;
                            if (a && (g = r.globalTransposeOrigKeySig),
                            ...
                            v) {
                                for (var y, x = 0; x < r.key.accidentals.length; x++)
                                    for (y = 0; y < v.accidentals.length; y++)
                                        v.accidentals[y].note && r.key.accidentals[x].note.toLowerCase() === v.accidentals[y].note.toLowerCase() && (v.accidentals[y].note = null);
                                for (y = 0; y < v.accidentals.length; y++)
                                    v.accidentals[y].note && (r.key.impliedNaturals || (r.key.impliedNaturals = []),
                    ...
                    if (0 === o.length)
                        return c;
                    if ("exp" === o[0].token && o.shift(),
                    0 === o.length)
                        return c;
                    if ("oct" === o[0].token && o.shift(),
                    0 === o.length)
                        return c;
                    var w, k = e.getKeyAccidentals2(o);
                    if (k.warn && t(k.warn, n, 0),
                    k.accs) {
                        c.foundKey || (c.foundKey = !0,
                        r.key = {
                            root: "none",
                            acc: "",
                            mode: "",
                        ...
                        for (var C = 0; C < k.accs.length; C++) {
                            for (var T = !1, _ = 0; _ < r.key.accidentals.length && !T; _++)
                                r.key.accidentals[_].note === k.accs[C].note && (T = !0,
                                r.key.accidentals[_].acc !== k.accs[C].acc && (r.key.accidentals[_].acc = k.accs[C].acc,
                                r.key.explicitAccidentals || (r.key.explicitAccidentals = []),
                                r.key.explicitAccidentals.push(k.accs[C])));
                            if (!T && (r.key.explicitAccidentals || (r.key.explicitAccidentals = []),
                            r.key.explicitAccidentals.push(k.accs[C]),
                    ...
                    for (; o.length > 0; )
                        ...
                        case "middle":
                            ...
                            E.warn && t(E.warn, n, 0),
                            E.position && (r.clef.verticalPos = E.position - 6);
                            break;
                        case "transpose":
                            if (o.shift(),
                            0 === o.length)
                        ...
                        case "staffscale":
                            ...
                            r.clef.staffscale = o[0].floatt,
                            o.shift();
                            break;
                        case "octave":
                            if (o.shift(),
                            0 === o.length)
                                return t("Expected = after octave", n, 0),
                                c;
                            if ("=" !== (w = o.shift()).token) {
                            ...
                            if (0 === o.length)
                                return t("Expected parameter after octave=", n, 0),
                                c;
                            if ("number" !== o[0].type) {
                        ...
                        case "none":
                            ...
                            o.length > 0 && "number" === o[0].type && (M.token += o[0].token,
                            o.shift()),
                            o.length > 1 && ("-" === o[0].token || "+" === o[0].token || "^" === o[0].token || "_" === o[0].token) && "8" === o[1].token && (M.token += o[0].token + o[1].token,
                            o.shift(),
                            o.shift()),
                            r.clef = {
                                type: M.token,
                                verticalPos: l(M.token, 0)
                            },
                            r.currentVoice && void 0 !== r.currentVoice.transpose && (r.clef.transpose = r.currentVoice.transpose),
                            c.foundClef = !0;
                            break;
                        default:
                ...
                s.parseVoice = function(n, i, a) {
                    ...
                    if (0 !== d.length) {
                        ...
                        for (var p = {
                            ...
                            void 0 !== i.warn ? t("Expected value for " + r + " in voice: " + i.warn, n, c) : void 0 !== i.err ? t("Expected value for " + r + " in voice: " + i.err, n, c) : 0 === i.token.length && '"' !== n[c] ? t("Expected value for " + r + " in voice", n, c) : p[r] = i.token,
                            c += i.len
                        }, g = function(i, a, s) {
                            var o = e.getVoiceToken(n, c, h);
                            void 0 !== o.warn ? t("Expected value for " + a + " in voice: " + o.warn, n, c) : void 0 !== o.err ? t("Expected value for " + a + " in voice: " + o.err, n, c) : 0 === o.token.length && '"' !== n[c] ? t("Expected value for " + a + " in voice", n, c) : ("number" === s && (o.token = parseFloat(o.token)),
                            r.voices[i][a] = o.token),
                            c += o.len
                        }, v = function(r, i) {
                            var a = e.getVoiceToken(n, c, h);
                            if (void 0 !== a.warn)
                                t("Expected value for " + r + " in voice: " + a.warn, n, c);
                            else if (void 0 !== a.err)
                                t("Expected value for " + r + " in voice: " + a.err, n, c);
                            else {
                                if (0 !== a.token.length || '"' === n[c])
                                    return "number" === i && (a.token = parseFloat(a.token)),
                                    a.token;
                            ...
                            y.warn)
                                ...
                                case "cl":
                                    m("clef");
                                    var w = 0;
                                    void 0 !== p.clef && (p.clef = p.clef.replace(/[',]/g, ""),
                                    -1 !== p.clef.indexOf("+16") && (w += 14,
                                ...
                                case "stem":
                                case "stems":
                                    void 0 !== (x = e.getVoiceToken(n, c, h)).warn ? t("Expected value for stems in voice: " + x.warn, n, c) : void 0 !== x.err ? t("Expected value for stems in voice: " + x.err, n, c) : "up" === x.token || "down" === x.token ? r.voices[d].stem = x.token : t("Expected up or down for voice stem", n, c),
                                    c += x.len;
                                    break;
                                case "up":
                                case "down":
                                ...
                                case "gch":
                                    ...
                                    "0" === (x = e.getVoiceToken(n, c, h)).token && (c += x.len);
                                    break;
                                case "space":
                                case "spc":
                                    m("spacing");
                                ...
                                case "cue":
                                    var k = v("cue", "string");
                                    r.voices[d].scale = "on" === k ? .6 : 1;
                                    break;
                                case "style":
                                    void 0 !== (x = e.getVoiceToken(n, c, h)).warn ? t("Expected value for style in voice: " + x.warn, n, c) : void 0 !== x.err ? t("Expected value for style in voice: " + x.err, n, c) : "normal" === x.token || "harmonic" === x.token || "rhythm" === x.token || "x" === x.token || "triangle" === x.token ? r.voices[d].style = x.token : t("Expected one of [normal, harmonic, rhythm, x, triangle] for voice style", n, c),
                                    c += x.len
                                }
                            }
                            c += e.eatWhiteSpace(n, c)
                        }
                        if ((p.startStaff || 0 === r.staves.length) && (r.staves.push({
                            index: r.staves.length,
                            meter: r.origMeter
                        }),
                        ...
                        function(e) {
                            ...
                            o.setCurrentVoice(r.currentVoice.staffNum, r.currentVoice.index)
                        }(d)
                    } else
                        t("Expected a voice id", n, c)
                }
            }(),
            e.exports = s
        },
        6476: function(e, t, r) {
            var n, i, a, s, o, c, l = r(5008), h = r(9708), u = r(2821), d = function(e, t, r, l, h, u) {
                n = e,
                i = t,
                a = r,
                s = l,
            ...
            d.prototype.parseMusic = function(e) {
                c.resolveTempo(),
                a.is_in_header = !1;
                for (var t = 0, r = a.iChar; n.isWhiteSpace(e[t]) && t < e.length; )
                    t++;
                if (t !== e.length && "%" !== e[t]) {
                    ...
                    for (var d = 0; t < e.length; ) {
                        ...
                        if (w[0] > 0)
                            ...
                            var k;
                            for ((!o.hasBeginMusic() || l && !this.lineContinuation) && (this.startNewLine(),
                            l = !1); ; )
                                if ((k = n.eatWhiteSpace(e, t)) > 0 && (t += k),
                                t > 0 && "" === e[t - 1] && (k = c.letter_to_body_header(e, t))[0] > 0 && ("V" === k[1] && this.startNewLine(),
                                t = k[0],
                                a.start_new_line = !1),
                                (k = S(e, t))[0] > 0 && (t += k[0]),
                                (k = g(e, t))[0] > 0) {
                                    ...
                                    for (var T = !1, M = 0; M < p.chord.length; M++)
                                        p.chord[M].position === k[2] && (T = !0,
                                        p.chord[M].name += "\n" + C);
                                    !1 === T && (null === k[2] && k[3] ? p.chord.push({
                                        name: C,
                                        rel_position: k[3]
                                    }) : p.chord.push({
                                        name: C,
                                    ...
                                    B > 0 && (p.force_end_beam_last = !0),
                                    t += B
                                } else if ((k = -1 === "ABCDEFGabcdefgxyzZ[]|^_{".indexOf(e[t]) ? _(e, t) : [0])[0] > 0)
                                    null === k[1] ? t + 1 < e.length && this.startNewLine() : k[1].length > 0 && (0 === k[1].indexOf("style=") ? p.style = k[1].substr(6) : (void 0 === p.decoration && (p.decoration = []),
                                    "beambr1" === k[1] ? p.beambr = 1 : "beambr2" === k[1] ? p.beambr = 2 : p.decoration.push(k[1]))),
                                    t += k[0];
                                else {
                                    if (!((k = v(e, t))[0] > 0))
                                        break;
                            ...
                            if ((k = E(e, t))[0] > 0) {
                                ...
                                0 === P.type.length ? i("Unknown bar type", e, t) : (a.inEnding && "bar_thin" !== P.type && (P.endEnding = !0,
                                a.inEnding = !1),
                                k[2] && (P.startEnding = k[2],
                                a.inEnding && (P.endEnding = !0),
                                a.inEnding = !0,
                                "bar_right_repeat" === k[1] ? a.restoreStartEndingHoldOvers() : a.duplicateStartEndingHoldOvers()),
                                void 0 !== p.decoration && (P.decoration = p.decoration),
                                void 0 !== p.chord && (P.chord = p.chord),
                                P.startEnding && void 0 === a.barFirstEndingNum ? a.barFirstEndingNum = a.currBarNumber : P.startEnding && P.endEnding && a.barFirstEndingNum ? a.currBarNumber = a.barFirstEndingNum : P.endEnding && (a.barFirstEndingNum = void 0),
                                "bar_invisible" !== P.type && a.measureNotEmpty && (void 0 === a.currentVoice || 0 === a.currentVoice.staffNum && 0 === a.currentVoice.index) && (a.currBarNumber++,
                                ...
                                (k = b(e, t))[0] > 0 && (o.appendElement("overlay", r, r + 1, {}),
                                t += 1,
                                d++);
                            else {
                                if ((k = N(e, t)).consumed > 0 && (void 0 !== k.startSlur && (p.startSlur = k.startSlur),
                                k.dottedSlur && (p.dottedSlur = !0),
                                void 0 !== k.triplet && (h > 0 ? i("Can't nest triplets", e, t) : (p.startTriplet = k.triplet,
                                ...
                                "[" === e[t]) {
                                    ...
                                    for (var L = null, z = !1, D = !1; !D; ) {
                                        ...
                                        if (null !== I && void 0 !== I.pitch)
                                            F[0] > 0 && 0 !== F[1].indexOf("style=") && (void 0 === p.decoration && (p.decoration = []),
                                            p.decoration.push(F[1])),
                                            I.end_beam && (p.end_beam = !0,
                                            delete I.end_beam),
                                            void 0 === p.pitches ? (p.duration = I.duration,
                                            p.pitches = [I]) : p.pitches.push(I),
                                            delete I.duration,
                                            F[0] > 0 && 0 === F[1].indexOf("style=") && (p.pitches[p.pitches.length - 1].style = F[1].substr(6)),
                                            a.inTieChord[p.pitches.length] && (I.endTie = !0,
                                            a.inTieChord[p.pitches.length] = void 0),
                                            I.startTie && (a.inTieChord[p.pitches.length] = !0),
                                            t = I.endChar,
                                            delete I.endChar;
                                        else if (" " === e[t])
                                            i("Spaces are not allowed in chords", e, t),
                                            t++;
                                        else {
                                            if (t < e.length && "]" === e[t]) {
                                                t++,
                                                0 !== a.next_note_duration && (p.duration = p.duration * a.next_note_duration,
                                                a.next_note_duration = 0),
                                                f(a, d, p) && (p.pitches.forEach((function(e) {
                                                    e.endTie = !0
                                                }
                                                )),
                                                m(a, d, !1)),
                                                ...
                                                i("Expected ']' to end the chords", e, t);
                                            void 0 !== p.pitches && (null !== L && (p.duration = p.duration * L,
                                            z && A(p)),
                                            a.addFormattingOptions(p, s.formatting, "note"),
                                    ...
                                    null !== W && (void 0 !== W.pitch ? (p.pitches = [{}],
                                    ...
                                    void 0 !== p.startTie && (p.pitches[0].startTie = p.startTie)) : (p.rest = W.rest,
                                    ...
                                    delete p.startSlur,
                                    delete p.dottedSlur,
                                    f(a, d, p) && (void 0 !== p.pitches ? p.pitches[0].endTie = !0 : "spacer" !== p.rest.type && (p.rest.endTie = !0),
                                    m(a, d, !1)),
                                    (W.startTie || p.startTie) && m(a, d, !0),
                                    t = W.endChar,
                                    h > 0 && (!W.rest || "spacer" !== W.rest.type) && 0 == --h && (p.endTriplet = !0),
                                    W.end_beam && A(p),
                                    p.rest && "rest" === p.rest.type && 1 === p.duration && y(a) <= 1 && (p.rest.type = "whole",
                                    p.duration = y(a)),
                                    p.duration < 1 && -1 === [.5, .75, .875, .9375, .96875, .984375, .25, .375, .4375, .46875, .484375, .4921875, .125, .1875, .21875, .234375, .2421875, .24609375, .0625, .09375, .109375, .1171875, .12109375, .123046875, .03125, .046875, .0546875, .05859375, .060546875, .0615234375, .015625, .0234375, .02734375, .029296875, .0302734375, .03076171875].indexOf(p.duration) && 0 !== p.duration && (p.rest && "spacer" === p.rest.type || i("Duration not representable: " + e.substring(x, t), e, t)),
                                    a.addFormattingOptions(p, s.formatting, "note"),
                                    o.appendElement("note", r + x, r + t, p),
                                    a.measureNotEmpty = !0,
                                    p = {})
                                }
                                t === x && (" " !== e[t] && "`" !== e[t] && i("Unknown character ignored", e, t),
                                t++)
                            }
                        }
                    }
                    this.lineContinuation = e.indexOf("") >= 0 || u[0] > 0,
            ...
            var m = function(e, t, r) {
                var n = e.currentVoice ? 100 * e.currentVoice.staffNum + e.currentVoice.index : 0;
                void 0 === e.inTie[t] && (e.inTie[t] = []),
                e.inTie[t][n] = r
            }
              , g = function(e, t) {
                if ('"' === e[t]) {
                    var r = n.getBrackettedSubstring(e, t, 5);
                    if (r[2] || i("Missing the closing quote while parsing the chord symbol", e, t),
                    r[0] > 0 && r[1].length > 0 && "^" === r[1][0])
                        r[1] = r[1].substring(1),
                        r[2] = "above";
                    else if (r[0] > 0 && r[1].length > 0 && "_" === r[1][0])
                        r[1] = r[1].substring(1),
                        r[2] = "below";
                        ...
                        !0 !== a.freegchord && (r[1] = r[1].replace(/([ABCDEFG0-9])b/g, "$1♭"),
              ...
              , v = function(e, t) {
                if ("{" === e[t]) {
                    ...
                    for (var s = [], o = 0, c = !1; o < r[1].length; ) {
                        ...
                        o++);
                        var h = H(r[1], o, {}, !1);
                        null !== h ? (h.duration = h.duration / (8 * a.default_length),
                        l && (h.acciaccatura = !0),
                        s.push(h),
                        c && (h.endTie = !0,
                        c = !1),
                        ...
                        o = h.endChar,
                        delete h.endChar,
                        h.end_beam && (h.endBeam = !0,
                        delete h.end_beam)) : (" " === r[1][o] ? s.length > 0 && (s[s.length - 1].endBeam = !0) : i("Unknown character '" + r[1][o] + "' while parsing grace note", e, t),
                        o++)
                    }
                    if (s.length)
                        return [r[0], s]
            ...
            var x = ["trill", "lowermordent", "uppermordent", "mordent", "pralltriller", "accent", "fermata", "invertedfermata", "tenuto", "0", "1", "2", "3", "4", "5", "+", "wedge", "open", "thumb", "snap", "turn", "roll", "breath", "shortphrase", "mediumphrase", "longphrase", "segno", "coda", "D.S.", "D.C.", "fine", "beambr1", "beambr2", "slide", "marcato", "upbow", "downbow", "/", "//", "///", "////", "trem1", "trem2", "trem3", "trem4", "turnx", "invertedturn", "invertedturnx", "trill(", "trill)", "arpeggio", "xstem", "mark", "umarcato", "style=normal", "style=harmonic", "style=rhythm", "style=x", "style=triangle", "D.C.alcoda", "D.C.alfine", "D.S.alcoda", "D.S.alfine", "editorial", "courtesy"]
              ...
              , _ = function(e, t) {
                ...
                case "+":
                    ...
                    if (s[1].length > 1 && ("^" === s[1][0] || "_" === s[1][0]) && (s[1] = s[1].substring(1)),
                    x.includes(s[1]))
                        return s;
                    if (w.includes(s[1]))
                        return "hidden" === a.volumePosition && (s[1] = ""),
                        s;
                    if (k.includes(s[1]))
                        return "hidden" === a.dynamicPosition && (s[1] = ""),
                        s;
                    var o = C.findIndex((function(e) {
                        return s[1] === e[0]
                    }
                    ));
                    return o >= 0 ? (s[1] = C[o][1],
                    s) : (o = T.findIndex((function(e) {
                        return s[1] === e[0]
                    }
                    ))) >= 0 ? (s[1] = T[o][1],
                    "hidden" === a.dynamicPosition && (s[1] = ""),
                    s) : "!" !== e[t] || 1 !== s[0] && "!" === e[t + s[0] - 1] ? (i("Unknown decoration: " + s[1], e, t),
                    s[1] = "",
                    s) : [1, null];
                case "H":
                    return [1, "fermata"];
              ...
              , S = function(e, t) {
                for (var r = t; n.isWhiteSpace(e[t]); )
                    t++;
                return [t - r]
            }
              , E = function(e, t) {
              ...
              , N = function(e, t) {
                var r = {}
                  , a = t;
                for ("." === e[t] && "(" === e[t + 1] && (r.dottedSlur = !0,
                t++); "(" === e[t] || n.isWhiteSpace(e[t]); )
                    "(" === e[t] && (t + 1 < e.length && e[t + 1] >= "2" && e[t + 1] <= "9" ? (void 0 !== r.triplet ? i("Can't nest triplets", e, t) : (r.triplet = e[t + 1] - "0",
                    r.tripletQ = M[r.triplet],
                    r.num_notes = r.triplet,
                    t + 2 < e.length && ":" === e[t + 2] && (t + 3 < e.length && ":" === e[t + 3] ? t + 4 < e.length && e[t + 4] >= "1" && e[t + 4] <= "9" ? (r.num_notes = e[t + 4] - "0",
                    t += 3) : i("expected number after the two colons after the triplet to mark the duration", e, t) : t + 3 < e.length && e[t + 3] >= "1" && e[t + 3] <= "9" ? (r.tripletQ = e[t + 3] - "0",
                    t + 4 < e.length && ":" === e[t + 4] ? t + 5 < e.length && e[t + 5] >= "1" && e[t + 5] <= "9" && (r.num_notes = e[t + 5] - "0",
                    t += 4) : t += 2) : i("expected number after the triplet to mark the duration", e, t))),
                    t++) : void 0 === r.startSlur ? r.startSlur = 1 : r.startSlur++),
                    t++;
                return r.consumed = t - a,
                r
            };
            d.prototype.startNewLine = function() {
                ...
                e.clef = a.currentVoice && void 0 !== a.staves[a.currentVoice.staffNum].clef ? l.clone(a.staves[a.currentVoice.staffNum].clef) : l.clone(a.clef);
                var t = a.currentVoice ? a.currentVoice.scoreTranspose : 0;
                if (e.key = h.standardKey(a.key.root + a.key.acc + a.key.mode, a.key.root, a.key.acc, t),
                ...
                a.key.explicitAccidentals)
                    for (var r = 0; r < a.key.explicitAccidentals.length; r++) {
                        for (var n = !1, i = 0; i < e.key.accidentals.length; i++)
                            e.key.accidentals[i].note === a.key.explicitAccidentals[r].note && (e.key.accidentals[i].acc = a.key.explicitAccidentals[r].acc,
                            n = !0);
                        n || e.key.accidentals.push(a.key.explicitAccidentals[r])
                    }
                if (a.targetKey = e.key,
                e.key.explicitAccidentals && delete e.key.explicitAccidentals,
                h.addPosToKey(e.clef, e.key),
                null !== a.meter ? (a.currentVoice ? (a.staves.forEach((function(e) {
                    e.meter = a.meter
                }
                )),
                e.meter = a.staves[a.currentVoice.staffNum].meter,
                a.staves[a.currentVoice.staffNum].meter = null) : e.meter = a.meter,
                a.meter = null) : a.currentVoice && a.staves[a.currentVoice.staffNum].meter && (e.meter = a.staves[a.currentVoice.staffNum].meter,
                ...
                a.partForNextLine = {},
                4 === a.tempoForNextLine.length && o.appendElement(a.tempoForNextLine[0], a.tempoForNextLine[1], a.tempoForNextLine[2], a.tempoForNextLine[3]),
                a.tempoForNextLine = []
            }
            ;
            var A = function(e) {
                ...
                for (var h = "startSlur", d = !1; ; ) {
                    ...
                    case "g":
                        if ("startSlur" !== h && "sharp2" !== h && "flat2" !== h && "pitch" !== h)
                            ...
                            r) : null;
                        if (r.pitch = B[e[t]],
                        r.pitch += 7 * (a.currentVoice && void 0 !== a.currentVoice.octave ? a.currentVoice.octave : a.octave),
                        r.name = e[t],
                        r.accidental && (r.name = L[r.accidental] + r.name),
                        u.note(a, r),
                        h = "octave",
                        i && 0 !== a.next_note_duration ? (r.duration = a.default_length * a.next_note_duration,
                        a.next_note_duration = 0,
                        ...
                        a.clef && "perc" === a.clef.type || a.currentVoice && "perc" === a.currentVoice.clef) {
                            ...
                            s.formatting && s.formatting.midi && s.formatting.midi.drummap && (r.midipitch = s.formatting.midi.drummap[f])
                        }
                        break;
                    case ",":
                        if ("octave" !== h)
                    ...
                    case "Z":
                        ...
                        r.rest.type.indexOf("multimeasure") >= 0 ? (r.duration = s.getBarLength(),
                        r.rest.text = 1,
                        h = "Zduration") : (i && 0 !== a.next_note_duration ? (r.duration = a.default_length * a.next_note_duration,
                        a.next_note_duration = 0,
                        d = !0) : r.duration = a.default_length,
                        h = "duration");
                        break;
                    ...
                    case "/":
                        if ("octave" === h || "duration" === h) {
                            ...
                            for (r.duration = r.duration * p.value,
                            r.endChar = p.index; p.index < e.length && (n.isWhiteSpace(e[p.index]) || "-" === e[p.index]); )
                                "-" === e[p.index] ? r.startTie = {} : r = A(r),
                                p.index++;
                            t = p.index - 1,
                            h = "broken_rhythm"
                        } else if ("sharp2" === h)
                            ...
                            if ("flat2" !== h) {
                                if ("Zduration" === h) {
                                    ...
                                    return r.duration = m.num * s.getBarLength(),
                                    r.rest.text = m.num,
                                    r.endChar = m.index,
                                    r
                                }
                    ...
                    case "-":
                        if ("startSlur" === h)
                            o.addTieToLastNote(c),
                            r.endTie = !0;
                        else {
                            if ("octave" !== h && "duration" !== h && "end_slur" !== h)
                                return "broken_rhythm" === h ? (r.endChar = t,
                                r) : null;
                            if (r.startTie = {},
                            d || !i)
                                return n.isWhiteSpace(e[t + 1]) && A(r),
                                r.endChar = t + 1,
                                r;
                            h = "broken_rhythm"
                        }
                    ...
                    case "\t":
                        ...
                        do {
                            ...
                            t++),
                            "-" === e[t] && (r.startTie = {},
                            c && (r.startTie.style = "dotted")),
                            t++
                        } while (t < e.length && (n.isWhiteSpace(e[t]) || "-" === e[t]) || "." === e[t] && "-" === e[t + 1]);
                        if (r.endChar = t,
                        d || !i || "<" !== e[t] && ">" !== e[t])
                            return r;
                        t--,
              ...
              , O = function(e, t) {
                switch (e[t]) {
                case ">":
                    return t < e.length - 2 && ">" === e[t + 1] && ">" === e[t + 2] ? [3, 1.875, .125] : t < e.length - 1 && ">" === e[t + 1] ? [2, 1.75, .25] : [1, 1.5, .5];
                case "<":
                    return t < e.length - 2 && "<" === e[t + 1] && "<" === e[t + 2] ? [3, .125, 1.875] : t < e.length - 1 && "<" === e[t + 1] ? [2, .25, 1.75] : [1, .5, 1.5]
                }
                return null
            };
            e.exports = d
            ...
            var n = r(5008)
              , i = function(e, t) {
                ...
                this.getMode = function(e) {
                    var t = function(e, t) {
                        for (; t < e.length && (e[t] >= "a" && e[t] <= "z" || e[t] >= "A" && e[t] <= "Z"); )
                            t++;
                        return t
                    }
                    ...
                    switch ((i.length > 1 && " " === i[1] || "^" === i[1] || "_" === i[1] || "=" === i[1]) && (i = i[0]),
                    i) {
                    case "mix":
                        return {
                            len: t(e, n),
                ...
                this.getClef = function(e, t) {
                    ...
                    if (n.startsWith(o, "treble"))
                        ...
                        l = "alto";
                    else if (!t && s && n.startsWith(o, "none"))
                        l = "none";
                    else if (n.startsWith(o, "perc"))
                        l = "perc";
                    else if (!t && s && n.startsWith(o, "C"))
                        l = "tenor";
                    else if (!t && s && n.startsWith(o, "F"))
                        l = "bass";
                    else {
                ...
                this.getToken = function(e, t, r) {
                    for (var n = t; n < r && !this.isWhiteSpace(e[n]); )
                        n++;
                ...
                this.getKeyAccidentals2 = function(e) {
                    for (var t; e.length > 0; ) {
                        ...
                        default:
                            return {
                                accs: t,
                                warn: "Expected note name after " + r + " Found: " + e[0].token
                            }
                        }
                    }
                    return {
                ...
                this.getMeat = function(e, t, r) {
                    var n = e.indexOf("%", t);
                    for (n >= 0 && n < r && (r = n); t < r && (" " === e[t] || "\t" === e[t] || "" === e[t]); )
                        t++;
                    for (; t < r && (" " === e[r - 1] || "\t" === e[r - 1] || "" === e[r - 1]); )
                        r--;
                    return {
                        start: t,
                        end: r
                ...
                this.tokenize = function(e, t, r, n) {
                    ...
                    for (var o, c = []; t < r; ) {
                        if ('"' === e[t]) {
                            ...
                            o = t + 1;
                            for (var h, u = null; o < r && a(e[o]); )
                                o++;
                            if ("." === e[o] && a(e[o + 1]))
                                for (o++; o < r && a(e[o]); )
                                    o++;
                            else
                                u = parseInt(e.substring(t, o));
                ...
                this.getVoiceToken = function(e, t, r) {
                    for (var n = t; n < r && this.isWhiteSpace(e[n]) || "=" === e[n]; )
                        n++;
                    if ('"' === e[n]) {
                        var i = e.indexOf('"', n + 1);
                        return -1 === i || i >= r ? {
                            ...
                            len: i - t + 1,
                            token: this.translateString(e.substring(n + 1, i))
                        }
                    }
                    for (var a = n; a < r && !this.isWhiteSpace(e[a]) && "=" !== e[a]; )
                        a++;
                    return {
                        len: a - t + 1,
                ...
                this.translateString = function(e) {
                    ...
                    return t.forEach((function(e) {
                        if (null === r)
                            ...
                            void 0 !== t ? r += t + e.substring(2) : void 0 !== (t = c[e.substring(0, 3)]) ? r += t + e.substring(3) : (t = o[e.substring(0, 1)],
                ...
                this.getMeasurement = function(e) {
                    ...
                    if ("." === n.token) {
                        ...
                        if ("number" === e[0].type && (r = r + "." + (n = e.shift()).token,
                        t++,
                        0 === e.length))
                            return {
                                used: t,
                    ...
                    case "cm":
                        return {
                            used: t + 1,
                            value: parseFloat(r) / 2.54 * 72
                        };
                    case "in":
                        return {
                            used: t + 1,
                            value: 72 * parseFloat(r)
                        };
                    default:
                        return e.unshift(n),
                        {
                ...
                this.getBrackettedSubstring = function(e, t, r, n) {
                    for (var i = n || e[t], a = t + 1, s = !1; a < e.length && (s || e[a] !== i); )
                        s = "\\" === e[a],
                        ++a;
                    return e[a] === i ? [a - t + 1, l(e.substring(t + 1, a)), !0] : ((a = t + r) > e.length - 1 && (a = e.length - 1),
                    [a - t + 1, l(e.substring(t + 1, a)), !1])
                }
            };
        ...
        2821: function(e, t, r) {
            ...
            s.keySignature = function(e, t, r, n, i) {
                ...
                if (!s)
                    return e.key;
                if (e.localTranspose = (e.globalTranspose ? e.globalTranspose : 0) + i,
                !e.localTranspose)
                    return {
                        accidentals: s,
                        root: r,
                ...
                if (e.globalTransposeOrigKeySig = s,
                ...
                var h = t[0];
                "b" === t[1] || "#" === t[1] ? (h += t[1],
                t = t.substr(2)) : t = t.substr(1);
                var u = o[h]
                  , d = void 0 !== u;
                d || (u = 0,
                h = "C",
                t = "");
                for (var f = u + e.localTranspose; f < 0; )
                    f += 12;
                f > 11 && (f %= 12);
                var p = "m" === t[0] ? l[f] : c[f]
                  , m = p + t
                ...
                return e.localTranspose > 0 ? v < 0 ? v += 7 : 0 === v && ("#" !== h[1] && "b" !== m[1] || (v += 7)) : e.localTranspose < 0 && (v > 0 ? v -= 7 : 0 === v && ("b" !== h[1] && "#" !== m[1] || (v -= 7))),
                e.localTranspose > 0 ? e.localTransposeVerticalMovement = v + 7 * Math.floor(e.localTranspose / 12) : e.localTransposeVerticalMovement = v + 7 * Math.ceil(e.localTranspose / 12),
                d ? {
                    accidentals: g,
                    root: p[0],
                    acc: p.length > 1 ? p[1] : ""
            ...
            s.note = function(e, t) {
                if (e.localTranspose && "perc" !== e.clef.type) {
                    var r = t.pitch;
                    if (e.localTransposeVerticalMovement && (t.pitch = t.pitch + e.localTransposeVerticalMovement,
                    t.name)) {
        ...
        867: function(e) {
            var t = {}
              , r = ["C,,,", "D,,,", "E,,,", "F,,,", "G,,,", "A,,,", "B,,,", "C,,", "D,,", "E,,", "F,,", "G,,", "A,,", "B,,", "C,", "D,", "E,", "F,", "G,", "A,", "B,", "C", "D", "E", "F", "G", "A", "B", "c", "d", "e", "f", "g", "a", "b", "c'", "d'", "e'", "f'", "g'", "a'", "b'", "c''", "d''", "e''", "f''", "g''", "a''", "b''", "c'''", "d'''", "e'''", "f'''", "g'''", "a'''", "b'''"];
        ...
        4208: function(e) {
            ...
            e.exports = function(e, a, s, o) {
                ...
                if (!c)
                    return e;
                var l, h = c[1], u = c[2], d = c[3], f = c[4];
                return (l = t.indexOf(h)) < 0 && (l = r.indexOf(h)),
                l < 0 && (l = n.indexOf(h)),
                l < 0 && (l = i.indexOf(h)),
                l < 0 || (l += a,
                l %= 12,
                ...
                u && (e += u),
                d && ((l = t.indexOf(d)) < 0 && (l = r.indexOf(d)),
                l < 0 && (l = n.indexOf(d)),
                l < 0 && (l = i.indexOf(d)),
                e += "/",
                l >= 0 ? (l += a,
                l %= 12,
                e += s ? o ? i[l] : r[l] : o ? n[l] : t[l]) : e += d),
                f && (e += f)),
                e
            }
        },
        575: function(e, t, r) {
            ...
            e.exports = function(e) {
                                ...
                                for (var c = s.staff[o], l = [], h = 0; h < c.voices.length; h++) {
                                    ...
                                    for (var d = 0, f = !1, p = 0, m = -1, g = 0; g < u.length; g++) {
                                        ...
                                        if ("overlay" !== v.el_type || f)
                                            ...
                                            l[h].voice.push(v)) : (d > 0 && l[h].voice.push({
                                                el_type: "note",
                                                duration: d,
                                                rest: {
                                                    type: "invisible"
                                            ...
                                            l[h].voice.push(v)),
                                            d = 0) : "note" === v.el_type ? f ? l[h].voice.push(v) : (d += v.duration,
                                            n[a] += v.duration) : "scale" !== v.el_type && "stem" !== v.el_type && "overlay" !== v.el_type && "style" !== v.el_type && "transpose" !== v.el_type && "color" !== v.el_type || l[h].voice.push(v);
                                        else {
                                            t = !0,
                                            f = !0,
                                            m = g,
                                            ...
                                            0 === p && (p = n[a]);
                                            for (var b = 0; b < a; b++)
                                                n[b] && e.lines[b].staff && c.voices.length >= e.lines[b].staff[0].voices.length && e.lines[b].staff[0].voices.push([{
                                                    el_type: "note",
                                                    duration: n[b],
                                                    rest: {
                                                        type: "invisible"
                                    ...
                                    l[h].hasOverlay && 0 === l[h].snip.length && l[h].snip.push({
                                        start: m,
                                        len: u.length - m
                                    })
                                }
                ...
                this.cleanUp = function(t, r, a) {
                    ...
                    e.metaText.tempo && e.metaText.tempo.bpm && !e.metaText.tempo.duration && (e.metaText.tempo.duration = [e.getBeatLength()]);
                    var s, o, c, l = !1;
                        ...
                        if (void 0 !== e.lines[s].staff) {
                            ...
                            for (o = 0; o < e.lines[s].staff.length; o++)
                                if (void 0 === e.lines[s].staff[o])
                                    l = !0,
                                    e.lines[s].staff[o] = null;
                                else
                                    for (c = 0; c < e.lines[s].staff[o].voices.length; c++)
                                        void 0 === e.lines[s].staff[o].voices[c] ? e.lines[s].staff[o].voices[c] = [] : this.containsNotes(e.lines[s].staff[o].voices[c]) && (h = !0);
                            h || (e.lines[s] = null,
                            l = !0)
                        }
                    if (l && (e.lines = e.lines.filter((function(e) {
                        return !!e
                    }
                    )),
                    e.lines.forEach((function(e) {
                        e.staff && (e.staff = e.staff.filter((function(e) {
                            return !!e
                        }
                        )))
                    }
                    ...
                    function d(e, t, r) {
                        ...
                        for (var i = function(e, i, s) {
                            ...
                            for (var c, l = 0; l < i; l++)
                                c = a[t][r][s].pop(),
                                e.endSlur.push(c);
                            return 0 === a[t][r][s].length && delete a[t][r][s],
                            c
                        }, s = function(e, n, i, s) {
                            e.startSlur = [],
                            void 0 === a[t][r][i] && (a[t][r][i] = []);
                            for (var o = 100 * i + 1, c = 0; c < n; c++)
                                ...
                                e.dottedSlur && (e.startSlur[e.startSlur.length - 1].style = "dotted",
                                delete e.dottedSlur),
                                o++
                        }, o = 0; o < e.length; o++) {
                            var c = e[o];
                            if ("note" === c.el_type) {
                                if (c.gracenotes)
                                    for (var l = 0; l < c.gracenotes.length; l++) {
                                        if (c.gracenotes[l].endSlur) {
                                            ...
                                            for (var u = 0; u < h; u++)
                                                i(c.gracenotes[l], 1, 20)
                                        }
                                        c.gracenotes[l].startSlur && (n = c.gracenotes[l].startSlur,
                                        s(c.gracenotes[l], n, 20))
                                    }
                                if (c.endSlur && (n = c.endSlur,
                                c.endSlur = [],
                                i(c, n, 0)),
                                ...
                                c.pitches) {
                                    ...
                                    for (f = 0; f < c.pitches.length; f++)
                                        c.pitches[f].startSlur && (n = c.pitches[f].startSlur,
                                        s(c.pitches[f], n, f + 1, d));
                                    c.gracenotes && c.pitches[0].endSlur && 100 === c.pitches[0].endSlur[0] && c.pitches[0].startSlur && (c.gracenotes[0].endSlur ? c.gracenotes[0].endSlur.push(c.pitches[0].startSlur[0].label) : c.gracenotes[0].endSlur = [c.pitches[0].startSlur[0].label],
                                    1 === c.pitches[0].endSlur.length ? delete c.pitches[0].endSlur : 100 === c.pitches[0].endSlur[0] ? c.pitches[0].endSlur.shift() : 100 === c.pitches[0].endSlur[c.pitches[0].endSlur.length - 1] && c.pitches[0].endSlur.pop(),
                                        ...
                                        for (var n = e[s].staff[o].voices[c], a = 0, l = 0; l < n.length; l++)
                                            if ("bar" === n[l].el_type) {
                                                if (++a >= t && l < n.length - 1) {
                                                    ...
                                                    return e[s].staff[o].voices[c] = e[s].staff[o].voices[c].slice(0, p),
                                                    h.staff[o].voices[c] = r.concat(g.concat(h.staff[o].voices[c])),
                                                    !0
                                                }
                                            } else
                                                n[l].duration || r.push(n[l])
                                }
                        return !1
                    }
                    function m(e, t) {
                    ...
                    for (e.lineNum = 0; e.lineNum < e.lines.length; e.lineNum++) {
                        ...
                        if (g)
                            for (e.staffNum = 0; e.staffNum < g.length; e.staffNum++)
                                for (g[e.staffNum].clef && f(g[e.staffNum].clef),
                                e.voiceNum = 0; e.voiceNum < g[e.staffNum].voices.length; e.voiceNum++) {
                ...
                this.getLastNote = function() {
                    if (e.lines[e.lineNum] && e.lines[e.lineNum].staff && e.lines[e.lineNum].staff[e.staffNum] && e.lines[e.lineNum].staff[e.staffNum].voices[e.voiceNum])
                ...
                this.addTieToLastNote = function(e) {
                    ...
                    return !!(t && t.pitches && t.pitches.length > 0) && (t.pitches[0].startTie = {},
                ...
                this.closeLine = function() {
                    e.potentialStartBeam && e.potentialEndBeam && (e.potentialStartBeam.startBeam = !0,
                ...
                this.appendElement = function(r, n, i, a) {
                    var s = e;
                    a.el_type = r,
                    null !== n && (a.startChar = n),
                    null !== i && (a.endChar = i);
                    var o = function() {
                        void 0 !== s.potentialStartBeam && void 0 !== s.potentialEndBeam && (s.potentialStartBeam.startBeam = !0,
                        s.potentialEndBeam.endBeam = !0),
                        delete s.potentialStartBeam,
                        delete s.potentialEndBeam
                    };
                    "note" === r ? t.getDuration(a) >= .25 || a.force_end_beam_last && void 0 !== s.potentialStartBeam ? o() : a.end_beam && void 0 !== s.potentialStartBeam ? void 0 === a.rest ? (s.potentialStartBeam.startBeam = !0,
                    a.endBeam = !0,
                    delete s.potentialStartBeam,
                    delete s.potentialEndBeam) : o() : void 0 === a.rest && (void 0 === s.potentialStartBeam ? a.end_beam || (s.potentialStartBeam = a,
                    delete s.potentialEndBeam) : s.potentialEndBeam = a) : o(),
                    delete a.end_beam,
                ...
                this.appendStartingElement = function(t, r, n, a) {
                    var s;
                    this.closeLine(),
                    "key" === t && (s = a.impliedNaturals,
                    delete a.impliedNaturals,
                    delete a.explicitAccidentals);
                    var o = i.clone(a);
                    if (e.lines[e.lineNum] && e.lines[e.lineNum].staff) {
                        e.lines[e.lineNum].staff.length <= e.staffNum && (e.lines[e.lineNum].staff[e.staffNum] = {},
                        ...
                        e.lines[e.lineNum].staff[0].meter && (e.lines[e.lineNum].staff[e.staffNum].meter = i.clone(e.lines[e.lineNum].staff[0].meter)),
                ...
                this.pushLine = function(t) {
                    e.vskipPending && (t.vskip = e.vskipPending,
                    delete e.vskipPending),
                    e.lines.push(t)
                }
                ,
                ...
                this.containsNotesStrict = function(e) {
                    for (var t = 0; t < e.length; t++)
                        if ("note" === e[t].el_type && (void 0 === e[t].rest || void 0 !== e[t].chord))
                            return !0;
                    return !1
                }
                ,
                this.changeVoiceScale = function(e) {
                    t.appendElement("scale", null, null, {
                        size: e
                    })
                }
                ,
                this.changeVoiceColor = function(e) {
                    t.appendElement("color", null, null, {
                        color: e
                    })
                }
                ,
                    ...
                    var i = function(e) {
                        ...
                        e.stem)
                            ...
                            if (void 0 !== r.voices[0]) {
                                for (var i = !1, a = 0; a < r.voices[0].length; a++)
                                    "stem" === r.voices[0].el_type && (i = !0);
                        ...
                        e.color && t.appendElement("color", null, null, {
                            color: e.color
                        })
                    }
                      , a = function(e) {
                        ...
                        void 0 !== e.stafflines && (n.lines[n.lineNum].staff[n.staffNum].clef.stafflines = e.stafflines,
                        ...
                        n.vskipPending && (n.lines[n.lineNum].vskip = n.vskipPending,
                        delete n.vskipPending)
                    };
                    void 0 === e.lines[e.lineNum] ? function(e) {
                        n.lines[n.lineNum] = {
                            staff: []
                        },
                        a(e)
                    }(r) : void 0 === e.lines[e.lineNum].staff ? (e.lineNum++,
                    this.startNewLine(r)) : void 0 === e.lines[e.lineNum].staff[e.staffNum] ? a(r) : void 0 === e.lines[e.lineNum].staff[e.staffNum].voices[e.voiceNum] ? i(r) : this.containsNotes(e.lines[e.lineNum].staff[e.staffNum].voices[e.voiceNum]) ? (e.lineNum++,
                    this.startNewLine(r)) : r.part && t.appendElement("part", r.part.startChar, r.part.endChar, {
                        title: r.part.title
                    })
                }
                ,
                ...
                this.setCurrentVoice = function(t, r) {
                    ...
                    for (var n = 0; n < e.lines.length; n++)
                        if (e.lines[n].staff && (void 0 === e.lines[n].staff[t] || void 0 === e.lines[n].staff[t].voices[r] || !this.containsNotes(e.lines[n].staff[t].voices[r])))
                            return void (e.lineNum = n);
                    e.lineNum = n
                }
                ,
                this.addMetaText = function(t, r, n) {
                    void 0 === e.metaText[t] ? (e.metaText[t] = r,
                    e.metaTextInfo[t] = n) : (e.metaText[t] += "\n" + r,
                    e.metaTextInfo[t].endChar = n.endChar)
                }
                ,
                this.addMetaTextArray = function(t, r, n) {
                    void 0 === e.metaText[t] ? (e.metaText[t] = [r],
                    e.metaTextInfo[t] = n) : (e.metaText[t].push(r),
                    e.metaTextInfo[t].endChar = n.endChar)
                }
                ,
        ...
        1756: function(e) {
            function t(e, t) {
                for (var r = [], n = [], i = 0, a = 0; a < e.length; a++) {
                    var s = e[a]
                      , o = i + s;
                    o < t ? i = o : t - i < o - t && i > 0 ? (r.push(a - 1),
                    n.push(Math.round(i - s)),
                    i = s) : a < e.length - 1 && (r.push(a),
                    n.push(Math.round(i)),
                    i = 0)
                }
                return n.push(Math.round(i)),
                {
                    lineBreaks: r,
                    totals: n
                }
            ...
            e.exports = {
                        ...
                        e.lines = function(e, t, r) {
                            for (var n = [], i = [], a = [], s = 1, o = 0; o < t.length; o++) {
                                ...
                                if (e[c.ogLine].staff) {
                                    ...
                                    n[c.line].staff[c.staff].voices[c.voice] = e[c.ogLine].staff[c.staff].voices[c.voice].slice(c.start, c.end + 1),
                                    a[10 * c.staff + c.voice] && n[c.line].staff[c.staff].voices[c.voice].unshift({
                                        el_type: "stem",
                                    ...
                                    if (void 0 !== r && 0 === c.staff && 0 === c.voice)
                                        for (p = 0; p < f.length; p++)
                                            "bar" === f[p].el_type && (s++,
                                            p === f.length - 1 ? delete f[p].barNumber : f[p].barNumber = s)
                                } else
                                    n[c.line] = e[c.ogLine]
                            }
                            for (var m = 0; m < n.length; m++)
                                n[m].staff && (n[m].staff = n[m].staff.filter((function(e) {
                                    return null != e
                                }
                                )));
                            return n
                ...
                calcLineWraps: function(e, r, n) {
                    ...
                    var s = n.scale ? Math.max(n.scale, .1) : 1
                      , o = n.wrap.minSpacing ? Math.max(parseFloat(n.wrap.minSpacing), 1) : 1
                      , c = n.wrap.minSpacingLimit ? Math.max(parseFloat(n.wrap.minSpacingLimit), 1) : o - .1
                    ...
                    for (var h = n.wrap.preferredMeasuresPerLine ? Math.max(parseInt(n.wrap.preferredMeasuresPerLine, 10), 0) : void 0, u = [], d = [], f = 0; f < r.length; f++) {
                        var p = r[f]
                        ...
                        if (!y) {
                            ...
                            (y = w.lineBreaks).length > 0 && p.measureWidths.length < 25 && (w = i(p, g, 0, b),
                            b.attempts.push({
                                type: "Optimize",
                                failed: w.failed,
                                reason: w.reason,
                    ...
                    var k = function(e, t, r) {
                        ...
                        for (var i in r)
                            r.hasOwnProperty(i) && "wrap" !== i && "staffwidth" !== i && (n[i] = r[i]);
                        return {
                            revisedParams: n
                        }
                    }(u, n.staffwidth, n);
                    return k.explanation = d,
                    k.reParse = !0,
                    k
                }
            }
        ...
        5633: function(e, t, r) {
            var n, i = r(9447), a = r(4914), s = a.relativeMajor, o = a.transposeKey, c = a.relativeMode, l = r(4208);
            !function() {
                "use strict";
                function e(e, r, n) {
                    var i = []
                      , a = r.getKeySignature();
                    if ("Hp" === a.root || "HP" === a.root)
                        return i;
                ...
                function t(e, t, n, i) {
                    for (var a = [], s = f(n, i), o = 0; o < t.length; o++)
                        a = a.concat(h(e, t[o], n.root, r(n), s, i));
                    return a
                }
                function r(e) {
                ...
                function a(e, t, r) {
                    ...
                    return "none" === t && (n = u.indexOf(e.root)),
                    0 === n ? r > 2 ? n += 7 : -12 === r && (n -= 7) : r > 0 && n < 0 ? n += 7 : r < 0 && n > 0 && (n -= 7),
                    r > 12 ? n += 7 : r < -12 && (n -= 7),
                    n
                }
                    ...
                    for (var c = [], h = a(s, n, o), u = {}, d = {}, m = 0; m < t.length; m++) {
                        ...
                        if ("note" === g.el_type && g.pitches) {
                            for (var _ = 0; _ < g.pitches.length; _++) {
                                ...
                                var E = p(S, s, h, d);
                                E.acc && (d[E.upper] = E.acc),
                                c.push(x(e, g.startChar, g.endChar, E.acc + E.name, _))
                            }
                            if (g.gracenotes)
                                for (var M = 0; M < g.gracenotes.length; M++) {
                                    ...
                                    c.push(w(e, g.startChar, g.endChar, A.acc + A.name, M))
                                }
                        } else
                            "bar" === g.el_type ? (u = {},
                            d = {}) : "keySignature" === g.el_type && (n = g.root,
                            i = r(g),
                            h = a(s = f(g, o), n, o))
                    }
                    return c
                ...
                function p(e, t, r, n) {
                    ...
                    switch (n[l] !== h && (n[l] || h !== f) || e.courtesy || (h = ""),
                    c) {
                    case 0:
                        l += ",,,";
                        break;
                ...
                function x(e, t, r, n, i) {
                    ...
                    if (s) {
                        ...
                        t += r - t - o - c,
                        r -= c
                    } else if (s = a.match(new RegExp(/([^\[]*)/.source + /\[/.source + v.source + v.source + v.source + v.source + v.source + v.source + v.source + v.source + /\-?](\d*\/*\d*)?([\>\<\-\)]*)/.source + b.source))) {
                ...
                function w(e, t, r, n, i) {
                    var a = /(\/*)/
                      , s = e.substring(t, r).match(new RegExp(/([^\{]*)/.source + /\{/.source + a.source + v.source + a.source + v.source + a.source + v.source + a.source + v.source + a.source + v.source + a.source + v.source + a.source + v.source + a.source + v.source + /\}/.source));
                    if (s) {
                        ...
                        s[3 * i + 2] && (o += s[3 * c + 2].length),
                        t += o;
                        var l = s[3 * i + 3] ? s[3 * i + 3].length : 0;
                        l += s[3 * i + 4] ? s[3 * i + 4].length : 0,
                        r = t + (l += s[3 * i + 5] ? s[3 * i + 5].length : 0)
                    }
                    return {
                        start: t,
                        end: r,
                ...
                function k(e, t, r, n) {
                    ...
                    return i[1] && (t += i[1].length),
                    {
                        start: t + 1,
                        end: (r = t + i[2].length) - 1,
                        note: n
                    }
                }
                function C(e, t, r) {
        ...
        9716: function(e, t, r) {
            var n, i = r(5008), a = r(5058);
            !function() {
                "use strict";
                var e, t, r, s, o, c, l, h, u, d, f, p, m, g, v, b, y, x, w, k, C, T, _, S, E = 1, M = {
                    num: 4,
                    den: 4
                }, N = 0, A = 0, B = 128, P = 64, L = 48, H = !1, O = !1, z = !0, D = 105, F = 95, I = 85, j = .25, V = 0, G = {}, Y = 0;
                function q(e) {
                    for (var t = u.length - 1; t >= 0; t--)
                        if ("program" === u[t].cmd)
                            return void (u[t].channel = e)
                }
                function W() {
                ...
                n = function(n, i, a, B) {
                        ...
                        for (var r = 0; r < e.length; r++) {
                            for (var n = e[r], i = {}, a = t.qpm, s = 0, o = 1, c = 0; c < n.length; c++) {
                                ...
                                if ("tempo" !== l.el_type) {
                                    ...
                                    if (s += Math.round(h * o * 1e6),
                                    l.pitches) {
                                        for (var u = 0; u < l.pitches.length; u++) {
                                            var d = l.pitches[u];
                                            if (d)
                                                if (d.duration = l.duration,
                                                d.startTie)
                                                    void 0 === i[d.pitch] ? i[d.pitch] = {
                                                        el: c,
                                                        pitch: u
                    ...
                    for (var X = 0; X < n.length; X++) {
                        ...
                        for (var $ = 0; $ < K.length; $++) {
                            ...
                            case "transpose":
                                ...
                                break;
                            case "bar":
                                p.length > 0 && (!1 === m || X === m) && (ue(w, R(J.time)),
                                b = []),
                                e = [],
                                0 === X && pe(n.length + 1),
                                O = !1,
                            ...
                            case "instrument":
                                ...
                                u.length > 0 && "program" === u[u.length - 1].cmd)
                                    ...
                                    for (ee = u.length - 1; ee >= 0 && "program" !== u[ee].cmd; ee--)
                                        ;
                                    (ee < 0 || u[ee].instrument !== J.program) && u.push({
                                        cmd: "program",
                                        channel: 0,
                                        instrument: J.program
                                    })
                                }
                                break;
                            case "channel":
                    ...
                    return i.detuneOctave && function(e, t) {
                        for (var r = {}, n = 0; n < e.length; n++)
                            for (var i = 0; i < e[n].length; i++) {
                                var a = e[n][i];
                                "note" === a.cmd && (void 0 === r[a.start] && (r[a.start] = []),
                                r[a.start].push({
                                    track: n,
                                    event: i,
                                    pitch: a.pitch
                    ...
                    var t = !1
                      , n = function(e) {
                        ...
                        for (var t = 0; t < e.chord.length; t++) {
                            var r = e.chord[t];
                            if ("default" === r.position)
                                return r.name;
                            if (K.indexOf(r.name.toLowerCase()) >= 0)
                                return "break"
                        }
                        return null
                    }(e);
                        ...
                        var i = function(e) {
                            if (0 !== e.length) {
                                ...
                                if (n) {
                                    ...
                                    "b" === c || "♭" === c ? (n--,
                                    s--,
                                    o = o.substring(1)) : "#" !== c && "♯" !== c || (n++,
                                    s++,
                                    o = o.substring(1));
                                    var l = o.split("/");
                                    if ((a = oe(n, l[0])).length >= 3 && (s = s + (a[2] - a[0]) - 7),
                ...
                function Z(e, t) {
                    ...
                    if (e.gracenotes && e.pitches && e.pitches.length > 0 && e.pitches[0] && (r = function(e, t) {
                        for (var r, n = 0, i = [], s = 0; s < e.length; s++)
                            n += (r = e[s]).duration;
                        var o = t / 2 / n;
                        for (s = 0; s < e.length; s++) {
                            var c = te(r = e[s]);
                    ...
                    e.elem && (e.elem.midiGraceNotePitches = function(e, t, r, n) {
                        var i = [];
                        r = Math.round(r);
                    ...
                    e.elem) {
                        ...
                        if (void 0 === e.elem.currentTrackMilliseconds)
                            ...
                            e.elem.currentTrackMilliseconds !== l && (e.elem.currentTrackMilliseconds = [e.elem.currentTrackMilliseconds, l],
                            ...
                            d || (e.elem.currentTrackMilliseconds.push(l),
                    ...
                    if (e.pitches) {
                        ...
                        for (var T = 0; T < v.length; T++) {
                            var _ = v[T];
                            if (_) {
                                _.startSlur && (V += _.startSlur.length),
                                _.endSlur && (V -= _.endSlur.length);
                    ...
                    return f = Math.max(f, R(e.time) + X(L)),
                    s
                }
                var ee = [0, 2, 4, 5, 7, 9, 11];
                function te(n) {
                    if (void 0 !== n.midipitch)
                        return n.midipitch;
                    var i = n.pitch;
                    if (n.accidental)
                        switch (n.accidental) {
                    ...
                    return void 0 !== e[i] ? a += e[i] : a += t[ie(i)],
                    a += r
                }
                function re(e) {
                    var t = [0, 0, 0, 0, 0, 0, 0];
                ...
                function ne(e) {
                    var t = "" + e.pitch;
                    return t.indexOf(".75") >= 0 ? (e.pitch = Math.round(e.pitch),
                    e.cents = -50) : t.indexOf(".25") >= 0 && (e.pitch = Math.round(e.pitch),
                    e.cents = 50),
                    e
                }
                function ie(e) {
                ...
                function oe(e, t) {
                    var r = se[t];
                    r || (r = "ma" === t.slice(0, 2).toLowerCase() || "M" === t[0] ? se.M : "m" === t[0] || "-" === t[0] ? se.m : se.M),
                    e += 12;
                ...
                function ue(e, t) {
                    ...
                    if (Math.abs(o) < 1e-5 && (o = !1),
                    !s || o) {
                        s = [];
                        for (var c = (t - e) / E / i, l = 0; l < c; l++)
                            s.push("chick")
                    }
                    ...
                    0 !== b[0].beat && y && x && b.unshift({
                        beat: 0,
                        chord: x
                    }),
                    1 !== b.length) {
                        for (var h = .125 === i ? 3 : 1, u = {}, d = 0; d < b.length; d++) {
                            var f = b[d];
                        ...
                        for (var p = 0; p < s.length; p++) {
                            ...
                            !O && m)
                                switch (s[p]) {
                                case "boom":
                                    u["" + (p + 1)] ? le(m.chord.chick, i, L, p, a) : (ce(m.chord.boom, i, P, p, a),
                                    g = m.chord.boom);
                                    break;
                                case "boom2":
                                    u["" + (p + 1)] ? le(m.chord.chick, i, L, p, a) : g === m.chord.boom ? (ce(m.chord.boom2, i, P, p, a),
                                    g = void 0) : (ce(m.chord.boom, i, P, p, a),
                                    g = m.chord.boom);
                                    break;
                                case "chick":
                ...
                function de(e) {
                    ...
                    if (0 !== n.length && r.push(n),
                    e.pattern.length !== 2 * i + 1)
                        return {
                            on: !1
                        };
                    for (var s = {
                    ...
                    return _ = e.bars ? e.bars : 1,
                    s
                }
                function fe() {
                    if (G && G.pattern) {
                        for (var e = G, t = 0, r = M.num / M.den, n = 0; n < e.pattern.length; n++)
                            t += e.pattern[n].len;
                        var i = t / _ / r;
                        for (n = 0; n < e.pattern.length; n++)
                            e.pattern[n].len = e.pattern[n].len / i;
                        G = e
                    }
                }
                function pe(e) {
        ...
        9991: function(e, t, r) {
            ...
            !function() {
                ...
                function e(e, t) {
                    for (var r in t)
                        t.hasOwnProperty(r) && e.setAttribute(r, t[r]);
                    return e
                }
                function t() {
                    this.trackstrings = "",
                ...
                t.prototype.setTempo = function(e) {
                    ...
                    this.track += "%00%FF%51%03" + a(Math.round(6e7 / e), 6),
                    this.endTrack())
                }
                ,
                t.prototype.setGlobalInfo = function(e, t, n, i) {
                    if (0 === this.trackcount) {
                        ...
                        i && (this.track += function(e) {
                            var t, r = "%00%FF%58%04" + a(e.num, 2), n = {
                                1: 0,
                                2: 1,
                                4: 2,
                                8: 3,
                ...
                t.prototype.setInstrument = function(e) {
                    this.trackInstrument = "%00%C0" + a(e, 2),
                    this.instrument = e
                }
                ,
                ...
                t.prototype.startNote = function(e, t, r) {
                    if (this.track += o(this.silencelength),
                    this.silencelength = 0,
                    r) {
                    ...
                    this.track += "%" + e.toString(16) + a(t, 2)
                }
                ,
                t.prototype.endNote = function(e) {
                    this.track += o(this.silencelength),
                    this.silencelength = 0,
                    this.noteWarped[e] && (this.track += "%e" + this.channel.toString(16),
                    this.track += s(8192),
                    this.track += o(0),
                    this.noteWarped[e] = !1),
            ...
            !function() {
                ...
                function r(e, t, r) {
                    for (var n = 0, i = t + 1; i < e.length; i++)
                        if ("note" === e[i].el_type && n++,
                        e[i].decoration && e[i].decoration.indexOf(r) >= 0)
                            return n;
                    return n
                }
                function a(e, t, r) {
                    for (var n = Math.min(e.length, t + 3), i = t; i < n; i++)
                        if ("note" === e[i].el_type && e[i].decoration)
                            for (var a = 0; a < e[i].decoration.length; a++)
                                if (r.indexOf(e[i].decoration[a]) >= 0)
                                    return e[i].decoration[a];
                    return null
                }
                function s(e) {
                    for (var t = 0; t < e.length; t++)
                        for (var r = e[t], n = r.length - 1; n >= 0 && "bar" !== r[n].el_type; )
                            r[n].noChordVoice = !0,
                            n--
                }
                function o(e, t) {
                ...
                function f(e, t) {
                    for (var r = e.length - 1; r >= 0; r--)
                        if (e[r].el_type === t.el_type)
                            return void (JSON.stringify(e[r]) !== JSON.stringify(t) && e.push(t));
                    e.push(t)
                }
                n = function(n, h) {
                    var p, m = (h = h || {}).program || 0, g = h.midiTranspose || 0;
                    ...
                    if (n.formatting.midi) {
                        ...
                        S.program && S.program.length > 0 && (m = S.program[0],
                        S.program.length > 1 && (m = S.program[1],
                        v = S.program[0]),
                        b = !0),
                        S.transpose && (g = S.transpose[0]),
                        S.channel && (v = S.channel[0],
                        b = !0),
                        S.drum && (y = S.drum),
                        ...
                        S.nobeataccents && _.push({
                            el_type: "beataccents",
                            value: !1
                        })
                    }
                    p = h.qpm ? parseInt(h.qpm, 10) : n.metaText.tempo ? c(n.metaText.tempo, n.getBeatLength()) : h.defaultQpm ? h.defaultQpm : 180;
                    var E = [];
                    T && E.push({
                        el_type: "bagpipes"
                    }),
                            ...
                            for (var V = function(e) {
                                ...
                                if (e.decoration)
                                    ...
                                    e.decoration.indexOf("crescendo(") >= 0) {
                                        ...
                                        e.decoration.indexOf("diminuendo)") >= 0 && (P[R] = !1)
                            }, G = j.staff, Y = 0, q = 0; q < G.length; q++) {
                                var W = G[q];
                                if (!W.clef || "TAB" !== W.clef.type)
                                    for (var R = 0; R < W.voices.length; R++) {
                                        ...
                                        if (g && "perc" === W.clef.type && A[Y].push({
                                            el_type: "transpose",
                                            transpose: 0
                                        }),
                                        W.clef && "perc" === W.clef.type && !b)
                                            for (var K = 0; K < A[Y].length; K++)
                                                "instrument" === A[Y][K].el_type && (A[Y][K].program = t);
                                        else
                                            W.key && u(A[Y], W.key);
                                        ...
                                        D = !0),
                                        W.clef && "perc" !== W.clef.type && W.clef.transpose && (W.clef.el_type = "clef",
                                        A[Y].push({
                                            el_type: "transpose",
                                            transpose: W.clef.transpose
                                        })),
                                        W.clef && W.clef.type && (W.clef.type.indexOf("-8") >= 0 ? A[Y].push({
                                            el_type: "transpose",
                                            transpose: -12
                                        }) : W.clef.type.indexOf("+8") >= 0 && A[Y].push({
                                            el_type: "transpose",
                                            transpose: 12
                                        })),
                                        n.formatting.midi && n.formatting.midi.drumoff && (A[Y].push({
                                            el_type: "bar"
                                        }),
                                        A[Y].push({
                                            el_type: "drum",
                                        ...
                                        for (var ee = 0; ee < X.length; ee++) {
                                            ...
                                            case "note":
                                                ...
                                                !te.rest || "spacer" !== te.rest.type) {
                                                    ...
                                                    if (te.style ? re.style = te.style : C[Y] && (re.style = C[Y]),
                                                    re.duration = 0 === te.duration ? .25 : te.duration,
                                                    te.startTriplet) {
                                                        if ($ = te.tripletMultiplier,
                                                        J = te.startTriplet * $ * te.duration,
                                                        te.startTriplet !== te.tripletR && ee + te.tripletR <= X.length) {
                                                            for (var ne = 0, ie = ee; ie < ee + te.tripletR; ie++)
                                                                ne += X[ie].duration;
                                                            J = $ * ne
                                                        }
                                                        ...
                                                        $ && (te.endTriplet ? ($ = 0,
                                                        re.duration = Math.round(1e6 * (J - Z)) / 1e6) : (re.duration = re.duration * $,
                                                        re.duration = Math.round(1e6 * re.duration) / 1e6,
                                                        Z += re.duration));
                                            ...
                                            case "meter":
                                                ...
                                                break;
                                            case "clef":
                                                te.transpose && A[Y].push({
                                                    el_type: "transpose",
                                                    transpose: te.transpose
                                                }),
                                                te.type && (te.type.indexOf("-8") >= 0 ? A[Y].push({
                                                    el_type: "transpose",
                                                    transpose: -12
                                                }) : te.type.indexOf("+8") >= 0 && A[Y].push({
                                                    el_type: "transpose",
                                                    transpose: 12
                                                }));
                                                break;
                                            ...
                                            case "bar":
                                                ...
                                                var ae = "bar_right_repeat" === te.type || "bar_dbl_repeat" === te.type
                                                  , se = "1" === te.startEnding
                                                  , oe = "bar_left_repeat" === te.type || "bar_dbl_repeat" === te.type || "bar_right_repeat" === te.type;
                                                if (ae) {
                                                    var ce = O[Y];
                                                    ce || (ce = 0);
                                                    var le = z[Y];
                                                    ...
                                                    for (var he = ce; he < le; he++) {
                                                        ...
                                                        ue.pitches && (ue.pitches = i.cloneArray(ue.pitches)),
                                                        A[Y].push(ue)
                                                    }
                                                    z[Y] = void 0,
                                                    O[Y] = void 0
                        ...
                        if (t && 0 !== t.length)
                            for (var r = Object.keys(t), n = 0; n < e.length; n++)
                                for (var i = e[n], a = t[0] ? t[0].qpm : 0, s = 0; s < i.length; s++) {
                                    ...
                                    r.indexOf("" + o.timing) >= 0 && a !== t["" + o.timing].qpm && (a = t["" + o.timing].qpm,
                                    "tempo" === o.el_type ? (o.qpm = t["" + o.timing].qpm,
                                    s++) : (e[n].splice(s, 0, {
                                        el_type: "tempo",
                                        qpm: t["" + o.timing].qpm,
                                        timing: o.timing
                    ...
                    w)
                        for (var fe = n.getPickupLength(), pe = 0; pe < A.length; pe++) {
                            for (var me = 0; "note" !== A[pe][me].el_type && A[pe].length > me; )
                                me++;
                            if (A[pe].length > me)
                                for (ie = 0; ie < w; ie++)
                                    0 === fe || ie < w - 1 ? A[pe].splice(me, 0, {
                                        el_type: "note",
                                        rest: {
                                            type: "rest"
                                        },
                    ...
                    return A.length > 0 && A[0].length > 0 && (A[0][0].pickupLength = n.getPickupLength()),
                    A
                }
            }(),
            e.exports = n
        ...
        8702: function(e, t, r) {
            var n = r(5281);
            e.exports = function() {
                return window.abcjsAudioContext || n(),
        ...
        9143: function(e, t, r) {
            var n = r(8471);
            e.exports = function(e) {
                for (var t = [], r = 0; r < e.tracks.length; r++)
                    t.push([]);
                var i = n[0];
            ...
            e.exports = function(e, t) {
                ...
                function(e, t) {
                    ...
                    if (r) {
                        ...
                        f += '<button type="button" class="abcjs-midi-loop abcjs-btn" title="' + p + '" aria-label="' + (t.repeatAria ? t.repeatAria : p) + '">' + o + "</button>\n"
                    }
                    if (n) {
                        var m = t.restartTitle ? t.restartTitle : "Click to go to beginning.";
                        f += '<button type="button" class="abcjs-midi-reset abcjs-btn" title="' + m + '" aria-label="' + (t.restartAria ? t.restartAria : m) + '">' + u + "</button>\n"
                    }
                    if (i) {
                        var g = t.playTitle ? t.playTitle : "Click to play/pause.";
                        f += '<button type="button" class="abcjs-midi-start abcjs-btn" title="' + g + '" aria-label="' + (t.playAria ? t.playAria : g) + '">' + c + l + h + "</button>\n"
                    }
                    if (a) {
                        var v = t.randomTitle ? t.randomTitle : "Click to change the playback position.";
                        f += '<button type="button" class="abcjs-midi-progress-background" title="' + v + '" aria-label="' + (t.randomAria ? t.randomAria : v) + '"><span class="abcjs-midi-progress-indicator"></span></button>\n'
                    }
                ...
                function(e) {
                    ...
                    n && s.addEventListener("click", (function(t) {
        ...
        5594: function(e, t, r) {
            ...
            e.exports = function() {
                ...
                e.init = function(t) {
                    ...
                    n.soundFontVolumeMultiplier || 0 === n.soundFontVolumeMultiplier ? e.soundFontVolumeMultiplier = n.soundFontVolumeMultiplier : e.soundFontUrl === m || "https://paulrosen.github.io/midi-js-soundfonts/MusyngKite/" === e.soundFontUrl ? e.soundFontVolumeMultiplier = 3 : e.soundFontUrl === p ? e.soundFontVolumeMultiplier = .4 : e.soundFontVolumeMultiplier = 1,
                    n.programOffsets ? e.programOffsets = n.programOffsets : e.soundFontUrl === p ? e.programOffsets = {
                    ...
                    t.visualObj)
                        ...
                        t.visualObj.getMeterFraction().den && (e.meterSize = t.visualObj.getMeterFraction().num / t.visualObj.getMeterFraction().den);
                    else {
                        if (!t.sequence)
                            return Promise.reject(new Error("Must pass in either a visualObj or a sequence"));
                        e.flattened = t.sequence
                    }
                    e.millisecondsPerMeasure = t.millisecondsPerMeasure ? t.millisecondsPerMeasure : t.visualObj ? t.visualObj.millisecondsPerMeasure(e.flattened.tempo) : 1e3,
                    ...
                    e.flattened.tracks.forEach((function(e) {
                        e.forEach((function(e) {
                            if ("program" === e.cmd && l[e.instrument] && (g = l[e.instrument]),
                            void 0 !== e.pitch) {
                                var t = e.pitch
                                  , r = c[t];
                                if (r)
                                    ...
                                    var i = g + ":" + r;
                                    console.log("Can't find note: ", t, i),
                    ...
                    e.debugCallback && e.debugCallback("note gathering time = " + Math.floor(1e3 * (s().currentTime - r)) + "ms"),
                    r = s().currentTime;
                    var v = [];
                    ...
                    return new Promise((function(t, n) {
                        var i = {
                          ...
                          , a = 0;
                        !function o() {
                            a < b.length ? e._loadBatch(b[a], e.soundFontUrl, r).then((function(e) {
                                r = s().currentTime,
                                e && (e.error && (i.error = i.error.concat(e.error)),
                                e.loaded && (i.loaded = i.loaded.concat(e.loaded))),
                                a++,
                                o()
                            }
                            ), n) : t(i)
                ...
                e._loadBatch = function(t, r, i, a) {
                    ...
                    Promise.all(o).then((function(n) {
                        e.debugCallback && e.debugCallback("mp3 load time = " + Math.floor(1e3 * (s().currentTime - i)) + "ms");
                        for (var o = [], c = [], l = [], h = [], u = 0; u < n.length; u++) {
                            var d = n[u]
                              , f = d.instrument + ":" + d.name;
                            "loaded" === d.status ? o.push(f) : "pending" === d.status ? l.push(f) : "cached" === d.status ? c.push(f) : h.push(f + " " + d.message)
                        }
                        if (l.length > 0) {
                            if (a ? a *= 2 : a = 50,
                            a < 9e4)
                                return new Promise((function(t, n) {
                                    setTimeout((function() {
                                        ...
                                        e._loadBatch(s, r, i, a).then((function(e) {
                                            t(e)
                                        }
                                        )).catch((function(e) {
                                            n(e)
                            ...
                            return Promise.reject(new Error("timeout attempting to load: " + p.join(", ")))
                        }
                ...
                e.prime = function() {
                    ...
                    new Promise((function(r) {
                        ...
                        if (e.duration = e.flattened.totalDuration * a,
                        e.duration <= 0)
                            return e.audioBuffers = [],
                            r({
                                status: "empty",
                                seconds: 0
                            });
                        ...
                        c.forEach((function(e, t) {
                            ...
                            e.forEach((function(e) {
                                var t = e.instrument + ":" + e.pitch + ":" + e.volume + ":" + Math.round(1e3 * (e.end - e.start)) / 1e3 + ":" + r + ":" + a + ":" + (e.cents ? e.cents : 0);
                                h[t] || (h[t] = []),
                                h[t].push(e.start)
                            }
                            ))
                        ...
                        for (var d = [], f = s().createBuffer(2, o, s().sampleRate), p = 0; p < Object.keys(h).length; p++) {
                            ...
                            d.push(u(f, s().sampleRate, g, h[m], e.soundFontVolumeMultiplier, e.programOffsets[g.instrument], t, e.noteEnd / 1e3))
                        }
                        function b(e) {
                        ...
                        e.audioBuffers = [f],
                        e.debugCallback && (e.debugCallback("sampleRate = " + s().sampleRate),
                        e.debugCallback("totalSamples = " + o),
                        e.debugCallback("creationTime = " + Math.floor(1e3 * (s().currentTime - n)) + "ms")),
                        Promise.all(d).then((function() {
                            "suspended" === s().state ? s().resume().then((function() {
                                r(b(e))
                            }
                            )) : "interrupted" === s().state ? s().suspend().then((function() {
                ...
                e.pause = function() {
                    if (!e.audioBufferPossible)
                        throw new Error(f);
                    return e.debugCallback && e.debugCallback("pause called"),
                ...
                e.seek = function(t, r) {
                    ...
                    e.isRunning ? (e.stop(),
                    e._kickOffSound(n)) : e.pausedTimeSec = n,
                    e.pausedTimeSec = n
                }
                ,
                e.stop = function() {
        ...
        873: function(e) {
            e.exports = function(e) {
                return window.URL.createObjectURL(function(e) {
                    var t, r, n = e[0], i = n.numberOfChannels, a = n.length * i * 2 + 44, s = new ArrayBuffer(a), o = new DataView(s), c = [], l = 0, h = 0;
                    for (d(1179011410),
                    d(a - 8),
                    d(1163280727),
                    d(544501094),
                    ...
                    for (; h < a; ) {
                        for (t = 0; t < c.length; t++)
                            r = 0 | (.5 + (r = Math.max(-1, Math.min(1, c[t][l]))) < 0 ? 32768 * r : 32767 * r),
                            o.setInt16(h, r, !0),
                            h += 2;
                        l++
                    }
        ...
        562: function(e, t, r) {
            var n = r(1592)
              ...
              , a = function(e, t, r, n) {
                ...
                var s, o, c = e.metaText && e.metaText.title ? e.metaText.title : "Untitled";
                return s = t.downloadLabel && (o = t.downloadLabel) && "[object Function]" === {}.toString.call(o) ? t.downloadLabel(e, n) : t.downloadLabel ? t.downloadLabel.replace(/%T/, c) : 'Download MIDI for "' + c + '"',
        ...
        2228: function(e, t, r) {
            ...
            e.exports = function(e, t, r, i) {
                ...
                return a[r] || (a[r] = new Promise((function(n, a) {
                    ...
                    s.onload = function() {
                        if (200 === s.status) {
                            var e = i.decodeAudioData(s.response, (function(e) {
                                n({
                                    instrument: t,
                                    name: r,
                                    status: "loaded",
                    ...
                    throw console.error("Didn't load note", t, r, ":", e.message),
                    e
                }
                ))),
                a[r]
        ...
        4586: function(e, t, r) {
            var n = r(4771)
              ...
              , s = function(e, t, r) {
                for (var n = 0; n < 2; n++)
                    for (var i = t.getChannelData(n), a = e.getChannelData(n), s = 0; s < i.length; s++)
                        a[s + r] += i[s]
            };
            e.exports = function(e, t, r, o, c, l, h, u) {
                ...
                var p = new d(2,Math.floor((f + h) * t),t)
                  , m = i[r.pitch]
                  , g = n[r.instrument][m];
                return g ? g.then((function(n) {
                    var i = p.createBufferSource();
                    i.buffer = n.audioBuffer;
                    var u, d = r.volume / 96 * c;
                    return i.gainNode = p.createGain(),
                    r.pan && p.createStereoPanner && (i.panNode = p.createStereoPanner(),
                    i.panNode.pan.setValueAtTime(r.pan, 0)),
                    i.gainNode.gain.value = d,
                    i.gainNode.gain.linearRampToValueAtTime(i.gainNode.gain.value, f),
                    i.gainNode.gain.linearRampToValueAtTime(0, f + h),
                    r.cents && (i.playbackRate.value = a(r.cents)),
                    i.panNode ? (i.panNode.connect(p.destination),
                    i.gainNode.connect(i.panNode)) : i.gainNode.connect(p.destination),
                    i.connect(i.gainNode),
                    i.start(0),
                    i.noteOff ? i.noteOff(f + h) : i.stop(f + h),
        ...
        4718: function(e, t, r) {
            ...
            e.exports = function(e, t, r) {
                for (var i = new n, o = 0; o < e.length; o++) {
                    var c = e[o]
                      , l = i.addTrack();
                    if (i.setInstrument(l, c.instrument),
                    0 === o && t)
                ...
                var d = a();
                return "suspended" === d.state ? d.resume().then((function() {
                    return s(i, r)
                }
                )) : s(i, r)
            }
        ...
        3450: function(e, t, r) {
            ...
            e.exports = function() {
                ...
                e.go = function() {
                    e.isLoading = !0;
                    var t, r = 100 * e.visualObj.millisecondsPerMeasure() / e.warp;
                    return e.currentTempo = Math.round(e.visualObj.getBeatsPerMeasure() / r * 6e4),
                    e.control && e.control.setTempo(e.currentTempo),
                    e.percent = 0,
                    e.midiBuffer || (e.midiBuffer = new i),
                    s().resume().then((function(t) {
                        ...
                        var r = 16;
                        return e.cursorControl && void 0 !== e.cursorControl.beatSubdivisions && parseInt(e.cursorControl.beatSubdivisions, 10) >= 1 && parseInt(e.cursorControl.beatSubdivisions, 10) <= 64 && (r = parseInt(e.cursorControl.beatSubdivisions, 10)),
                ...
                e.runWhenReady = function(t, r) {
                    return e.visualObj ? e.isLoading ? (n = 500,
                    new Promise((function(e) {
                        setTimeout(e, n)
                    }
                    ))).then((function() {
                    ...
                    )) : e.isLoaded ? t(r) : e.go().then((function() {
                        return t(r)
                    }
                    )) : Promise.resolve({
                        status: "loading"
                ...
                e._play = function() {
                    return s().resume().then((function() {
                        ...
                        e.control && e.control.pushPlay(!0)) : e.pause(),
                        Promise.resolve({
                            status: "ok"
                        })
                    }
                ...
                ,
                e.seek = function(t, r) {
                    e.timer && e.midiBuffer && (e.timer.setProgress(t, r),
                    e.midiBuffer.seek(t, r))
                }
                ,
                e.setWarp = function(t) {
                    if (parseInt(t, 10) > 0) {
                        ...
                        e.isStarted = !1,
                        e.go().then((function() {
                            return e.setProgress(n, 1e3 * e.midiBuffer.duration),
                            e.control && e.control.setWarp(e.currentTempo, e.warp),
                            r ? e.play().then((function() {
                                return e.seek(n),
                                Promise.resolve()
                            }
                            )) : (e.seek(n),
                ...
                e.setProgress = function(t, r) {
                    e.percent = t,
                    e.control && e.control.setProgress(t, r)
                }
                ,
                e.finished = function() {
                    if (e.timer.reset(),
                    e.isLooping)
                        return e.timer.start(0),
                        e.midiBuffer.finished(),
                        e.midiBuffer.start(),
                        "continue";
                    e.timer.stop(),
                    e.isStarted && (e.control && e.control.pushPlay(!1),
                    e.isStarted = !1,
                    e.midiBuffer.finished(),
                ...
                e.beatCallback = function(t, r, n, i) {
                    var a = t / r;
                    e.setProgress(a, n),
                    e.cursorControl && e.cursorControl.onBeat && "function" == typeof e.cursorControl.onBeat && e.cursorControl.onBeat(t, r, n, i)
                }
                ,
                e.eventCallback = function(t) {
                    if (!t)
                        return e.finished();
                    e.cursorControl && e.cursorControl.onEvent && "function" == typeof e.cursorControl.onEvent && e.cursorControl.onEvent(t)
                }
                ,
                e.lineEndCallback = function(t, r) {
                    e.cursorControl && e.cursorControl.onLineEnd && "function" == typeof e.cursorControl.onLineEnd && e.cursorControl.onLineEnd(t, r)
                }
                ,
                e.getUrl = function() {
        ...
        1921: function(e, t, r) {
                    ...
                    for (var r = 0; r < t.length - 1; r++) {
                        ...
                        if (n.str == i.str) {
                            if (n.str == e.strings.length - 1)
                                ...
                                void (i.num = "?");
                            i.num < n.num ? (i.str++,
                            i = o(e, i.note, i.str, e.secondPos, e.strings[i.str].length)) : (n.str++,
                            n = o(e, n.note, n.str, e.secondPos, e.strings[n.str].length)),
                            t[r] = n,
                            t[r + 1] = i
                        }
                    }
            ...
            function o(e, t, r, n, i) {
                var a = e.strings;
                t.checkKeyAccidentals(e.accidentals, e.measureAccidentals),
                n && (a = n);
                ...
                if (-1 != o) {
                    if (n && (o += i),
                    (t.isFlat || -1 == t.acc) && 0 == o) {
                        var l = t.getAccidentalEquiv();
                        o = a[++r].indexOf(l.emit()),
                        c = 0
                    }
                    return {
                        num: o + c,
            ...
            function c(e, t) {
                var r;
                (t.isAltered || t.natural) && (t.isFlat ? r = t.isDouble ? "__" : "_" : t.isSharp ? r = t.isDouble ? "^^" : "^" : t.natural && (r = "="),
                ...
                for (var n = e.stringPitches.length - 1; n >= 0; n--)
                    if (t.pitch + t.pitchAltered >= e.stringPitches[n]) {
                        ...
                        return "^" === t.quarter ? i -= .5 : "v" === t.quarter && (i += .5),
                        {
                            num: Math.round(i),
                            str: e.stringPitches.length - 1 - n,
                            note: t
                        }
                    }
                return {
            ...
            function l(e, t) {
                ...
                e.push(r),
                e.error = t.emit() + ": unexpected note for instrument"
            }
            function h(e) {
                var t = e.tuning
                  , r = e.capo
                ...
                if (this.capo > 0 && (this.capoTuning = function(e) {
                    var t = null
                      , r = e.tuning;
                    if (e.capo > 0) {
                        t = [];
                        for (var n = 0; n < r.length; n++) {
                            for (var a = new i.TabNote(r[n]), s = 0; s < e.capo; s++)
                                a = a.nextNote();
                            t[n] = a.emit()
                        }
                    }
                ...
                this.strings.error)
                    return e._super.setError(this.strings.error),
                    void (e.inError = !0);
                this.secondPos = function(e) {
                    var t = [];
                    t[0] = [];
                    for (var r = e.strings, n = 1; n < r.length; n++)
                        t[n] = r[n - 1];
                    return t
                }(this)
            }
            ...
            h.prototype.notesToNumber = function(e, t) {
                var r, n, a = null, o = null;
                if (e && (o = [],
                e.length > 1 ? (o = s(this, e)).error && (a = o.error) : e[0].endTie || ((r = new i.TabNote(e[0].name,this.clefTranspose)).checkKeyAccidentals(this.accidentals, this.measureAccidentals),
                (n = c(this, r)) ? o.push(n) : (l(o, r),
                a = o.error))),
                a)
                    return o;
                var h = null;
                if (t) {
                    ...
                    for (var u = 0; u < t.length; u++)
                        (r = new i.TabNote(t[u].name,this.clefTranspose)).checkKeyAccidentals(this.accidentals, this.measureAccidentals),
                        (n = c(this, r)) ? h.push(n) : (l(h, r),
                        a = o.error)
                }
                return {
                    notes: o,
            ...
            h.prototype.tabInfos = function(e) {
                ...
                if (t) {
                    var r = "";
                    return -1 != t.indexOf("%T") && (r = this.toString(),
        ...
        6776: function(e, t, r) {
            ...
            function s(e, t) {
                var r = i(e);
                t && (r += t);
                var n, s = a(r), o = !1, c = !1, l = null, h = null, u = !1, d = 0;
                e.startsWith("_") ? (o = !0,
                d = -1,
                "/" == e[1] ? (o = !1,
                h = "v",
                d = 0) : "_" == e[1] && (u = !0,
                d -= 1)) : e.startsWith("^") ? (c = !0,
                d = 1,
                "/" == e[1] ? (c = !1,
                h = "^",
                d = 0) : "^" == e[1] && (u = !0,
                d += 1)) : e.startsWith("=") && (l = !0,
                d = 0),
            ...
            s.prototype.checkKeyAccidentals = function(e, t) {
                if (!this.isAltered && !this.natural)
                    if (t[this.name.toUpperCase()])
                        ...
                        case "__":
                            return this.acc = -2,
                            void (this.pitchAltered = -2);
                        case "_":
                            return this.acc = -1,
                            void (this.pitchAltered = -1);
                        case "=":
                            return this.acc = 0,
                            void (this.pitchAltered = 0);
                        case "^":
                            return this.acc = 1,
                            void (this.pitchAltered = 1);
                        case "^^":
                        ...
                        for (var r = this.name, n = 0; n < e.length; n++) {
                            var i = e[n];
                            r == i.note.toUpperCase() && ("flat" == i.acc && (this.acc = -1,
                            this.isKeyFlat = !0,
                            this.pitchAltered = -1),
                            "sharp" == i.acc && (this.acc = 1,
                            this.isKeySharp = !0,
                            this.pitchAltered = 1))
                        }
            }
            ...
            s.prototype.getAccidentalEquiv = function() {
                var e, t, r = ((t = new s((e = this).name)).pitch = e.pitch,
                ...
                t);
                return r.isSharp || r.isKeySharp ? ((r = r.nextNote()).isFlat = !0,
                r.isSharp = !1,
                r.isKeySharp = !1) : (r.isFlat || r.isKeyFlat) && ((r = r.prevNote()).isSharp = !0,
                r.isFlat = !1,
                r.isKeyFlat = !1),
                r
            }
            ...
            s.prototype.emitNoAccidentals = function() {
                ...
                for (var t = 0; t < this.isQuoted; t++)
                    e += "'";
                for (var r = 0; r < this.hasComma; r++)
                    e += ",";
                return e
            }
            ,
            s.prototype.emit = function() {
                var e = this.name;
                (this.isSharp || this.isKeySharp) && (e = "^" + e,
                this.isDouble && (e = "^" + e)),
                (this.isFlat || this.isKeyFlat) && (e = "_" + e,
                this.isDouble && (e = "_" + e)),
                this.quarter && (e = "^" == this.quarter ? "^/" + e : "_/" + e),
                this.natural && (e = "=" + e);
                for (var t = 1; t <= this.hasComma; t++)
                    e += ",";
                if (this.isLower) {
                    e = e.toLowerCase();
                    for (var r = 1; r <= this.isQuoted; r++)
                        e += "'"
                }
                return e
            }
        ...
        6629: function(e, t, r) {
            var n = r(6776)
              , i = n.notes;
            function a(e, t) {
                this.fromN = new n.TabNote(e),
                this.toN = new n.TabNote(t)
            }
            a.prototype.build = function() {
                ...
                if (t.isLowerThan(e)) {
                    var r = e.emit();
                    return {
                        error: "Invalid string Instrument tuning : " + t.emit() + " string lower than " + r + " string"
                    }
                }
                var n = []
                  , a = i.indexOf(e.name)
        ...
        1696: function(e, t, r) {
            ...
            function a(e, t) {
                for (var r in t)
                    t.hasOwnProperty(r) && (Array.isArray(t[r]) || null != (n = t[r]) && n.constructor === Object || (e[r] = t[r]));
                var n
            }
            function s(e) {
                var t = new n("",0,0,"",0);
                ...
                if (t)
                    for (var n = e.children, o = !0, c = 0; c < n.length; c++) {
                        var l = n[c]
                          , h = new i("",0,0,0,"");
                        a(h, l),
                        o = t.tablature.setRelative(l, h, o),
                        r.children.push(h)
                    }
                return r
            }
            ...
            function u(e, t, r, n, a) {
                var s = n.num;
                null != n.note.quarter && (s = s.toString(),
                s += n.note.quarter);
                ...
                var c = new i(s,0,0,o + .3,{
                    type: "tabNumber"
                });
                return c.x = t,
                c.isGrace = a,
                c.isAltered = n.note.isAltered,
                c
            }
            function d(e, t) {
                var r = 0;
                if (e.extra)
                    for (var n = 0; n < e.extra.length; n++)
                        if (e.extra[n].c.indexOf("noteheads") >= 0) {
                            if (r === t)
                                return e.extra[n].x + e.extra[n].w / 2;
                            r++
                        }
                return -1
            }
            ...
            function p(e, t, r) {
                ...
                if (n.error)
                    return e._super.setError(n.error),
                    n;
                if (n.graces && n.notes) {
        ...
        676: function(e, t, r) {
            ...
            s.prototype.doLayout = function() {
                ...
                var f = {
                  ...
                  , p = function(e, t) {
                    for (var r = e.staffIndex, n = 0, i = 0, a = 0; ; ) {
                        if (!t[n])
                            return -1;
                        if (t[n].isTabStaff || (a = t[n].voices.length),
                        t[n].isTabStaff) {
                            if (i++,
                            o(n, t) && i < a)
                                return n + 1
                ...
                if (-1 !== p) {
                    ...
                    var m, g, v, b, y, x, w = function(e, t) {
                        for (var r = t; r >= 0; r--)
                            if (!e[r].isTabStaff)
                                return e[r];
                        return null
        ...
        1897: function(e, t, r) {
            ...
            S.prototype.createABCLine = function(e, t, r) {
                ...
                for (var i = 0; i < e.length; i++)
                    T && this.restoreState(),
                    T = !1,
                    this.createABCStaff(n, e[i], t, i, r);
                return n
            }
            ,
            S.prototype.createABCStaff = function(e, t, r, n, i) {
                ...
                for (var c = 0; c < t.voices.length; c++) {
                    ...
                    0 === c ? (h.barfrom = "start" === t.connectBarLines || "continue" === t.connectBarLines,
                    h.barto = "continue" === t.connectBarLines || "end" === t.connectBarLines) : h.duplicate = !0,
                    t.title && t.title[c] && (h.header = t.title[c].replace(/\\n/g, "\n"),
                    h.headerPosition = 6 + e.getTextSize.baselineToCenter(h.header, "voicefont", "staff-extra voice-name", c, t.voices.length) / p.STEP),
                    t.clef && "perc" === t.clef.type && (h.isPercussion = !0);
                    var u = (!this.initialClef || 0 === i) && s(t.clef, this.tuneNumber);
                    u && (0 === c && t.barNumber && this.addMeasureNumber(t.barNumber, u),
                    h.addChild(u),
                    ...
                    e.setStaffLimits(h),
                    0 === c && ("start" === t.brace || !e.brace && t.brace ? (e.brace || (e.brace = []),
                    e.brace.push(new a(h,"brace"))) : "end" === t.brace && e.brace ? e.brace[e.brace.length - 1].setBottomStaff(h) : "continue" === t.brace && e.brace && e.brace[e.brace.length - 1].continuing(h),
                    "start" === t.bracket || !e.bracket && t.bracket ? (e.bracket || (e.bracket = []),
                    e.bracket.push(new a(h,"bracket"))) : "end" === t.bracket && e.bracket ? e.bracket[e.bracket.length - 1].setBottomStaff(h) : "continue" === t.bracket && e.bracket && e.bracket[e.bracket.length - 1].continuing(h))
                }
            }
            ,
                    ...
                    if (b)
                        for (h = 0; h < b.length; h++) {
                            if (!this.tempoSet && t && !t.suppress) {
                                ...
                                y.addFixedX(new g(t,this.tuneNumber,c)),
                                s.addChild(y)
                            }
                            s.addChild(b[h])
                        }
            ...
            S.prototype.createABCElement = function(e, t, r, i) {
                ...
                case "part":
                    ...
                    u.addFixedX(new f(i.title,0,0,void 0,{
                        type: "part",
                ...
                case "tempo":
                    ...
                    m.addFixedX(new g(i,this.tuneNumber,c)),
                    a[0] = m;
                    break;
                case "style":
                ...
                case "scale":
                    ...
                    break;
                case "color":
                    this.voiceColor = i.color,
                    r.color = this.voiceColor;
                    break;
                default:
                    var v = new n(i,0,0,"unsupported",this.tuneNumber);
                    v.addFixed(new f("element type " + i.el_type,0,0,void 0,{
                        type: "debug"
                    })),
                    a[0] = v
                }
            ...
            S.prototype.createBeam = function(e, t, r) {
                ...
                for (var s = 0; s < r.length; s++)
                    a.runningDirection(r[s]);
                a.setStemDirection();
                var o = this.stemdir;
                for (this.stemdir = a.stemsUp ? "up" : "down",
                s = 0; s < r.length; s++) {
                    var c = r[s]
                      , l = this.createNote(c, !0, e, t);
                    n.push(l),
                    a.add(l),
                    this.triplet && this.triplet.isClosed() && (t.addOther(this.triplet),
                    this.triplet = null,
                    this.tripletmultiplier = 1)
                }
                return a.calcDir(),
            ...
            var N = function(e) {
              ...
              , A = function(e, t, r, n, i, a, s, o, c) {
                for (var l = r; l > 11; l--)
                    l % 2 != 0 || n || e.addFixed(new f(null,o,(i + 4) * c,l,{
                        type: "ledger"
                    }));
                for (l = t; l < 1; l++)
                    l % 2 != 0 || n || e.addFixed(new f(null,o,(i + 4) * c,l,{
                ...
                for (l = 0; l < a.length; l++) {
                    var h = i;
                    "down" === s && (h = -h),
                    e.addFixed(new f(null,h + o,(i + 4) * c,a[l],{
                        type: "ledger"
                    }))
                }
            };
            ...
            S.prototype.addGraceNotes = function(e, t, r, n, a, s, o) {
                ...
                a = Math.round(.7 * a);
                var h, u, p = null;
                e.gracenotes.length > 1 && (p = new i(a,"grace",s),
                T && p.setHint(),
                p.mainNote = r);
                var m = [];
                ...
                for (u = 0; u < e.gracenotes.length; u++) {
                    ...
                    var y = b.notehead;
                    if (this.addSlursAndTies(r, e.gracenotes[u], y, t, "up", !0),
                    r.addExtra(y),
                    e.gracenotes[u].acciaccatura) {
                        var x = e.gracenotes[u].verticalPos + 4.2
                          , w = p ? 5 : 6;
                        r.addRight(new f("flags.ugrace",-m[u] + w,0,x,{
                            scalex: l,
                            scaley: l
                        }))
                    }
                    ...
                    0 !== u || s || !this.graceSlurs || N || t.addOther(new v({
                        anchor1: y,
                        anchor2: n,
                        isGrace: !0
                    }))
            ...
            S.prototype.addNoteToAbcElement = function(e, t, r, n, i, a, s, o, l) {
                var h, u, p, m, g, v = 0, b = 0, y = 0, x = [], k = [], T = 0, S = t.averagepitch >= 6 ? "down" : "up";
                for (n && (S = n),
                (i = t.style ? t.style : i) && "normal" !== i || (i = "note"),
                (m = a ? _[i].nostem : _[i][-s]) || console.log("noteSymbol:", i, s, a),
                g = "down" === S ? t.pitches.length - 2 : 1; "down" === S ? g >= 0 : g < t.pitches.length; g = "down" === S ? g - 1 : g + 1) {
                    var E = t.pitches["down" === S ? g + 1 : g - 1]
                      , M = t.pitches[g]
                      , N = "down" === S ? E.pitch - M.pitch : M.pitch - E.pitch;
                    N <= 1 && !E.printer_shift && (M.printer_shift = N ? "different" : "same",
                ...
                for (g = 0; g < t.pitches.length; g++) {
                    var P, L;
                    if (o || (P = "down" === S && 0 !== g || "up" === S && g !== A - 1 ? null : _["down" === S ? "dflags" : "uflags"][-s]),
                    t.pitches[g].style)
                        ...
                        L = m;
                    if (t.pitches[g].highestVert = t.pitches[g].verticalPos,
                    ("up" === n || "up" === S) && 0 === g || ("down" === n || "down" === S) && g === A - 1) {
                        if ((t.startSlur || 1 === A) && (t.pitches[g].highestVert = t.pitches[A - 1].verticalPos,
                        C(t) < 1 && ("up" === n || "up" === S) && (t.pitches[g].highestVert += 6)),
                        t.startSlur)
                            for (t.pitches[g].startSlur || (t.pitches[g].startSlur = []),
                            p = 0; p < t.startSlur.length; p++)
                                B(t.pitches[g].startSlur, t.startSlur[p]);
                        if (t.endSlur)
                            for (t.pitches[g].highestVert = t.pitches[A - 1].verticalPos,
                            C(t) < 1 && ("up" === n || "up" === S) && (t.pitches[g].highestVert += 6),
                            t.pitches[g].endSlur || (t.pitches[g].endSlur = []),
                            p = 0; p < t.endSlur.length; p++)
                    ...
                    (h = z.notehead) && (this.addSlursAndTies(e, t.pitches[g], h, l, O ? S : null, !1),
            ...
            S.prototype.addLyric = function(e, t) {
                ...
                e.addCentered(new f(r,0,n.width,void 0,{
                    type: "lyric",
                    position: i,
            ...
            S.prototype.createNote = function(e, t, r, i) {
                var a, s = null, o = 0, l = 0, h = 0, u = [], p = C(e), m = !1;
                0 === p && (m = !0,
                p = .25,
                t = !0);
                for (var g = Math.floor(Math.log(p) / Math.log(2)), v = 0, y = Math.pow(2, g), w = y / 2; y < p; v++,
                y += w,
                w /= 2)
                    ;
                ...
                var S = e.rest ? "rest" : "note"
                  , E = new n(e,k,1,S,this.tuneNumber,{
                    durationClassOveride: e.duration * this.tripletmultiplier
                });
                if (T && E.setHint(),
                e.rest) {
                    this.measureLength === p && "invisible" !== e.rest.type && "spacer" !== e.rest.type && e.rest.type.indexOf("multimeasure") < 0 && (e.rest.type = "whole");
                ...
                if (void 0 !== e.lyric && this.addLyric(E, e),
                void 0 !== e.gracenotes && (o += this.addGraceNotes(e, i, E, s, this.stemHeight * this.voiceScale, this.isBagpipes, o)),
                e.decoration && this.decoration.createDecoration(i, e.decoration, E.top, s ? s.w : 0, E, o, a, E.bottom, e.positioning, this.hasVocals),
                e.barNumber && E.addFixed(new f(e.barNumber,-10,0,0,{
                    type: "barNumber"
                })),
                ...
                return e.startTriplet && (this.triplet = new b(e.startTriplet,s,{
                    flatBeams: this.flatBeams
                })),
                e.endTriplet && this.triplet && this.triplet.setCloseAnchor(s),
                !this.triplet || e.startTriplet || e.endTriplet || e.rest && "spacer" === e.rest.type || this.triplet.middleNote(s),
                E
            }
            ,
            S.prototype.addSlursAndTies = function(e, t, r, n, i, a) {
                if (t.endTie && this.ties.length > 0) {
                    ...
                    s || (this.ties[0].setEndAnchor(r),
                    n.setRange(this.ties[0]),
                    this.ties.splice(0, 1))
                }
                var c, l, h = n.voicetotal < 2 ? -1 : n.voicenumber;
                if (t.startTie) {
                    var u = new v({
                        anchor1: r,
                ...
                if (t.endSlur)
                    for (var d = 0; d < t.endSlur.length; d++)
                        l = t.endSlur[d],
                        this.slurs[l] ? ((c = this.slurs[l]).setEndAnchor(r),
                        n.setRange(c),
                        delete this.slurs[l]) : (c = new v({
                            anchor2: r,
                            stemDir: this.stemdir,
                            voiceNumber: h
                        }),
                    ...
                    for (var f in this.slurs)
                        this.slurs.hasOwnProperty(f) && this.slurs[f].addInternalNote(r);
                if (t.startSlur)
            ...
            S.prototype.addMeasureNumber = function(e, t) {
                ...
                t.addFixed(new f(e,n,r.width,i + r.height / p.STEP,{
                    type: "barNumber",
            ...
            S.prototype.createBarLine = function(e, t, r) {
                ...
                if (o || d) {
                    for (var p in this.slurs)
                        this.slurs.hasOwnProperty(p) && this.slurs[p].setEndX(i);
                    this.startlimitelem = i
                }
                if (o && (i.addRight(new f("dots.dot",s,1,7)),
                i.addRight(new f("dots.dot",s,1,5)),
                s += 6),
                ...
                i.addRight(a)),
                t.decoration && this.decoration.createDecoration(e, t.decoration, 12, l ? 3 : 1, i, 0, "down", 2, t.positioning, this.hasVocals),
                ...
                i.addRight(a)),
                d && (s += 3,
                i.addRight(new f("dots.dot",s,1,7)),
                i.addRight(new f("dots.dot",s,1,5))),
                t.startEnding && r) {
                ...
                return i.extraw -= 5,
                void 0 !== t.chord && x(this.getTextSize, i, t, 0, 0, 0, !1, this.germanAlphabet),
                i
            }
            ,
            e.exports = S
        ...
        2652: function(e, t, r) {
            ...
            e.exports = function(e, t, r, s, o, c, l, h) {
                for (var u = 0; u < r.chord.length; u++)
                    for (var d = r.chord[u].position, f = r.chord[u].rel_position, p = r.chord[u].name.split("\n"), m = p.length - 1; m >= 0; m--) {
                        var g, v, b, y = p[m], x = 0;
                        "left" === d || "right" === d || "below" === d || "above" === d || f ? (v = "annotationfont",
                        b = "annotation") : (v = "gchordfont",
                        b = "chord",
                        y = a(y, l, h));
                        var w = e.attr(v, b)
                          , k = e.calc(y, v, b)
                        ...
                        default:
                            if (f) {
                                var _ = f.y + 3 * i.STEP;
                                t.addRight(new n(y,x + f.x,0,r.minpitch + _ / i.STEP,{
                                    position: "relative",
                                    type: "text",
                                    height: T,
                                    dim: w
                                ...
                                "hidden" !== S && t.addCentered(new n(y,c / 2,C,void 0,{
                                    type: "chord",
                                    position: S,
                                    height: T,
                                    dim: w,
            ...
            e.exports = function(e, t, r) {
                if (t.text) {
                    ...
                    var i = r.calc("A", t.font, t.klass)
                      , a = t.text.split("\n").length;
                    if ("\n" === t.text[t.text.length - 1] && a--,
                    !t.noMove) {
                        var s = 1.1 * i.height * a;
                        e.push({
                            move: Math.round(s)
                        }),
                        t.marginBottom && e.push({
                            move: t.marginBottom
                        })
                    }
                }
        ...
        9600: function(e, t, r) {
            ...
            e.exports = function(e, t) {
                ...
                case "perc":
                    ...
                    break;
                default:
                    o.addFixed(new a("clef=" + e.type,0,0,void 0,{
                        type: "debug"
                    }))
                }
                if (r) {
                    ...
                    if (o.addRight(new a(r,5,i.getSymbolWidth(r),e.clefPos,{
                        top: c + e.clefPos + l,
                        bottom: e.clefPos + l
                    })),
                    0 !== s) {
                        ...
                        "bass-8" === e.type && (d = 3,
                        u = 0),
                        o.addRight(new a("8",5 + u,i.getSymbolWidth("8") * h,d,{
                            scalex: h,
                            scaley: h,
                            top: f,
                            bottom: p
        ...
        3923: function(e, t, r) {
            ...
            e.exports = function(e, t) {
                ...
                return e.accidentals.forEach((function(e) {
                    ...
                    r.addRight(new a(t,s,i.getSymbolWidth(t),e.verticalPos,{
        ...
        2143: function(e, t, r) {
            ...
            e.exports = function(e, t, r, a) {
                a || (a = {});
                var s, o = void 0 !== a.dir ? a.dir : null, c = void 0 !== a.headx ? a.headx : 0, l = void 0 !== a.extrax ? a.extrax : 0, h = void 0 !== a.flag ? a.flag : null, u = void 0 !== a.dot ? a.dot : 0, d = void 0 !== a.dotshiftx ? a.dotshiftx : 0, f = void 0 !== a.scale ? a.scale : 1, p = void 0 !== a.accidentalSlot ? a.accidentalSlot : [], m = void 0 !== a.shouldExtendStem && a.shouldExtendStem, g = void 0 === a.printAccidentals || a.printAccidentals, v = r.verticalPos, b = 0, y = 0, x = 0;
                if (void 0 === t)
                    e.addFixed(new i("pitch is undefined",0,0,0,{
                        type: "debug"
                    }));
                else if ("" === t)
                    s = new i(null,0,0,v);
                    ...
                    if ((s = new i(t,w,n.getSymbolWidth(t) * f,v,C)).stemDir = o,
                    h) {
                        var T = v + ("down" === o ? -7 : 7) * f;
                        m && ("down" === o && T > 6 && (T = 6),
                        "up" === o && T < 6 && (T = 6));
                        var _ = "down" === o ? c : c + s.w - .6;
                        e.addRight(new i(h,_,n.getSymbolWidth(h) * f,T,{
                            scalex: f,
                            scaley: f
                        }))
                    }
                ...
                if (s && (s.highestVert = r.highestVert),
                g && r.accidental) {
                    var E;
                    switch (r.accidental) {
                    case "quartersharp":
                    ...
                    !1 === M && (N -= n.getSymbolWidth(E) * f + 2,
                    p.push([v, N]),
                    b = n.getSymbolWidth(E) * f + 2);
                    var B = n.symbolHeightInPitches(E);
                    e.addExtra(new i(E,N,n.getSymbolWidth(E),v,{
                        scalex: f,
                        scaley: f,
                        top: v + B / 2,
                        bottom: v - B / 2
            ...
            e.exports = function(e, t) {
                ...
                if ("specified" === e.type)
                    for (var s = 0, o = 0; o < e.value.length; o++)
                        if (0 !== o && (r.addRight(new a("+",s + 1,i.getSymbolWidth("+"),6,{
                            thickness: i.symbolHeightInPitches("+")
                        })),
                        s += i.getSymbolWidth("+") + 2),
                        e.value[o].den) {
                            for (var c = 0, l = 0; l < e.value[o].num.length; l++)
                                c += i.getSymbolWidth(e.value[o].num[l]);
                            var h = 0;
                            for (l = 0; l < e.value[o].num.length; l++)
                                h += i.getSymbolWidth(e.value[o].den[l]);
                            var u = Math.max(c, h);
                            r.addRight(new a(e.value[o].num,s + (u - c) / 2,c,8,{
                                thickness: i.symbolHeightInPitches(e.value[o].num[0])
                            })),
                            r.addRight(new a(e.value[o].den,s + (u - h) / 2,h,4,{
                                thickness: i.symbolHeightInPitches(e.value[o].den[0])
                            })),
                            s += u
                        } else {
                            for (var d = 0, f = 0; f < e.value[o].num.length; f++)
                                d += i.getSymbolWidth(e.value[o].num[f]);
                            r.addRight(new a(e.value[o].num,s,d,6,{
                                thickness: i.symbolHeightInPitches(e.value[o].num[0])
                            })),
                            s += d
                        }
                else
                    "common_time" === e.type ? r.addRight(new a("timesig.common",0,i.getSymbolWidth("timesig.common"),6,{
                        thickness: i.symbolHeightInPitches("timesig.common")
                    })) : "cut_time" === e.type ? r.addRight(new a("timesig.cut",0,i.getSymbolWidth("timesig.cut"),6,{
                        thickness: i.symbolHeightInPitches("timesig.cut")
                    })) : "tempus_imperfectum" === e.type ? r.addRight(new a("timesig.imperfectum",0,i.getSymbolWidth("timesig.imperfectum"),6,{
                        thickness: i.symbolHeightInPitches("timesig.imperfectum")
                    })) : "tempus_imperfectum_prolatio" === e.type ? r.addRight(new a("timesig.imperfectum2",0,i.getSymbolWidth("timesig.imperfectum2"),6,{
                        thickness: i.symbolHeightInPitches("timesig.imperfectum2")
                    })) : "tempus_perfectum" === e.type ? r.addRight(new a("timesig.perfectum",0,i.getSymbolWidth("timesig.perfectum"),6,{
                        thickness: i.symbolHeightInPitches("timesig.perfectum")
                    })) : "tempus_perfectum_prolatio" === e.type ? r.addRight(new a("timesig.perfectum2",0,i.getSymbolWidth("timesig.perfectum2"),6,{
        ...
        8677: function(e, t, r) {
            var n = r(3185)
              ...
              , h = function(e, t, r, n, i) {
                function a(e, t) {
                    ...
                    for (var l = 0; l < t; l++)
                        a -= 1,
                        n.addFixedX(new o(e,c,s.getSymbolWidth(e),a))
                }
            ...
            l.prototype.createDecoration = function(e, t, r, i, a, l, u, d, f, p) {
                ...
                function(e, t, r, n, i, a, c) {
                    ...
                    function h(e) {
                        var t;
                        return "above" === e ? (t = n.above) < a && (t = a) : (t = n.below) > c && (t = c),
                        t
                    }
                    function u(e, n, i) {
                        var a = h(n);
                        r.addFixedX(new o(e,t / 2,0,a + 2,{
                            type: "decoration",
                            klass: "ornament",
                            thickness: 3,
                            anchor: i
                    ...
                    function d(e, n) {
                        ...
                        r.addFixedX(new o(e,i,s.getSymbolWidth(e),c,{
                            klass: "ornament",
                    ...
                    for (var n = 0; n < e.length; n++)
                        if ("arpeggio" === e[n])
                            for (var i = t.abcelem.minpitch - 1; i <= t.abcelem.maxpitch; i += 2)
                                t.addExtra(new o("scripts.arpeggio",2 * -s.getSymbolWidth("scripts.arpeggio") - r,0,i + 2,{
                                    klass: "ornament",
        ...
        1409: function(e, t, r) {
            ...
            a.prototype.addRight = function(e) {
                this.fixed.w = Math.max(this.fixed.w, e.dx + e.w),
                void 0 !== e.top && (void 0 === this.fixed.t ? this.fixed.t = e.top : this.fixed.t = Math.max(this.fixed.t, e.top)),
                void 0 !== e.bottom && (void 0 === this.fixed.b ? this.fixed.b = e.bottom : this.fixed.b = Math.min(this.fixed.b, e.bottom)),
        ...
        8491: function(e) {
            var t = function(e, t, r, n) {
                ...
                this.stemHeight = e,
                this.beams = [],
                n && n.duration ? (this.duration = n.duration,
                n.startTriplet && (this.duration *= n.tripletMultiplier),
                this.duration = Math.round(1e3 * this.duration) / 1e3) : this.duration = 0
            };
            function r(e, t) {
                return t ? e / t : 0
            }
            ...
            t.prototype.runningDirection = function(e) {
                ...
                void 0 !== t && (this.total = Math.round(this.total + t),
            ...
            t.prototype.add = function(e) {
                ...
                void 0 !== t && (e.abcelem.rest || (this.allrests = !1),
                e.beam = this,
                this.elems.push(e),
            ...
            t.prototype.setStemDirection = function() {
                ...
                this.forceup ? this.stemsUp = !0 : this.forcedown ? this.stemsUp = !1 : this.stemsUp = this.average < 6,
                delete this.count,
                this.total = 0
            }
            ,
        ...
        5224: function(e) {
            ...
            t.prototype.setBottomStaff = function(e) {
                this.endVoice = e,
                this.startVoice.header && !this.endVoice.header && (this.header = this.startVoice.header,
        ...
        3736: function(e) {
            e.exports = function(e, t, r, n, i, a) {
                ...
                if ("" === o)
                    this.rows.push({
                        move: 2 * c.attr["font-size"]
                    });
                else if ("string" == typeof o)
                    this.rows.push({
                        move: c.attr["font-size"] / 2
                    }),
                    this.rows.push({
                        left: n,
                        text: o,
        ...
        6658: function(e) {
            var t = function(e, t, r, n, i) {
                ...
                i.thickness && (this.top += i.thickness / 2,
                this.bottom -= i.thickness / 2),
                ...
                case "debug":
                    ...
                    break;
                case "lyric":
                    i.position && "below" === i.position ? this.lyricHeightBelow = this.height : this.lyricHeightAbove = this.height;
                    break;
                case "chord":
                    i.position && "below" === i.position ? this.chordHeightBelow = this.height : this.chordHeightAbove = this.height;
                    break;
                case "text":
                    void 0 === this.pitch ? i.position && "below" === i.position ? this.chordHeightBelow = this.height : this.chordHeightAbove = this.height : this.centerVertically = !0;
                    break;
                case "part":
            ...
            t.prototype.putChordInLane = function(e) {
                this.lane = e,
                this.chordHeightAbove ? this.chordHeightAbove = 1.25 * this.height * this.lane : this.chordHeightBelow = 1.25 * this.height * this.lane
            }
            ,
        ...
        1106: function(e, t, r) {
            ...
            a.prototype.createNote = function(e, t, r) {
                var a, s, o, c = .75, l = t.duration[0], h = new n(t,l,1,"tempo",r);
                l <= 1 / 32 ? (o = "noteheads.quarter",
                s = "flags.u32nd",
                a = 0) : l <= 1 / 16 ? (o = "noteheads.quarter",
                s = "flags.u16th",
                a = 0) : l <= 3 / 32 ? (o = "noteheads.quarter",
                s = "flags.u16nd",
                a = 1) : l <= 1 / 8 ? (o = "noteheads.quarter",
                s = "flags.u8th",
                a = 0) : l <= 3 / 16 ? (o = "noteheads.quarter",
                s = "flags.u8th",
                a = 1) : l <= 1 / 4 ? (o = "noteheads.quarter",
                a = 0) : l <= 3 / 8 ? (o = "noteheads.quarter",
                a = 1) : l <= .5 ? (o = "noteheads.half",
                a = 0) : l <= 3 / 4 ? (o = "noteheads.half",
                a = 1) : l <= 1 ? (o = "noteheads.whole",
                a = 0) : l <= 1.5 ? (o = "noteheads.whole",
                a = 1) : l <= 2 ? (o = "noteheads.dbl",
                a = 0) : (o = "noteheads.dbl",
                a = 1);
                var u, d = e(h, o, {
                    verticalPos: 0
        ...
        6183: function(e) {
            ...
            t.prototype.setEndAnchor = function(e) {
                this.anchor2 = e,
                this.anchor1 ? (this.top = Math.max(this.anchor1.pitch, this.anchor2.pitch) + 4,
                this.bottom = Math.min(this.anchor1.pitch, this.anchor2.pitch) - 4) : (this.top = this.anchor2.pitch + 4,
            ...
            t.prototype.calcX = function(e, t) {
                ...
                this.anchor1.scalex < 1 && (this.startX -= 3)) : this.startLimitX ? this.startX = this.startLimitX.x + this.startLimitX.w : this.anchor2 ? this.startX = this.anchor2.x - 20 : this.startX = e,
            ...
            t.prototype.calcSlurY = function() {
                if (this.anchor1 && this.anchor2) {
                    ...
                    this.endX += Math.round(this.anchor2.w / 2)) : this.endY = this.above && e ? this.anchor2.highestVert : this.anchor2.pitch
                } else
        ...
        1134: function(e, t, r) {
            ...
            e.exports = function(e, t, r, i, a, s, o, c, l) {
                ...
                e.author && e.author.length > 0 && n(this.rows, {
                    marginLeft: o + a,
                    text: e.author,
                    font: "composerfont",
                ...
                e.partOrder && e.partOrder.length > 0 && n(this.rows, {
                    marginLeft: o,
                    text: e.partOrder,
                    font: "partsfont",
        ...
        3197: function(e) {
            ...
            t.prototype.setLimit = function(e, t) {
                var r = t.specialY;
                r || (r = t),
                r[e] && (this.specialY[e] ? this.specialY[e] = Math.max(this.specialY[e], r[e]) : this.specialY[e] = r[e])
            }
            ,
            ...
            var n = r(4331)
              ...
              , a = function(e) {
                for (var t = [], r = 0, n = e.length; r < n; r++) {
                    t[r] = [];
                    for (var i = 0, a = e[r].length; i < a; i++)
                        t[r][i] = e[r][i]
                }
                return t
            }
        ...
        4750: function(e, t, r) {
            ...
            e.exports = function(e, t, r, c, l) {
                if (!t.invisible) {
                    ...
                    t.elemset = [],
                    o.beginGroup(e.paper, e.controller);
                    for (var u = 0; u < t.children.length; u++) {
                        var d = t.children[u];
                        "TempoElement" === d.type ? n(e, d) : i(e, d, r)
                    }
                    var f = t.type;
                    if (("note" === t.type || "rest" === t.type) && (t.counters = e.controller.classes.getCurrent(),
                    ...
                    if (m) {
                        if (t.cloned && (t.cloned.overrideClasses = m.className.baseVal),
                        t.overrideClasses) {
                        ...
                        if (h)
                            ...
                            t.elemset.push(m);
                            var v = !1;
                            "note" !== t.type && "tabNumber" !== t.type || (v = !0),
                            c.add(t, m, v, l)
                        }
                    } else
                        t.elemset.length > 0 && c.add(t, t.elemset[0], "note" === t.type, l);
                    if (t.klass && s(t.elemset, "mark", "", "#00ff00"),
                    ...
                    t.heads && t.heads.length > 0) {
                        ...
                        for (var b = 0; b < t.heads.length; b++)
                            t.notePositions.push({
                                ...
                                y: l.zero - t.heads[b].pitch * a.STEP
                            })
                    }
                }
            }
            ...
            e.exports = function(e, t) {
                if (0 !== t.beams.length) {
                    for (var r = "", i = 0; i < t.beams.length; i++) {
                        var o = t.beams[i];
                        if (o.split) {
                            for (var c = (m = o.startX,
                            g = o.startY,
                            v = o.endX,
                            (o.endY - g) / (v - m)), l = [], h = 0; h < o.split.length; h += 2)
                            ...
                            r += a(e, o.startX, o.startY, o.endX, o.endY, o.dy)
                    }
        ...
        129: function(e, t, r) {
            ...
            var o = function(e, t, r, o, c, l, h) {
                ...
                return "brace" === c ? u = function(e, t, r, n, i) {
                    var a = n - r
                      , o = s(t, r, [7.5, -8, 21, 0, 18.5, -10.5, 7.5], [0, a / 5.5, a / 3.14, a / 2, a / 2.93, a / 4.88, 0]);
                    return o += s(t, r, [0, 17.5, -7.5, 6.6, -5, 20, 0], [a / 2, a / 1.46, a / 1.22, a, a / 1.19, a / 1.42, a / 2]),
                    e.paper.path({
                        path: o,
                ...
                }(e, t, r, o, c) : "bracket" === c && (u = function(e, t, r, a, s) {
                    t += i.STEP;
                    var o = .75 * i.STEP
                      , c = .75 * i.STEP
                      , l = a - r
            ...
            e.exports = function(e, t, r) {
                ...
                return t.endVoice && t.endVoice.staff ? t.endY = t.endVoice.staff.absoluteY - 2 * i.STEP : t.lastContinuedVoice && t.lastContinuedVoice.staff ? t.endY = t.lastContinuedVoice.staff.absoluteY - 2 * i.STEP : t.endY = t.startVoice.staff.absoluteY - 2 * i.STEP,
        ...
        3245: function(e, t, r) {
            ...
            e.exports = function(e, t, r) {
                ...
                var n, i = e.calcY(t.pitch) + 4, a = t.anchor1 ? t.anchor1.x : 0, o = t.anchor2 ? t.anchor2.x : 800;
                return n = "<" === t.dir ? s(e, i + 4, i, i + 4, i + 8, a, o) : s(e, i, i + 4, i + 8, i + 4, a, o),
                r.wrapSvgEl({
            ...
            e.exports = function(e, t, r, n, s, h, u, d, f, p) {
                ...
                for (var g = [], v = 0; v < r.lines.length; v++) {
                    ...
                    if (b.staff) {
                        ...
                        b.nonMusic && (e.paper.openGroup(),
                        a(e, b.nonMusic, m),
                        e.paper.closeGroup())
                }
                return t.reset(),
                r.bottomText && r.bottomText.rows && r.bottomText.rows.length > 0 && (e.paper.openGroup(),
                e.moveY(24),
                a(e, r.bottomText, m),
                e.paper.closeGroup()),
                i(e, s, u, h),
        ...
        5947: function(e, t, r) {
            ...
            e.exports = function(e, t, r, o, c) {
                ...
                var l = s(e.calcY(t.pitch))
                  , h = "";
                t.anchor1 && (r = s(t.anchor1.x + t.anchor1.w),
                h += n("M %f %f L %f %f ", r, l, r, s(l + 20))),
                t.anchor2 && (o = s(t.anchor2.x),
        ...
        9045: function(e, t, r) {
            ...
            e.exports = function(e, t, r) {
                t.anchor1 && t.anchor2 && t.anchor1.heads && t.anchor2.heads && 0 !== t.anchor1.heads.length && 0 !== t.anchor2.heads.length || window.console.error("Glissando Element not set.");
                var n, i, a = e.calcY(t.anchor1.heads[0].pitch), o = e.calcY(t.anchor2.heads[0].pitch), c = t.anchor1.x + t.anchor1.w / 2, l = t.anchor2.x + t.anchor2.w / 2, h = function(e, t, r, n) {
                    var i = r - e
                      , a = n - t;
                    return Math.sqrt(i * i + a * a)
                }(c, a, l, o), u = t.anchor1.w / 2 + 4, d = t.anchor2.w / 2 + 4, p = function(e, t, r, n) {
                    return (n - t) / (r - e)
                }(c, a, l, o), m = s(a, p, u), g = (s(o, p, -d),
                n = h - u - d,
                i = 5,
                Math.max(2, Math.floor((n - 2 * i) / 6))), v = f(e, c + u, m, g, p);
                return r.wrapSvgEl({
                    el_type: "glissando",
                    startChar: -1,
                    endChar: -1
        ...
        8832: function(e, t, r) {
            ...
            i.prototype.endGroup = function(e, t) {
                ...
                return n && (n.setAttribute("class", this.controller.classes.generate(e)),
        ...
        6637: function(e, t, r) {
            ...
            e.exports = function(e, t, r, a, s, o, c) {
                ...
                var h = i(a - c)
                  , u = i(a + c)
                  , d = {
                    path: n("M %f %f L %f %f L %f %f L %f %f z", t, h, r, h, r, u, t, u),
                    stroke: "none",
                    fill: l
                };
                return o && (d["data-name"] = o),
                s && (d.class = s),
        ...
        3624: function(e, t, r) {
            ...
            e.exports = function(e, t, r, a, s, o, c) {
                if (r < 0 || a < s) {
                    ...
                    s = i(s);
                t = i(t);
                for (var h = i(t + r), u = [["M", t, a], ["L", t, s], ["L", h, s], ["L", h, a], ["z"]], d = {
                    path: ""
                }, f = 0; f < u.length; f++)
                    d.path += u[f].join(" ");
                return o && (d.class = o),
                c && (d["data-name"] = c),
                n.isInGroup() || (d.stroke = "none",
                d.fill = e.foregroundColor),
                e.paper.pathToBack(d)
            }
        },
        4777: function(e, t, r) {
            ...
            e.exports = function(e, t, r, s, o) {
                ...
                if (s.length > 1 && s.indexOf(".") < 0) {
                    ...
                    for (var m = 0, g = 0; g < s.length; g++) {
                        var v = s[g];
                        l = i.getYCorr(v),
                        (c = i.printSymbol(t + m, e.calcY(r + l), v, e.paper, {
                            stroke: o.stroke,
                            fill: o.fill
                        })) ? g < s.length - 1 && (m += (h = v,
                        u = s[g + 1],
                ...
                return l = i.getYCorr(s),
                (c = a.isInGroup() ? i.printSymbol(t, e.calcY(r + l), s, e.paper, {
                    "data-name": o.name
        ...
        2435: function(e, t, r) {
            ...
            e.exports = function(e, t, r) {
                ...
                case "stem":
                    ...
                    break;
                case "ledger":
                    t.graphelem = a(e, t.x, t.x + t.w, t.pitch, "abcjs-ledger", "ledger", .35 + e.lineThickness)
                }
                return 1 !== t.scalex && t.graphelem && function(e, t, r, n, i, a) {
        ...
        3524: function(e, t, r) {
            ...
            a.prototype.add = function(e, t, r, n) {
                if (this.canSelect(e)) {
                    ...
                    void 0 !== n && (a.staffPos = n),
                    this.elements.push(a)
                }
            }
            ,
            a.prototype.canSelect = function(e) {
                return !(!1 === this.selectTypes || !e || !e.abcelem || !0 !== this.selectTypes && !(void 0 === this.selectTypes ? "note" === e.abcelem.el_type || "tabNumber" === e.abcelem.el_type : this.selectTypes.indexOf(e.abcelem.el_type) >= 0))
            }
            ,
        ...
        4169: function(e) {
            e.exports = function(e, t) {
                var r = Math.round(e.y)
                  ...
                  , i = n + t
                  , a = "M " + n + " " + r + " L " + i + " " + r + " L " + i + " " + (r + 1) + " L " + n + " " + (r + 1) + " L " + n + " " + r + " z";
                e.paper.pathToBack({
                    path: a,
                    stroke: "rgba(0,0,0,0)",
                    fill: "rgba(0,0,0,255)",
        ...
        7611: function(e) {
            e.exports = function(e, t, r, n) {
                ...
                if (e.isPrint && (a = Math.max(a, 1056)),
                "" !== e.ariaLabel) {
                    var s = "Sheet Music";
                    e.abctune && e.abctune.metaText && e.abctune.metaText.title && (s += ' for "' + e.abctune.metaText.title + '"'),
                    e.paper.setTitle(s);
                    var o = e.ariaLabel ? e.ariaLabel : s;
                    e.paper.setAttribute("aria-label", o)
                }
                e.paper.insertStyles(".abcjs-dragging-in-progress text, .abcjs-dragging-in-progress tspan {" + ["-webkit-touch-callout: none;", "-webkit-user-select: none;", "-khtml-user-select: none;", "-moz-user-select: none;", "-ms-user-select: none;", "user-select: none;"].join(" ") + "}");
                var c = {
                    overflow: "hidden"
                };
                "resize" === n ? e.paper.setResponsiveWidth(i, a) : (c.width = "",
                c.height = a + "px",
                r < 1 ? (c.width = i + "px",
                e.paper.setSize(i / r, a / r)) : e.paper.setSize(i, a)),
                e.paper.setScale(r),
        ...
        6764: function(e) {
            ...
            e.exports = function() {
                for (var e, r, n, i, a, s = 0, o = arguments[s++], c = []; o; ) {
                    if (r = /^[^\x25]+/.exec(o))
                        c.push(r[0]);
                    else if (r = /^\x25{2}/.exec(o))
                        c.push("%");
                    else {
                        if (!(r = /^\x25(?:(\d+)\$)?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/.exec(o)))
                            throw "Huh ?!";
        ...
        5537: function(e, t, r) {
            ...
            function h(e, t, r, a, s) {
                if (r)
                    for (var o = 0; o < r.length; o++)
                        r[o].isStartVoice(a) && (r[o].startY = t - 10 * n.STEP,
                        r[o].elemset = i(e, r[o], s))
            }
            function u(e, t, r) {
            ...
            e.exports = function(e, t, r, i) {
                for (var d, f, p, m = e.y, g = 0; g < t.staffs.length; g++) {
                    ...
                    v.absoluteY = e.y,
                    e.showDebug && (e.showDebug.indexOf("box") >= 0 && v.voices && u(e, t.voices, v.voices),
                    e.showDebug.indexOf("grid") >= 0 && (e.paper.dottedLine({
                        x1: e.padding.left,
                    ...
                    e.showDebug && e.showDebug.indexOf("grid") >= 0 && e.paper.dottedLine({
                        x1: e.padding.left,
                        x2: e.padding.left + e.controller.width,
                        y1: e.y,
                        y2: e.y,
                ...
                for (var b = 2, y = 0, x = 0; x < t.voices.length; x++) {
                    ...
                    !t.voices[x].duplicate) {
                        if (f || (f = e.calcY(10)),
                        p = e.calcY(b),
                        0 !== w.lines) {
                            w.linePitch && (b = w.linePitch),
                            e.controller.classes.newMeasure();
                            var C = s(e, t.startx, t.w, w.lines, w.linePitch, .35);
                            p = C[1],
                            w.bottomLine = p,
                            w.topLine = C[0],
                            w.hasTab && (y = w.topLine),
                            w.hasStaff && (y = w.hasStaff.topLine,
                            t.voices[x].barto = !0,
                            t.voices[x].topLine = f)
                        }
                        h(e, w.absoluteY, t.brace, x, r),
                        h(e, w.absoluteY, t.bracket, x, r)
                    }
                    a(e, t.voices[x], y, r, {
                        top: m,
                        zero: e.y,
                    ...
                    if (k) {
                        ...
                        _.rows.push({
                            move: k.textSize.height
                        }),
                        l(e, _),
                        T = k.textSize.height
                    }
                    e.controller.classes.newMeasure(),
                    t.voices[x].duplicate || (y = e.calcY(2 + T))
                }
                e.controller.classes.newMeasure();
                var S = t.staffs.length;
                function E(t, r) {
                    var i = ["rgb(207,27,36)", "rgb(168,214,80)", "rgb(110,161,224)", "rgb(191,119,218)", "rgb(195,30,151)", "rgb(31,170,177)", "rgb(220,166,142)"];
                    if (t.positionY && t.positionY[r]) {
                        var a = t.specialY[r] * n.STEP;
                        "chordHeightAbove" === r && t.specialY.chordLines && t.specialY.chordLines.above && (a *= t.specialY.chordLines.above),
                        "chordHeightBelow" === r && t.specialY.chordLines && t.specialY.chordLines.below && (a *= t.specialY.chordLines.below),
                        o(e, {
                            x: e.padding.left,
                ...
                S > 1 && (f = t.staffs[0].topLine,
                p = t.staffs[S - 1].bottomLine,
                c(e, t.startx, .6, f, p, null)),
                e.y = m
            }
        },
        7865: function(e, t, r) {
        ...
        7641: function(e, t, r) {
            ...
            e.exports = function(e, t, r, i, a, s) {
                ...
                var l = 0
                  , h = 0;
                if (1 === i)
                    n(e, t, r, 6, o, null, s + e.lineThickness),
                    l = e.calcY(10),
                    h = e.calcY(2);
                else
                    for (var u = i - 1; u >= 0; u--) {
                        ...
                        h = e.calcY(d),
                        0 === l && (l = h),
                        n(e, t, r, d, o, null, s + e.lineThickness),
                        o = void 0
                    }
                return e.paper.closeGroup(),
                [l, h]
        ...
        5759: function(e, t, r) {
            ...
            e.exports = function(e, t, r) {
                ...
                "debugfont" === t.type && (console.log("Debug msg: " + t.text),
                i.attr.stroke = "#ff0000"),
                t.cursor && (i.attr.cursor = t.cursor);
                var o = t.text.replace(/\n\n/g, "\n \n");
                o = o.replace(/^\n/, " \n"),
                i.font.box && (r || e.paper.openGroup({
                    klass: i.attr.class,
                    fill: e.foregroundColor,
                    "data-name": t.name
                }),
                "end" === i.attr["text-anchor"] ? i.attr.x -= i.font.padding : "start" === i.attr["text-anchor"] && (i.attr.x += i.font.padding),
                ...
                if (i.font.box) {
                    var l = c.getBBox()
                      , h = 0;
                    "middle" === i.attr["text-anchor"] ? h = l.width / 2 + i.font.padding : "end" === i.attr["text-anchor"] && (h = l.width + 2 * i.font.padding);
                    var u = 0;
        ...
        3272: function(e, t, r) {
            var n = r(6764)
              , i = r(7199)
              , a = function(e, t, r) {
                e.anchor1 && e.anchor2 ? e.anchor1.pitch === e.anchor2.pitch && 0 === e.internalNotes.length ? e.isTie = !0 : e.isTie = !1 : e.isTie = !0,
                e.isTie ? (e.calcTieDirection(),
                e.calcX(t, r),
                e.calcTieY()) : (e.calcSlurDirection(),
                e.calcX(t, r),
                e.calcSlurY()),
              ...
              , s = function(e, t, r, a, s, o, c, l, h) {
                ...
                a += o ? u : -u,
                s += o ? u : -u;
                var d, f = i(e.calcY(a)), p = i(e.calcY(s)), m = r - t, g = p - f, v = Math.sqrt(m * m + g * g), b = m / v, y = g / v, x = v / 3.5, w = l ? 10 : 25, k = (o ? -1 : 1) * Math.min(w, Math.max(4, x)), C = i(t + x * b - k * y), T = i(f + x * y + k * b), _ = i(r - x * b - k * y), S = i(p - x * y + k * b);
                if (c ? c += " slur" : c = "slur",
                c += l ? " tie" : " legato",
                h) {
                    c += " dotted";
                    ...
                    var M = n("M %f %f C %f %f %f %f %f %f C %f %f %f %f %f %f z", t, f, C, T, _, S, r, p, i(_ - 2 * y), i(S + 2 * b), i(C - 2 * y), i(T + 2 * b), t, f);
                    d = e.paper.path({
                        path: M,
                        stroke: "none",
                        fill: e.foregroundColor,
            ...
            e.exports = function(e, t, r, n, i) {
                a(t, r, n);
                var o = "";
                t.anchor1 ? o += "abcjs-start-m" + t.anchor1.parent.counters.measure + "-n" + t.anchor1.parent.counters.note : o += "abcjs-start-edge",
                t.anchor2 ? o += " abcjs-end-m" + t.anchor2.parent.counters.measure + "-n" + t.anchor2.parent.counters.note : o += " abcjs-end-edge",
                t.hint && (o = "abcjs-hint");
        ...
        3145: function(e, t, r) {
            ...
            e.exports = function(e, t, r, d, f) {
                ...
                var m, g, v = e.foregroundColor;
                if (t.color && (e.foregroundColor = t.color),
                t.header) {
                    var b = h(e, {
                        x: e.padding.left,
                ...
                for (m = 0; m < t.children.length; m++) {
                    ...
                    var w = !1;
                    "staff-extra" === g.type || e.controller.classes.isInMeasure() || (e.controller.classes.startMeasure(),
                    w = !0),
                    t.staff.isTabStaff && (g.invisible = !1,
                    "bar" == g.type && g.abcelem.lastBar && (r = t.topLine)),
                    u(e, g, t.barto || m === t.children.length - 1 ? r : 0, d, f),
                    ("note" === g.type || "rest" === (y = g).type && !(!y.abcelem || !y.abcelem.rest || "spacer" === y.abcelem.rest.type)) && e.controller.classes.incrNote(),
                    "bar" === g.type && !w && x && e.controller.classes.incrMeasure()
                }
                for (e.controller.classes.startMeasure(),
                m = 0; m < t.beams.length; m++) {
                    var k = t.beams[m];
                    "bar" === k ? e.controller.classes.incrMeasure() : l(e, k, d)
                }
                for (e.controller.classes.startMeasure(),
                m = 0; m < t.otherchildren.length; m++)
                    if ("bar" === (g = t.otherchildren[m]))
        ...
        5253: function(e, t, r) {
            var n = r(4331)
              ...
              , b = function(e, t) {
                ...
                this.classes = new f({
                    shouldAddClasses: t.add_classes
                }),
            ...
            function y(e) {
                for (var t = document.createElementNS("http://www.w3.org/2000/svg", "svg"), r = 0; r < e.attributes.length; r++) {
                    ...
                    if (a.staff) {
                        ...
                        a.staffGroup.voices.length > 0)
                            for (var s = a.staffGroup.voices[0], o = !1, c = 0, l = 0; l < s.children.length; l++) {
                                var h = s.children[l];
                                o || h.isClef || h.isKeySig || (o = !0,
                                t.left = h.x,
                                c = h.x),
                                "bar" === h.type && (t.measureWidths.push(h.x - c),
                                t.total += h.x - c,
                                c = h.x)
                            }
                    } else
            ...
            b.prototype.setupTune = function(e, t) {
                ...
                return "resize" === this.responsive && (r = void 0),
            ...
            b.prototype.constructTuneElements = function(e) {
                var t, r;
                e.topText = new l(e.metaText,e.metaTextInfo,e.formatting,e.lines,this.width,this.renderer.isPrint,this.renderer.padding.left,this.renderer.spacing,this.getTextSize);
                var n = !1
                  , i = !1;
                for (t = 0; t < e.lines.length; t++)
                    if ((r = e.lines[t]).staff)
                        ...
                        if (i) {
                            ...
                            r.nonMusic = new c(this.renderer.spacing.subtitle,e.formatting,r.subtitle,a,this.renderer.padding.left,this.getTextSize)
                        }
                    } else
                        void 0 !== r.text ? (i = !0,
                        r.nonMusic = new s(r.text,r.vskip,this.getFontAndAttr,this.renderer.padding.left,this.width,this.getTextSize)) : void 0 !== r.separator && r.separator.lineLength && (i = !0,
                        r.nonMusic = new o(r.separator.spaceAbove,r.separator.lineLength,r.separator.spaceBelow));
                e.bottomText = new h(e.metaText,this.width,this.renderer.isPrint,this.renderer.padding.left,this.renderer.spacing,this.getTextSize)
            }
            ,
            b.prototype.engraveTune = function(e, t, r) {
                ...
                if (this.staffgroups = a.staffgroups,
                this.selectables = a.selectables,
                this.oneSvgPerLine) {
                    ...
                    this.svgs = function(e, t, r) {
                        ...
                        for (var i = n.querySelector("style"), a = "resize" === r ? n.viewBox.baseVal.width : n.getAttribute("width"), s = e.querySelectorAll("svg > g"), o = 0, c = [], l = 0; l < s.length; l++) {
                            var h = s[l]
                              , u = h.getBBox()
                              , d = u.y - o
                              , f = u.height + d
                            ...
                            g.setAttribute("viewBox", "0 " + o + " " + a + " " + f),
        ...
        1954: function(e) {
            var t = function(e) {
                this.shouldAddClasses = e.shouldAddClasses,
                this.reset()
            };
            ...
            t.prototype.measureTotal = function() {
                ...
                return this.measureNumber && (e += this.measureNumber),
                e
            }
            ,
            ...
            t.prototype.generate = function(e) {
                if (!this.shouldAddClasses)
                    return "";
                var t = [];
                if (e && e.length > 0 && t.push(e),
                "tab-number" === e)
                    return t.join(" ");
                if ("text instrument-name" === e)
                    return "abcjs-text abcjs-instrument-name";
                if (null !== this.lineNumber && t.push("l" + this.lineNumber),
                ...
                e && (e.indexOf("note") >= 0 || e.indexOf("rest") >= 0 || e.indexOf("lyric") >= 0) && null !== this.noteNumber && t.push("n" + this.noteNumber),
                t.length > 0) {
                    t = (t = t.join(" ")).split(" ");
                    for (var r = 0; r < t.length; r++)
        ...
        1328: function(e) {
            ...
            t.prototype.calc = function(e, t) {
                var r;
                r = "string" == typeof e ? (r = this.formatting[e]) ? {
                    face: r.face,
                ...
                var n = this.formatting.fontboxpadding ? this.formatting.fontboxpadding : .1;
                return r.padding = r.size * n,
                {
                    font: r,
                    attr: {
                        "font-size": r.size,
        ...
        9799: function(e) {
            ...
            t.prototype.calc = function(e, t, r, n) {
                var i;
                i = "string" == typeof t ? this.attr(t, r) : {
                    font: {
                        face: t.face,
                        size: t.size,
                ...
                return i.font.box ? {
                    height: a.height + 4 * i.font.padding,
                    width: a.width + 4 * i.font.padding
                } : a
            }
            ,
            t.prototype.baselineToCenter = function(e, t, r, n, i) {
                return .5 * this.calc(e, t, r).height + (i - n - 2) * this.attr(t, r).font.size
            }
            ,
            e.exports = t
        },
            ...
            e.exports = function(e, t, r, n) {
                if (e)
                    for (var i = 0; i < e.length; i++) {
                        ...
                        t.length > 0 && (o.length > 0 && " " !== o[o.length - 1] && (o += " "),
                        o += t),
        ...
        8068: function(e, t, r) {
            var n = r(4331);
            function i(e) {
                "keyboard" === this.dragMechanism && 0 !== this.dragYStep && this.dragTarget && f.bind(this)(this.dragTarget, this.dragYStep, this.selectables.length, this.dragIndex, e),
                this.dragYStep = 0
            }
            function a(e) {
                switch (e.keyCode) {
            ...
            function s(e) {
                ...
                case 38:
                    ...
                    this.dragTarget = this.selectables[r],
                    this.dragIndex = r,
                    this.dragTarget && this.dragTarget.isDraggable && (this.dragging && this.dragTarget.isDraggable && this.dragTarget.absEl.highlight(void 0, this.dragColor),
                    this.dragYStep--,
            ...
            function o(e, t) {
                var r, n, i, a = function(e, t) {
                    for (var r = 0; r < e.length; r++)
                        if (t.dataset.index === e[r].svgEl.dataset.index)
                            return r;
                    return -1
                }(e.selectables, function(e) {
                    if ("svg" === e.tagName)
                        return e;
                ...
                return a >= 0 ? (i = function(e, t, r) {
                    return e.x <= t.offsetX && e.x + e.width >= t.offsetX && e.y <= t.offsetY && e.y + e.height >= t.offsetY || Math.abs(t.layerY / r - t.offsetY) < 3 ? [t.offsetX, t.offsetY] : [t.layerX, t.layerY]
                }(e.selectables[a].svgEl.getBBox(), t, e.scale),
                r = i[0],
                n = i[1]) : (i = function(e) {
                    var t, r, n = 1, i = 1, a = e.target.closest("svg"), s = 0;
                    return a && a.viewBox && a.viewBox.baseVal && (0 !== a.viewBox.baseVal.width && (n = a.viewBox.baseVal.width / a.clientWidth),
                    0 !== a.viewBox.baseVal.height && (i = a.viewBox.baseVal.height / a.clientHeight),
                    s = a.viewBox.baseVal.y),
                    e.target && "svg" === e.target.tagName ? (t = e.offsetX,
                    r = e.offsetY) : (t = e.layerX,
                    r = e.layerY),
                    [t *= n, (r *= i) + s]
                }(t),
                a = function(e, t, r) {
                    for (var n = 9999999, i = -1, a = 0; a < e.selectables.length && n > 0; a++) {
                        ...
                        if (e.getDim(s),
                        s.dim.left < t && s.dim.right > t && s.dim.top < r && s.dim.bottom > r)
                            i = a,
                            n = 0;
                            ...
                            var l = Math.abs(t - s.dim.left) > Math.abs(t - s.dim.right) ? Math.abs(t - s.dim.right) : Math.abs(t - s.dim.left)
                              , h = Math.abs(r - s.dim.top) > Math.abs(r - s.dim.bottom) ? Math.abs(r - s.dim.bottom) : Math.abs(r - s.dim.top)
                              , u = Math.sqrt(l * l + h * h);
                            u < n && (n = u,
                            i = a)
                        }
            ...
            function l(e) {
                var t = e;
                "touchstart" === e.type && (c(e),
                e.touches.length > 0 && (t = e.touches[0]));
                var r = o(this, t);
                r.clickedOn >= 0 && ("touchstart" === e.type || 0 === e.button) && this.selectables[r.clickedOn] && (this.dragTarget = this.selectables[r.clickedOn],
                ...
                this.dragging && this.dragTarget.isDraggable && (function(e, t) {
                    if (e) {
                        var r = v(e.svg);
                        r[t] = !0,
                        b(e.svg, r)
            ...
            function h(e) {
                var t = e;
                if ("touchmove" === e.type && (c(e),
                e.touches.length > 0 && (t = e.touches[0])),
                this.lastTouchMove = e,
                this.dragTarget && this.dragging && this.dragTarget.isDraggable && "mouse" === this.dragMechanism && this.dragMouseStart) {
                    var r = o(this, t)
                      , i = Math.round((r.y - this.dragMouseStart.y) / n.STEP);
                    i !== this.dragYStep && (this.dragYStep = i,
                    this.dragTarget.svgEl.setAttribute("transform", "translate(0," + i * n.STEP + ")"))
                }
            }
            function u(e) {
                var t = e;
                "touchend" === e.type && this.lastTouchMove && (c(this.lastTouchMove),
                this.lastTouchMove && this.lastTouchMove.touches && this.lastTouchMove.touches.length > 0 && (t = this.lastTouchMove.touches[0])),
                this.dragTarget && (m.bind(this)(),
                this.dragTarget.absEl && this.dragTarget.absEl.highlight && (this.selected = [this.dragTarget.absEl],
                ...
                this.dragTarget.svgEl && this.dragTarget.svgEl.focus && (this.dragTarget.svgEl.focus(),
                this.dragTarget = null,
                this.dragIndex = -1),
                function(e, t) {
                    if (e) {
            ...
            function d(e) {
                e >= 0 && e < this.selectables.length && (this.dragTarget = this.selectables[e],
                this.dragIndex = e,
                this.dragMechanism = "keyboard",
                u.bind(this)({
            ...
            function f(e, t, r, n, i) {
                ...
                if (e.absEl.elemset) {
                    for (var s = {}, o = 0; o < e.absEl.elemset.length; o++) {
                        ...
                        if (c)
                            for (var l = c.getAttribute("class").split(" "), h = 0; h < l.length; h++)
                                s[l[h]] = !0
                    }
                    for (var u = 0; u < Object.keys(s).length; u++)
                        a.push(Object.keys(s)[u])
                }
                for (var f = {}, m = 0; m < a.length; m++)
                    p(a[m], "abcjs-v", f, "voice"),
                    p(a[m], "abcjs-l", f, "line"),
                    p(a[m], "abcjs-m", f, "measure");
                ...
                for (var b = 0; b < this.listeners.length; b++)
                    this.listeners[b](e.absEl.abcelem, e.absEl.tuneNumber, a.join(" "), f, {
                        step: t,
                        max: r,
                        index: n,
                        setSelection: d.bind(this)
                    }, i)
            }
            function p(e, t, r, n) {
                if (0 === e.indexOf(t)) {
                ...
                for (var r = 0; r < this.staffgroups.length; r++)
                    for (var n = this.staffgroups[r].voices, i = 0; i < n.length; i++)
                        for (var a = n[i].children, s = 0; s < a.length; s++) {
                            ...
                            a[s].highlight(void 0, this.selectionColor))
                        }
            }
            function v(e) {
            ...
            e.exports = function(e, t) {
                if (e.rangeHighlight = g,
                e.dragging)
                    for (var r = 0; r < e.selectables.length; r++) {
                        var n = e.selectables[r];
                        "true" === n.svgEl.getAttribute("selectable") && (n.svgEl.setAttribute("tabindex", 0),
        ...
        6251: function(e, t, r) {
            ...
            function o(e, t, r, n) {
                ...
                for (var i = 0; i < e.children.length; i++) {
                    var a = e.children[i];
                    t && void 0 !== a.top && "flags.ugrace" === a.c ? n = Math.max(n, a.top - r) : t || void 0 === a.bottom || "flags.ugrace" !== a.c || (n = Math.max(n, r - a.bottom + 7))
                }
                return n
            }
            function c(e, t, r) {
            ...
            e.exports = function(e) {
                if (0 !== e.elems.length && !e.allrests) {
                    ...
                    for (var p = function(e, t, r, n, i) {
                        ...
                        return o
                    }(e.elems, e.stemsUp, e.beams[0], e.isgrace, t), m = 0; m < p.length; m++)
                        e.addBeam(p[m]);
                    !function(e, t, r, s, o) {
                        for (var c = 0; c < e.length; c++) {
                            var l = e[c];
        ...
        4760: function(e) {
            ...
            e.exports = function(e, n, i, a, s) {
                var o, c, l = e.padding.left, h = 0;
                for (o = 0; o < i.length; o++)
                    i[o].header && (c = n.calc(i[o].header, "voicefont", ""),
            ...
            var n = r(6759)
              ...
              , o = function(e, t, r, n, i, o, l) {
                for (var h = s(e, n.getTextSize, n.voices, n.brace, n.bracket), u = r, d = 0; d < 8; d++) {
                    var f = a(u, e, l, n, h);
                    if (u = c(o, i.stretchlast, t + e.padding.left, n.w, u, f.spacingUnits, f.minSpace, e.padding.left + e.padding.right),
            ...
            function c(e, t, r, n, i, a, s, o) {
                if (e)
                    if (void 0 === t) {
                        ...
                        return null;
                return Math.abs(r - n) < 2 ? null : a > 0 ? ((i = (r - (n - a * i)) / a) * s > 50 && (i = 50 / s),
                i) : null
            }
            e.exports = function(e, t, r, a) {
                var s, c, l = r;
                for (s = 0; s < t.lines.length; s++)
                    (c = t.lines[s]).staff && (o(e, r, a, c.staffGroup, t.formatting, s === t.lines.length - 1, !1),
        ...
        6934: function(e, t, r) {
            ...
            function o(e, t, r) {
                for (var n = 0; n < t.children.length; n++) {
                    ...
                    for (var a in t.specialY)
                        t.specialY.hasOwnProperty(a) && i[a] && (i.pitch = e[a],
                        void 0 === i.top && ("TempoElement" === i.type ? u(e, i) : d(e, i, r),
                        t.pushTop(i.top),
                        t.pushBottom(i.bottom)))
                }
            }
            function c(e, t) {
            ...
            function d(e, t, r) {
                ...
                case "text":
                case "chord":
                    t.chordHeightAbove ? (t.top = e.chordHeightAbove,
                    t.bottom = e.chordHeightAbove) : (t.top = e.chordHeightBelow,
                    t.bottom = e.chordHeightBelow);
                    break;
                case "lyric":
                    t.lyricHeightAbove ? (t.top = e.lyricHeightAbove,
                    t.bottom = e.lyricHeightAbove) : (t.top = e.lyricHeightBelow + r.vocal / n.STEP,
                ...
                void 0 !== t.pitch && void 0 !== t.top || console.error("RelativeElement position not set.", t.type, t.pitch, t.top, e)
            }
            e.exports = function(e, t) {
                for (var r, o = 0; o < t.staffs.length; o++) {
                    ...
                    if (e.showDebug && e.showDebug.indexOf("box") >= 0 && (c.originalTop = c.top,
                    c.originalBottom = c.bottom),
                    a(c, l, "lyricHeightAbove"),
                    a(c, l, "chordHeightAbove", c.specialY.chordLines.above),
                    c.specialY.endingHeightAbove && (c.specialY.chordHeightAbove ? c.top += 2 : c.top += c.specialY.endingHeightAbove + i,
                    l.endingHeightAbove = c.top),
                    c.specialY.dynamicHeightAbove && c.specialY.volumeHeightAbove ? (c.top += Math.max(c.specialY.dynamicHeightAbove, c.specialY.volumeHeightAbove) + i,
                    l.dynamicHeightAbove = c.top,
                    l.volumeHeightAbove = c.top) : (a(c, l, "dynamicHeightAbove"),
                    a(c, l, "volumeHeightAbove")),
                    a(c, l, "partHeightAbove"),
                    a(c, l, "tempoHeightAbove"),
                    c.specialY.lyricHeightBelow && (c.specialY.lyricHeightBelow += e.spacing.vocal / n.STEP,
                    ...
                    c.specialY.volumeHeightBelow && c.specialY.dynamicHeightBelow ? (l.volumeHeightBelow = c.bottom,
                    l.dynamicHeightBelow = c.bottom,
                    c.bottom -= Math.max(c.specialY.volumeHeightBelow, c.specialY.dynamicHeightBelow) + i) : c.specialY.volumeHeightBelow ? (l.volumeHeightBelow = c.bottom,
                    c.bottom -= c.specialY.volumeHeightBelow + i) : c.specialY.dynamicHeightBelow && (l.dynamicHeightBelow = c.bottom,
                    c.bottom -= c.specialY.dynamicHeightBelow + i),
        ...
        735: function(e, t, r) {
            ...
            e.exports = function(e, t, r, s, o) {
                ...
                s.startx = u;
                var d, f, p = 0;
                for (r && console.log("init layout", e),
                c = 0; c < s.voices.length; c++)
                ...
                for (var m = 0; !i(s.voices); ) {
                    ...
                    for (c = 0; c < s.voices.length; c++)
                        a(s.voices[c]) - p > 1e-7 ? v.push(s.voices[c]) : g.push(s.voices[c]);
                    m = 0;
                    var b = 0;
                    for (c = 0; c < g.length; c++)
                        n.getNextX(g[c]) > u && (u = n.getNextX(g[c]),
                    ...
                    for (c = 0; c < g.length; c++) {
                        ...
                        f = w,
                        (d = x) && d.staff && d.staff.voices && 0 !== d.staff.voices.length && f && f.staff && f.staff.voices && 0 !== f.staff.voices.length && d.staff.voices[0] === f.staff.voices[0] || (w = void 0);
                    ...
                    for (c = 0; c < v.length; c++)
                        v[c].spacingduration -= b,
                        n.updateNextX(u, e, v[c]);
                    for (c = 0; c < g.length; c++) {
                        var _ = g[c];
                        n.updateIndices(_)
                    }
                ...
                for (c = 0; c < s.voices.length; c++)
                    n.getNextX(s.voices[c]) > u && (u = n.getNextX(s.voices[c]),
        ...
        3294: function(e, t, r) {
            ...
            e.exports = function(e) {
                if (e.anchor1 && e.anchor2) {
                    ...
                    if (!e.hasBeam || t.elems[0] === e.anchor1.parent && t.elems[t.elems.length - 1] === e.anchor2.parent || (e.hasBeam = !1),
                    e.hasBeam) {
                        ...
                        "rest" === e.anchor1.parent.type && "rest" !== e.anchor2.parent.type ? e.startNote = e.endNote : "rest" === e.anchor2.parent.type && "rest" !== e.anchor1.parent.type && (e.endNote = e.startNote);
                        for (var a = 0, s = 0; s < e.middleElems.length; s++)
                            a = Math.max(a, e.middleElems[s].top);
                        ((a += 4) > e.startNote || a > e.endNote) && (e.startNote = a,
                        e.endNote = a),
                        e.flatBeams && (e.startNote = Math.max(e.startNote, e.endNote),
        ...
        937: function(e) {
            ...
            t.layoutOneItem = function(e, t, r, n, i) {
                ...
                if ("note" === a.abcelem.el_type && !a.abcelem.rest && 0 !== r.voicenumber && i) {
                    var c = i.children[i.i]
                      , l = c && (a.abcelem.maxpitch <= c.abcelem.maxpitch + 1 && a.abcelem.maxpitch >= c.abcelem.minpitch - 1 || a.abcelem.minpitch <= c.abcelem.maxpitch + 1 && a.abcelem.minpitch >= c.abcelem.minpitch - 1);
                    if (l && a.abcelem.minpitch === c.abcelem.minpitch && a.abcelem.maxpitch === c.abcelem.maxpitch && c.heads && c.heads.length > 0 && a.heads && a.heads.length > 0 && c.heads[0].c === a.heads[0].c && (l = !1),
                    l) {
                        var h = c.heads && c.heads.length > 0 ? c.heads[0].realWidth : c.fixed.w;
                        a.adjustedWidth || (a.adjustedWidth = h + a.w),
                        a.w = a.adjustedWidth;
                        for (var u = 0; u < a.children.length; u++) {
                            var d = a.children[u];
                            d.name.indexOf("accidental") < 0 && (d.adjustedWidth || (d.adjustedWidth = d.dx + h),
                ...
                var f = function(e, t) {
                    var r = 0;
                    return "note" !== e.type && "bar" !== e.type || (r = t),
                    -e.extraw + r
                }(a, o);
                return s < f && (0 === r.i || "bar" !== a.type || "part" !== r.children[r.i - 1].type && "tempo" !== r.children[r.i - 1].type) && (e += f - s),
                a.setX(e),
            ...
            t.updateIndices = function(e) {
                this.layoutEnded(e) || (e.durationindex += e.children[e.i].duration,
        ...
        6759: function(e, t, r) {
            ...
            function o(e, t) {
                ...
                if (r) {
                    for (var n = 0; n < e.length; n++)
                        if (e[n] < r.left)
                            return n > 0 && t.putChordInLane(n),
                            void (e[n] = r.right);
                    e.push(r.right),
                    t.putChordInLane(e.length - 1)
                }
            }
            function c(e) {
                for (var t = 0, r = 0; r < e.children.length; r++)
            ...
            function l(e, t) {
                return t = t.beams[0],
                i(t.startX, t.startY, t.endX, t.endY, e.x)
            }
            e.exports = function(e) {
                ...
                for (e.staff.specialY.chordLines = function(e) {
                    var t, r, n, i = [0], a = [0];
                    for (t = 0; t < e.length; t++) {
                        for (r = 0; r < e[t].children.length; r++)
                            (n = e[t].children[r]).chordHeightAbove && o(i, n);
                        for (r = e[t].children.length - 1; r >= 0; r--)
                            (n = e[t].children[r]).chordHeightBelow && o(a, n)
                    }
                    return (i.length > 1 || a.length > 1) && function(e, t, r) {
                        for (var n = 0; n < e.length; n++) {
                            c(e[n]);
                ...
                t = 0; t < e.otherchildren.length; t++) {
                    var i = e.otherchildren[t];
                    "TripletElem" === i.type && (a(i),
                    e.adjustRange(i))
                }
                e.staff.top = Math.max(e.staff.top, e.top),
                e.staff.bottom = Math.min(e.staff.bottom, e.bottom)
        ...
        8510: function(e, t, r) {
            ...
            a.prototype.setPadding = function(e) {
                function t(t, r, n, i, a) {
                    void 0 !== e.formatting[n] ? t.padding[r] = e.formatting[n] : void 0 !== t.paddingOverride[r] ? t.padding[r] = t.paddingOverride[r] : t.isPrint ? t.padding[r] = i : t.padding[r] = a
                }
        ...
        4101: function(e) {
            ...
            r.prototype.setResponsiveWidth = function(e, t) {
                ...
                this.svg.parentNode) {
                    ...
                    r ? r.indexOf("abcjs-container") < 0 && this.svg.parentNode.setAttribute("class", r + " abcjs-container") : this.svg.parentNode.setAttribute("class", "abcjs-container"),
            ...
            r.prototype.text = function(e, r, n) {
                ...
                for (var a in i.setAttribute("stroke", "none"),
                r)
                    r.hasOwnProperty(a) && i.setAttribute(a, r[a]);
                for (var s = ("" + e).split("\n"), o = 0; o < s.length; o++) {
                    var c = document.createElementNS(t, "tspan");
                    if (c.setAttribute("x", r.x ? r.x : 0),
                    0 !== o && c.setAttribute("dy", "1.2em"),
                    -1 !== s[o].indexOf("")) {
                        var l = s[o].split("");
                        if (c.textContent = l[0],
                        l[1]) {
                ...
                return n ? n.appendChild(i) : this.append(i),
                i
            }
            ,
            r.prototype.guessWidth = function(e, t) {
                var r, n = this.createDummySvg(), i = this.text(e, t, n);
                try {
                    r = i.getBBox(),
                    r = isNaN(r.height) || !r.height ? {
                        width: t["font-size"] / 2,
            ...
            r.prototype.createDummySvg = function() {
                return this.dummySvg || (this.dummySvg = s(),
            ...
            r.prototype.getTextSize = function(e, t, r) {
                ...
                var n;
                if (e.length < 20 && (n = e + JSON.stringify(t),
                a[n]))
                    return a[n];
                var i, s = !r;
                r || (r = this.text(e, t));
                try {
                    i = r.getBBox(),
                    i = isNaN(i.height) || !i.height ? this.guessWidth(e, t) : {
                        width: i.width,
                        height: i.height
                    }
                } catch (r) {
                ...
                return s && (this.currentGroup.length > 0 ? this.currentGroup[0].removeChild(r) : this.svg.removeChild(r)),
                n && (a[n] = i),
                i
            }
            ,
            r.prototype.openGroup = function(e) {
                ...
                return e.klass && r.setAttribute("class", e.klass),
                e.fill && r.setAttribute("fill", e.fill),
                e.stroke && r.setAttribute("stroke", e.stroke),
            ...
            r.prototype.closeGroup = function() {
                ...
                return e && 0 === e.children.length ? (e.parentElement.removeChild(e),
                null) : e
            }
            ,
            r.prototype.path = function(e) {
                ...
                for (var n in e)
                    e.hasOwnProperty(n) && ("path" === n ? r.setAttributeNS(null, "d", e.path) : "klass" === n ? r.setAttributeNS(null, "class", e[n]) : void 0 !== e[n] && r.setAttributeNS(null, n, e[n]));
            ...
            r.prototype.pathToBack = function(e) {
                var r = document.createElementNS(t, "path");
                for (var n in e)
                    e.hasOwnProperty(n) && ("path" === n ? r.setAttributeNS(null, "d", e.path) : "klass" === n ? r.setAttributeNS(null, "class", e[n]) : r.setAttributeNS(null, n, e[n]));
                return this.prepend(r),
                r
            }
            ,
